...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k63421,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k63421,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__63434){
var vec__63435 = p__63434;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63435,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63435,(1),null);
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__63420){
var self__ = this;
var G__63420__$1 = this;
return (new cljs.core.RecordIter((0),G__63420__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pattern","pattern",242135423)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this63422,other63423){
var self__ = this;
var this63422__$1 = this;
return (((!((other63423 == null)))) && ((((this63422__$1.constructor === other63423.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63422__$1.pattern,other63423.pattern)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63422__$1.__extmap,other63423.__extmap)))))));
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k63421){
var self__ = this;
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__63420){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__63445 = cljs.core.keyword_identical_QMARK_;
var expr__63446 = k__5352__auto__;
if(cljs.core.truth_((pred__63445.cljs$core$IFn$_invoke$arity$2 ? pred__63445.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__63446) : pred__63445.call(null,new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__63446)))){
return (new rewrite_clj.node.regex.RegexNode(G__63420,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__63420),null));
}
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__63420){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,G__63420,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.regex.map__GT_RegexNode = (function rewrite_clj$node$regex$map__GT_RegexNode(G__63425){
var extmap__5385__auto__ = (function (){var G__63450 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__63425,new cljs.core.Keyword(null,"pattern","pattern",242135423));
if(cljs.core.record_QMARK_(G__63425)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__63450);
} else {
return G__63450;
}
})();
return (new rewrite_clj.node.regex.RegexNode(new cljs.core.Keyword(null,"pattern","pattern",242135423).cljs$core$IFn$_invoke$arity$1(G__63425),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
