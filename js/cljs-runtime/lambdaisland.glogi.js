...
var G__61588 = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if((G__61588 == null)){
return null;
} else {
return lambdaisland.glogi.goog_setLevel(G__61588,lambdaisland.glogi.level(lvl));
}
});
/**
...
var seq__61589 = cljs.core.seq(lvls);
var chunk__61591 = null;
var count__61592 = (0);
var i__61593 = (0);
while(true){
if((i__61593 < count__61592)){
var vec__61604 = chunk__61591.cljs$core$IIndexed$_nth$arity$2(null,i__61593);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61604,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61604,(1),null);
var level_61645__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_61645__$1);


var G__61646 = seq__61589;
var G__61647 = chunk__61591;
var G__61648 = count__61592;
var G__61649 = (i__61593 + (1));
seq__61589 = G__61646;
chunk__61591 = G__61647;
count__61592 = G__61648;
i__61593 = G__61649;
continue;
} else {
...
var c__5568__auto__ = cljs.core.chunk_first(seq__61589__$1);
var G__61650 = cljs.core.chunk_rest(seq__61589__$1);
var G__61651 = c__5568__auto__;
var G__61652 = cljs.core.count(c__5568__auto__);
var G__61653 = (0);
seq__61589 = G__61650;
chunk__61591 = G__61651;
count__61592 = G__61652;
i__61593 = G__61653;
continue;
} else {
var vec__61607 = cljs.core.first(seq__61589__$1);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61607,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61607,(1),null);
var level_61657__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_61657__$1);


var G__61658 = cljs.core.next(seq__61589__$1);
var G__61659 = null;
var G__61660 = (0);
var G__61661 = (0);
seq__61589 = G__61658;
chunk__61591 = G__61659;
count__61592 = G__61660;
i__61593 = G__61661;
continue;
}
} else {
...
var temp__5753__auto___61662 = goog.debug.Console.instance;
if(cljs.core.truth_(temp__5753__auto___61662)){
var instance_61663 = temp__5753__auto___61662;
instance_61663.setCapturing(true);

var instance_61664__$1 = (new goog.debug.Console());
(goog.debug.Console.instance = instance_61664__$1);

instance_61664__$1.setCapturing();
} else {
}
...
var G__61610 = (new goog.debug.FancyWindow());
G__61610.setEnabled(true);
...
var G__61615 = (new goog.debug.DivConsole(element));
G__61615.setCapturing(true);
...
var len__5769__auto___61665 = arguments.length;
var i__5770__auto___61666 = (0);
while(true){
if((i__5770__auto___61666 < len__5769__auto___61665)){
args__5775__auto__.push((arguments[i__5770__auto___61666]));

var G__61669 = (i__5770__auto___61666 + (1));
i__5770__auto___61666 = G__61669;
continue;
} else {
}
break;
...
/** @this {Function} */
(lambdaisland.glogi.swap_handlers_BANG_.cljs$lang$applyTo = (function (seq61616){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61617,G__61618,seq61616__$2);
}));
...
var G__61624 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"sequenceNumber","sequenceNumber",-543983615),record.sequenceNumber_,new cljs.core.Keyword(null,"time","time",1385887882),record.time_,new cljs.core.Keyword(null,"level","level",1290497552),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.lower_case(record.level_.name)),new cljs.core.Keyword(null,"message","message",-406056002),record.msg_,new cljs.core.Keyword(null,"logger-name","logger-name",-1988126927),record.loggerName_,new cljs.core.Keyword(null,"exception","exception",-335277064),record.exception_], null);
return (handler_fn.cljs$core$IFn$_invoke$arity$1 ? handler_fn.cljs$core$IFn$_invoke$arity$1(G__61624) : handler_fn.call(null,G__61624));
});
if(cljs.core.truth_(logger)){
var temp__5753__auto___61687 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5753__auto___61687)){
var handler_61688 = temp__5753__auto___61687;
lambdaisland.glogi.goog_removeHandler(logger,handler_61688);
} else {
}
...
return lambdaisland.glogi.goog_addHandler(G__61625,log_record_handler);
}
} else {
return null;
}
...
var logger = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if(cljs.core.truth_(logger)){
var temp__5753__auto___61698 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5753__auto___61698)){
var handler_61699 = temp__5753__auto___61698;
lambdaisland.glogi.goog_removeHandler(logger,handler_61699);
} else {
}
