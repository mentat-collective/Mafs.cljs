...
function scrollRectIntoView(dom,rect$jscomp$0,side,x,y,xMargin,yMargin,ltr){let doc=dom.ownerDocument,win=doc.defaultView||window;for(;dom;)if(1==dom.nodeType){let top=dom==doc.body;if(top){var JSCompiler_object_inline_left_448=0;var JSCompiler_object_inline_right_449=win.innerWidth;var JSCompiler_object_inline_top_450=0;var JSCompiler_object_inline_bottom_451=win.innerHeight}else{if(dom.scrollHeight<=dom.clientHeight&&dom.scrollWidth<=dom.clientWidth){dom=dom.assignedSlot||dom.parentNode;continue}var rect=
dom.getBoundingClientRect();JSCompiler_object_inline_left_448=rect.left;JSCompiler_object_inline_right_449=rect.left+dom.clientWidth;JSCompiler_object_inline_top_450=rect.top;JSCompiler_object_inline_bottom_451=rect.top+dom.clientHeight}var moveY=rect=0;"nearest"==y?rect$jscomp$0.top<JSCompiler_object_inline_top_450?(moveY=-(JSCompiler_object_inline_top_450-rect$jscomp$0.top+yMargin),0<side&&rect$jscomp$0.bottom>JSCompiler_object_inline_bottom_451+moveY&&(moveY=rect$jscomp$0.bottom-JSCompiler_object_inline_bottom_451+
moveY+yMargin)):rect$jscomp$0.bottom>JSCompiler_object_inline_bottom_451&&(moveY=rect$jscomp$0.bottom-JSCompiler_object_inline_bottom_451+yMargin,0>side&&rect$jscomp$0.top-moveY<JSCompiler_object_inline_top_450&&(moveY=-(JSCompiler_object_inline_top_450+moveY-rect$jscomp$0.top+yMargin))):(moveY=rect$jscomp$0.bottom-rect$jscomp$0.top,JSCompiler_object_inline_bottom_451-=JSCompiler_object_inline_top_450,moveY=("center"==y&&moveY<=JSCompiler_object_inline_bottom_451?rect$jscomp$0.top+moveY/2-JSCompiler_object_inline_bottom_451/
2:"start"==y||"center"==y&&0>side?rect$jscomp$0.top-yMargin:rect$jscomp$0.bottom-JSCompiler_object_inline_bottom_451+yMargin)-JSCompiler_object_inline_top_450);"nearest"==x?rect$jscomp$0.left<JSCompiler_object_inline_left_448?(rect=-(JSCompiler_object_inline_left_448-rect$jscomp$0.left+xMargin),0<side&&rect$jscomp$0.right>JSCompiler_object_inline_right_449+rect&&(rect=rect$jscomp$0.right-JSCompiler_object_inline_right_449+rect+xMargin)):rect$jscomp$0.right>JSCompiler_object_inline_right_449&&(rect=
rect$jscomp$0.right-JSCompiler_object_inline_right_449+xMargin,0>side&&rect$jscomp$0.left<JSCompiler_object_inline_left_448+rect&&(rect=-(JSCompiler_object_inline_left_448+rect-rect$jscomp$0.left+xMargin))):rect=("center"==x?rect$jscomp$0.left+(rect$jscomp$0.right-rect$jscomp$0.left)/2-(JSCompiler_object_inline_right_449-JSCompiler_object_inline_left_448)/2:"start"==x==ltr?rect$jscomp$0.left-xMargin:rect$jscomp$0.right-(JSCompiler_object_inline_right_449-JSCompiler_object_inline_left_448)+xMargin)-
JSCompiler_object_inline_left_448;if(rect||moveY)top?win.scrollBy(rect,moveY):(JSCompiler_object_inline_right_449=JSCompiler_object_inline_left_448=0,moveY&&(JSCompiler_object_inline_right_449=dom.scrollTop,dom.scrollTop+=moveY,JSCompiler_object_inline_right_449=dom.scrollTop-JSCompiler_object_inline_right_449),rect&&(JSCompiler_object_inline_left_448=dom.scrollLeft,dom.scrollLeft+=rect,JSCompiler_object_inline_left_448=dom.scrollLeft-JSCompiler_object_inline_left_448),rect$jscomp$0={left:rect$jscomp$0.left-
JSCompiler_object_inline_left_448,top:rect$jscomp$0.top-JSCompiler_object_inline_right_449,right:rect$jscomp$0.right-JSCompiler_object_inline_left_448,bottom:rect$jscomp$0.bottom-JSCompiler_object_inline_right_449},JSCompiler_object_inline_left_448&&1>Math.abs(JSCompiler_object_inline_left_448-rect)&&(x="nearest"),JSCompiler_object_inline_right_449&&1>Math.abs(JSCompiler_object_inline_right_449-moveY)&&(y="nearest"));if(top)break;dom=dom.assignedSlot||dom.parentNode}else if(11==dom.nodeType)dom=dom.host;
else break}function focusPreventScroll(dom){if(dom.setActive)return dom.setActive();if(preventScrollSupported)return dom.focus(preventScrollSupported);let stack=[];for(var cur=dom;cur&&(stack.push(cur,cur.scrollTop,cur.scrollLeft),cur!=cur.ownerDocument);cur=cur.parentNode);dom.focus(null==preventScrollSupported?{get preventScroll(){preventScrollSupported={preventScroll:!0};return!0}}:void 0);if(!preventScrollSupported)for(preventScrollSupported=!1,dom=0;dom<stack.length;){cur=stack[dom++];let top=
stack[dom++],left=stack[dom++];cur.scrollTop!=top&&(cur.scrollTop=top);cur.scrollLeft!=left&&(cur.scrollLeft=left)}}function textRange(node,from,to=from){let range=scratchRange||(scratchRange=document.createRange());range.setEnd(node,to);range.setStart(node,from);return range}function dispatchKey(elt,name,code){code={key:name,code:name,keyCode:code,which:code,cancelable:!0};name=new KeyboardEvent("keydown",code);name.synthetic=!0;elt.dispatchEvent(name);code=new KeyboardEvent("keyup",code);code.synthetic=
!0;elt.dispatchEvent(code);return name.defaultPrevented||code.defaultPrevented}function getRoot(node){for(;node;){if(node&&(9==node.nodeType||11==node.nodeType&&node.host))return node;node=node.assignedSlot||node.parentNode}return null}function clearAttributes(node){for(;node.attributes.length;)node.removeAttributeNode(node.attributes[0])}function rm$1(dom){let next=dom.nextSibling;dom.parentNode.removeChild(dom);return next}function replaceRange(parent,fromI,fromOff,toI,toOff,insert,breakAtStart,
openStart,openEnd){let {children}=parent,before=children.length?children[fromI]:null,last=insert.length?insert[insert.length-1]:null,breakAtEnd=last?last.breakAfter:breakAtStart;if(!(fromI==toI&&before&&!breakAtStart&&!breakAtEnd&&2>insert.length&&before.merge(fromOff,toOff,insert.length?last:null,0==fromOff,openStart,openEnd))){if(toI<children.length){let after=children[toI];if(after&&toOff<after.length)fromI==toI&&(after=after.split(toOff),toOff=0),!breakAtEnd&&last&&after.merge(0,toOff,last,!0,
0,openEnd)?insert[insert.length-1]=after:(toOff&&after.merge(0,toOff,null,!1,0,openEnd),insert.push(after));else if(null===after||void 0===after?0:after.breakAfter)last?last.breakAfter=1:breakAtStart=1;toI++}before&&(before.breakAfter=breakAtStart,0<fromOff&&(!breakAtStart&&insert.length&&before.merge(fromOff,before.length,insert[0],!1,openStart,0)?before.breakAfter=insert.shift().breakAfter:(fromOff<before.length||before.children.length&&0==before.children[before.children.length-1].length)&&before.merge(fromOff,
before.length,null,!1,openStart,0),fromI++));for(;fromI<toI&&insert.length;)if(children[toI-1].become(insert[insert.length-1]))toI--,insert.pop(),openEnd=insert.length?0:openStart;else if(children[fromI].become(insert[0]))fromI++,insert.shift(),openStart=insert.length?0:openEnd;else break;!insert.length&&fromI&&toI<children.length&&!children[fromI-1].breakAfter&&children[toI].merge(0,0,children[fromI-1],!1,openStart,openEnd)&&fromI--;(fromI<toI||insert.length)&&parent.replaceChildren(fromI,toI,insert)}}
function mergeChildrenInto(parent,from,to,insert,openStart,openEnd){let cur=parent.childCursor(),{i:toI,off:toOff}=cur.findPos(to,1),{i:fromI,off:fromOff}=cur.findPos(from,-1);from-=to;for(let view of insert)from+=view.length;parent.length+=from;replaceRange(parent,fromI,fromOff,toI,toOff,insert,0,openStart,openEnd)}function textCoords(text,pos,side){let length=text.nodeValue.length;pos>length&&(pos=length);let from=pos,to=pos,flatten=0;0==pos&&0>side||pos==length&&0<=side?browser.chrome||browser.gecko||
(pos?(from--,flatten=1):to<length&&(to++,flatten=-1)):0>side?from--:to<length&&to++;text=textRange(text,from,to).getClientRects();if(!text.length)return Rect0;side=text[(flatten?0>flatten:0<=side)?0:text.length-1];browser.safari&&!flatten&&0==side.width&&(side=Array.prototype.find.call(text,r=>r.width)||side);return flatten?flattenRect(side,0>flatten):side||null}function scanCompositionTree(pos,side,view,text,enterView,fromText){if(view instanceof MarkView){for(let child=view.dom.firstChild;child;child=
...
bottom}:rect}function domPosAtCoords(parent,x,y){let closest,closestRect;let closestY;var closestOverlap=!1;let above,below,aboveRect,belowRect;for(let child=parent.firstChild;child;child=child.nextSibling){let rects=clientRectsFor(child);for(let i=0;i<rects.length;i++){let rect=rects[i];closestRect&&yOverlap(closestRect,rect)&&(rect=upTop(upBot(rect,closestRect.bottom),closestRect.top));let dx=rect.left>x?rect.left-x:Math.max(0,x-rect.right),dy=rect.top>y?rect.top-y:Math.max(0,y-rect.bottom);if(0==
dx&&0==dy)return 3==child.nodeType?domPosInText(child,x,y):domPosAtCoords(child,x,y);if(!closest||closestY>dy||closestY==dy&&closestX>dx){closest=child;closestRect=rect;var closestX=dx;closestOverlap=(closestY=dy)?y<rect.top?-1:1:dx?x<rect.left?-1:1:0;closestOverlap=!closestOverlap||(0<closestOverlap?i<rects.length-1:0<i)}0==dx?y>rect.bottom&&(!aboveRect||aboveRect.bottom<rect.bottom)?(above=child,aboveRect=rect):y<rect.top&&(!belowRect||belowRect.top>rect.top)&&(below=child,belowRect=rect):aboveRect&&
yOverlap(aboveRect,rect)?aboveRect=upBot(aboveRect,rect.bottom):belowRect&&yOverlap(belowRect,rect)&&(belowRect=upTop(belowRect,rect.top))}}aboveRect&&aboveRect.bottom>=y?(closest=above,closestRect=aboveRect):belowRect&&belowRect.top<=y&&(closest=below,closestRect=belowRect);if(!closest)return{node:parent,offset:0};closestX=Math.max(closestRect.left,Math.min(closestRect.right,x));if(3==closest.nodeType)return domPosInText(closest,closestX,y);if(closestOverlap&&"false"!=closest.contentEditable)return domPosAtCoords(closest,
closestX,y);x=Array.prototype.indexOf.call(parent.childNodes,closest)+(x>=(closestRect.left+closestRect.right)/2?1:0);return{node:parent,offset:x}}function domPosInText(node,x,y){let len=node.nodeValue.length;var closestOffset=-1,closestDY=1E9;let generalSide=0;for(let i=0;i<len;i++){let rects=textRange(node,i,i+1).getClientRects();for(let j=0;j<rects.length;j++){let rect=rects[j];if(rect.top==rect.bottom)continue;generalSide||(generalSide=x-rect.left);let dy=(rect.top>y?rect.top-y:y-rect.bottom)-
1;if(rect.left-1<=x&&rect.right+1>=x&&dy<closestDY){closestDY=closestOffset=x>=(rect.left+rect.right)/2;(browser.chrome||browser.gecko)&&textRange(node,i).getBoundingClientRect().left==rect.right&&(closestDY=!closestOffset);if(0>=dy)return{node,offset:i+(closestDY?1:0)};closestOffset=i+(closestDY?1:0);closestDY=dy}}}return{node,offset:-1<closestOffset?closestOffset:0<generalSide?node.nodeValue.length:0}}function posAtCoords(view,{x,y},precise,bias=-1){var _a,content=view.contentDOM.getBoundingClientRect(),
docTop=content.top+view.viewState.paddingTop;let block;var {docHeight}=view.viewState;let yOffset=y-docTop;if(0>yOffset)return 0;if(yOffset>docHeight)return view.state.doc.length;for(let halfLine=view.defaultLineHeight/2,bounced=!1;;){block=view.elementAtHeight(yOffset);if(block.type==exports.BlockType.Text)break;for(;;){yOffset=0<bias?block.bottom+halfLine:block.top-halfLine;if(0<=yOffset&&yOffset<=docHeight)break;if(bounced)return precise?null:0;bounced=!0;bias=-bias}}y=docTop+yOffset;bias=block.from;
if(bias<view.viewport.from)return 0==view.viewport.from?0:precise?null:posAtCoordsImprecise(view,content,block,x,y);if(bias>view.viewport.to)return view.viewport.to==view.state.doc.length?view.state.doc.length:precise?null:posAtCoordsImprecise(view,content,block,x,y);precise=view.dom.ownerDocument;docHeight=view.root.elementFromPoint?view.root:precise;(docTop=docHeight.elementFromPoint(x,y))&&!view.contentDOM.contains(docTop)&&(docTop=null);docTop||(x=Math.max(content.left+1,Math.min(content.right-
1,x)),(docTop=docHeight.elementFromPoint(x,y))&&!view.contentDOM.contains(docTop)&&(docTop=null));var node;content=-1;if(docTop&&0!=(null===(_a=view.docView.nearest(docTop))||void 0===_a?void 0:_a.isEditable))if(precise.caretPositionFromPoint){var pos=precise.caretPositionFromPoint(x,y);pos&&({offsetNode:node,offset:content}=pos)}else if(precise.caretRangeFromPoint&&(_a=precise.caretRangeFromPoint(x,y))){({startContainer:node,startOffset:content}=_a);if(!(_a=!view.contentDOM.contains(node))&&(_a=
browser.safari))a:if(_a=x,3!=node.nodeType||content!=(pos=node.nodeValue.length))_a=!1;else{for(precise=node.nextSibling;precise;precise=precise.nextSibling)if(1!=precise.nodeType||"BR"!=precise.nodeName){_a=!1;break a}_a=textRange(node,pos-1,pos).getBoundingClientRect().left>_a}if(!(pos=_a)&&(pos=browser.chrome))a:if(_a=node,pos=x,0!=content)pos=!1;else{for(precise=_a;;){docTop=precise.parentNode;if(!docTop||1!=docTop.nodeType||docTop.firstChild!=precise){pos=!1;break a}if(docTop.classList.contains("cm-line"))break;
precise=docTop}_a=1==_a.nodeType?_a.getBoundingClientRect():textRange(_a,0,Math.max(_a.nodeValue.length,1)).getBoundingClientRect();pos=5<pos-_a.left}pos&&(node=void 0)}if(!node||!view.docView.dom.contains(node)){node=LineView.find(view.docView,bias);if(!node)return yOffset>block.top+block.height/2?block.to:block.from;({node,offset:content}=domPosAtCoords(node.dom,x,y))}return view.docView.posFromDOM(node,content)}function posAtCoordsImprecise(view,contentRect,block,x,y){contentRect=Math.round((x-
contentRect.left)*view.defaultCharacterWidth);view.lineWrapping&&block.height>1.5*view.defaultLineHeight&&(contentRect+=Math.floor((y-block.top)/view.defaultLineHeight)*view.viewState.heightOracle.lineLength);y=view.state.sliceDoc(block.from,block.to);return block.from+state$jscomp$0.findColumn(y,contentRect,view.state.tabSize)}function moveByChar(view,start,forward,by){let line=view.state.doc.lineAt(start.head),spans=view.bidiSpans(line),direction=view.textDirectionAt(line.from);for(let cur=start,
check=null;;){start=moveVisually(line,spans,direction,cur,forward);let char=movedOver;if(!start){if(line.number==(forward?view.state.doc.lines:1))return cur;char="\n";line=view.state.doc.line(line.number+(forward?1:-1));spans=view.bidiSpans(line);start=state$jscomp$0.EditorSelection.cursor(forward?line.from:line.to)}if(!check){if(!by)return start;check=by(char)}else if(!check(char))return cur;cur=start}}function byGroup(view,pos,start){let categorize=view.state.charCategorizer(pos),cat=categorize(start);
return next=>{next=categorize(next);cat==state$jscomp$0.CharCategory.Space&&(cat=next);return cat==next}}function skipAtoms(view,oldPos,pos){let atoms=view.state.facet(atomicRanges).map(f=>f(view));for(;;){let moved=!1;for(let set of atoms)set.between(pos.from-1,pos.from+1,(from,to,value)=>{pos.from>from&&pos.from<to&&(pos=oldPos.head>pos.from?state$jscomp$0.EditorSelection.cursor(from,1):state$jscomp$0.EditorSelection.cursor(to,-1),moved=!0)});if(!moved)return pos}}function isInPrimarySelection(view,
event){var {main}=view.state.selection;if(main.empty)return!1;view=getSelection(view.root);if(!view||0==view.rangeCount)return!0;view=view.getRangeAt(0).getClientRects();for(main=0;main<view.length;main++){let rect=view[main];if(rect.left<=event.clientX&&rect.right>=event.clientX&&rect.top<=event.clientY&&rect.bottom>=event.clientY)return!0}return!1}function eventBelongsToEditor(view,event){if(!event.bubbles)return!0;if(event.defaultPrevented)return!1;for(let node=event.target,cView;node!=view.contentDOM;node=
node.parentNode)if(!node||11==node.nodeType||(cView=ContentView.get(node))&&cView.ignoreEvent(event))return!1;return!0}function capturePaste(view){let parent=view.dom.parentNode;if(parent){var target=parent.appendChild(document.createElement("textarea"));target.style.cssText="position: fixed; left: -10000px; top: 10px";target.focus();setTimeout(()=>{view.focus();target.remove();doPaste(view,target.value)},50)}}function doPaste(view,input){let {state:state$1}=view,changes,i=1,text=state$1.toText(input),
byLine=text.lines==state$1.selection.ranges.length;if(null!=lastLinewiseCopy&&state$1.selection.ranges.every(r=>r.empty)&&lastLinewiseCopy==text.toString()){let lastLine=-1;changes=state$1.changeByRange(range=>{let line=state$1.doc.lineAt(range.from);if(line.from==lastLine)return{range};lastLine=line.from;let insert=state$1.toText((byLine?text.line(i++).text:input)+state$1.lineBreak);return{changes:{from:line.from,insert},range:state$jscomp$0.EditorSelection.cursor(range.from+insert.length)}})}else changes=
byLine?state$1.changeByRange(range=>{let line=text.line(i++);return{changes:{from:range.from,to:range.to,insert:line.text},range:state$jscomp$0.EditorSelection.cursor(range.from+line.length)}}):state$1.replaceSelection(text);view.dispatch(changes,{userEvent:"input.paste",scrollIntoView:!0})}function rangeForClick(view,pos,bias,type){if(1==type)return state$jscomp$0.EditorSelection.cursor(pos,bias);if(2==type)return groupAt(view.state,pos,bias);bias=LineView.find(view.docView,pos);pos=view.state.doc.lineAt(bias?
...
-1;else{view=line.coordsAt(off,-1);var JSCompiler_temp;if(JSCompiler_temp=view)JSCompiler_temp=event>=view.top&&event<=view.bottom&&JSCompiler_inline_result>=view.left&&JSCompiler_inline_result<=view.right;if(JSCompiler_temp)JSCompiler_inline_result=-1;else{if(JSCompiler_temp=off=line.coordsAt(off,1))JSCompiler_temp=event>=off.top&&event<=off.bottom&&JSCompiler_inline_result>=off.left&&JSCompiler_inline_result<=off.right;JSCompiler_inline_result=JSCompiler_temp?1:view&&event>=view.top&&event<=view.bottom?
-1:1}}}else JSCompiler_inline_result=1}return{pos,bias:JSCompiler_inline_result}}function getClickType(event){if(!BadMouseDetail)return event.detail;let last=lastMouseDown,lastTime=lastMouseDownTime;lastMouseDown=event;lastMouseDownTime=Date.now();return lastMouseDownCount=!last||lastTime>Date.now()-400&&2>Math.abs(last.clientX-event.clientX)&&2>Math.abs(last.clientY-event.clientY)?(lastMouseDownCount+1)%3:1}function basicMouseSelection(view,event$jscomp$0){let start=queryPos(view,event$jscomp$0),
type=getClickType(event$jscomp$0),startSel=view.state.selection;return{update(update){update.docChanged&&(start.pos=update.changes.mapPos(start.pos),startSel=startSel.map(update.changes))},get(event,extend,multiple){event=queryPos(view,event);let range=rangeForClick(view,event.pos,event.bias,type);if(start.pos!=event.pos&&!extend){var startRange=rangeForClick(view,start.pos,start.bias,type);event=Math.min(startRange.from,range.from);startRange=Math.max(startRange.to,range.to);range=event<range.from?
state$jscomp$0.EditorSelection.range(event,startRange):state$jscomp$0.EditorSelection.range(startRange,event)}return extend?startSel.replaceRange(startSel.main.extend(range.from,range.to)):multiple&&1<startSel.ranges.length&&startSel.ranges.some(r=>r.eq(range))?removeRange(startSel,range):multiple?startSel.addRange(range):state$jscomp$0.EditorSelection.create([range])}}}function removeRange(sel,range){for(let i=0;;i++)if(sel.ranges[i].eq(range))return state$jscomp$0.EditorSelection.create(sel.ranges.slice(0,
i).concat(sel.ranges.slice(i+1)),sel.mainIndex==i?0:sel.mainIndex-(sel.mainIndex>i?1:0))}function dropText(view,event,text,direct){if(text){var dropPos=view.posAtCoords({x:event.clientX,y:event.clientY},!1);event.preventDefault();({mouseSelection:event}=view.inputState);direct=direct&&event&&event.dragging&&event.dragMove?{from:event.dragging.from,to:event.dragging.to}:null;text={from:dropPos,insert:text};text=view.state.changes(direct?[direct,text]:text);view.focus();view.dispatch({changes:text,
selection:{anchor:text.mapPos(dropPos,-1),head:text.mapPos(dropPos,1)},userEvent:direct?"move.drop":"input.drop"})}}function captureCopy(view,text){let parent=view.dom.parentNode;if(parent){var target=parent.appendChild(document.createElement("textarea"));target.style.cssText="position: fixed; left: -10000px; top: 10px";target.value=text;target.focus();target.selectionEnd=text.length;target.selectionStart=0;setTimeout(()=>{target.remove();view.focus()},50)}}function updateForFocusChange(view){setTimeout(()=>
{view.hasFocus!=view.inputState.notifiedFocused&&view.update([])},10)}function mergeGaps(nodes,around){let before,after;null==nodes[around]&&(before=nodes[around-1])instanceof HeightMapGap&&(after=nodes[around+1])instanceof HeightMapGap&&nodes.splice(around-1,3,new HeightMapGap(before.length+1+after.length))}function heightRelevantDecoChanges(a,b,diff){let comp=new DecorationComparator;state$jscomp$0.RangeSet.compare(a,b,diff,comp,0);return comp.changes}function visiblePixelRange(dom,paddingTop){let rect=
dom.getBoundingClientRect(),doc=dom.ownerDocument;var win=doc.defaultView||window;let left=Math.max(0,rect.left),right=Math.min(win.innerWidth,rect.right),top=Math.max(0,rect.top);win=Math.min(win.innerHeight,rect.bottom);for(let parent=dom.parentNode;parent&&parent!=doc.body;)if(1==parent.nodeType){let elt=parent,style=window.getComputedStyle(elt);if((elt.scrollHeight>elt.clientHeight||elt.scrollWidth>elt.clientWidth)&&"visible"!=style.overflow){let parentRect=elt.getBoundingClientRect();left=Math.max(left,
parentRect.left);right=Math.min(right,parentRect.right);top=Math.max(top,parentRect.top);win=parent==dom.parentNode?parentRect.bottom:Math.min(win,parentRect.bottom)}parent="absolute"==style.position||"fixed"==style.position?elt.offsetParent:elt.parentNode}else if(11==parent.nodeType)parent=parent.host;else break;return{left:left-rect.left,right:Math.max(left,right)-rect.left,top:top-(rect.top+paddingTop),bottom:Math.max(top,win)-(rect.top+paddingTop)}}function fullPixelRange(dom,paddingTop){dom=
dom.getBoundingClientRect();return{left:0,right:dom.right-dom.left,top:paddingTop,bottom:dom.bottom-(dom.top+paddingTop)}}function lineStructure(from$jscomp$0,to$jscomp$0,stateDeco){let ranges=[],pos=from$jscomp$0,total=0;state$jscomp$0.RangeSet.spans(stateDeco,from$jscomp$0,to$jscomp$0,{span(){},point(from,to){from>pos&&(ranges.push({from:pos,to:from}),total+=from-pos);pos=to}},20);pos<to$jscomp$0&&(ranges.push({from:pos,to:to$jscomp$0}),total+=to$jscomp$0-pos);return{total,ranges}}function findPosition({total,
ranges},ratio){if(0>=ratio)return ranges[0].from;if(1<=ratio)return ranges[ranges.length-1].to;total=Math.floor(total*ratio);for(ratio=0;;ratio++){let {from,to}=ranges[ratio],size=to-from;if(total<=size)return from+total;total-=size}}function findFraction(structure,pos){let counted=0;for(let {from,to}of structure.ranges){if(pos<=to){counted+=pos-from;break}counted+=to-from}return counted/structure.total}function find(array,f){for(let val of array)if(f(val))return val}function scaleBlock(block,scaler){if(1==
...
domChange){let change;var {newSel}=domChange;let sel=view.state.selection.main;if(domChange.bounds){let {from,to}=domChange.bounds;var preferredPos=sel.from;let preferredSide=null;if(8===view.inputState.lastKeyCode&&view.inputState.lastKeyTime>Date.now()-100||browser.android&&domChange.text.length<to-from)preferredPos=sel.to,preferredSide="end";if(preferredPos=findDiff(view.state.doc.sliceString(from,to,"￿"),domChange.text,preferredPos-from,preferredSide))browser.chrome&&13==view.inputState.lastKeyCode&&
preferredPos.toB==preferredPos.from+2&&"￿￿"==domChange.text.slice(preferredPos.from,preferredPos.toB)&&preferredPos.toB--,change={from:from+preferredPos.from,to:from+preferredPos.toA,insert:state$jscomp$0.Text.of(domChange.text.slice(preferredPos.from,preferredPos.toB).split("￿"))}}else newSel&&(!view.hasFocus&&view.state.facet(editable)||newSel.main.eq(sel))&&(newSel=null);if(!change&&!newSel)return!1;!change&&domChange.typeOver&&!sel.empty&&newSel&&newSel.main.empty?change={from:sel.from,to:sel.to,
insert:view.state.doc.slice(sel.from,sel.to)}:change&&change.from>=sel.from&&change.to<=sel.to&&(change.from!=sel.from||change.to!=sel.to)&&4>=sel.to-sel.from-(change.to-change.from)?change={from:sel.from,to:sel.to,insert:view.state.doc.slice(sel.from,change.from).append(change.insert).append(view.state.doc.slice(change.to,sel.to))}:(browser.mac||browser.android)&&change&&change.from==change.to&&change.from==sel.head-1&&/^\. ?$/.test(change.insert.toString())?(newSel&&2==change.insert.length&&(newSel=
state$jscomp$0.EditorSelection.single(newSel.main.anchor-1,newSel.main.head-1)),change={from:sel.from,to:sel.to,insert:state$jscomp$0.Text.of([" "])}):browser.chrome&&change&&change.from==change.to&&change.from==sel.head&&"\n "==change.insert.toString()&&view.lineWrapping&&(newSel&&(newSel=state$jscomp$0.EditorSelection.single(newSel.main.anchor-1,newSel.main.head-1)),change={from:sel.from,to:sel.to,insert:state$jscomp$0.Text.of([" "])});if(change){let startState=view.state;if(browser.ios&&view.inputState.flushIOSKey(view)||
browser.android&&(change.from==sel.from&&change.to==sel.to&&1==change.insert.length&&2==change.insert.lines&&dispatchKey(view.contentDOM,"Enter",13)||change.from==sel.from-1&&change.to==sel.to&&0==change.insert.length&&dispatchKey(view.contentDOM,"Backspace",8)||change.from==sel.from&&change.to==sel.to+1&&0==change.insert.length&&dispatchKey(view.contentDOM,"Delete",46)))return!0;let text=change.insert.toString();if(view.state.facet(inputHandler).some(h=>h(view,change.from,change.to,text)))return!0;
0<=view.inputState.composing&&view.inputState.composing++;if(change.from>=sel.from&&change.to<=sel.to&&change.to-change.from>=(sel.to-sel.from)/3&&(!newSel||newSel.main.empty&&newSel.main.from==change.from+change.insert.length)&&0>view.inputState.composing)newSel=sel.from<change.from?startState.sliceDoc(sel.from,change.from):"",domChange=sel.to>change.to?startState.sliceDoc(change.to,sel.to):"",newSel=startState.replaceSelection(view.state.toText(newSel+change.insert.sliceString(0,void 0,view.state.lineBreak)+
domChange));else{let changes=startState.changes(change),mainSel=newSel&&!startState.selection.main.eq(newSel.main)&&newSel.main.to<=changes.newLength?newSel.main:void 0;if(1<startState.selection.ranges.length&&0<=view.inputState.composing&&change.to<=sel.to&&change.to>=sel.to-10){let replaced=view.state.sliceDoc(change.from,change.to),compositionRange=compositionSurroundingNode(view)||view.state.doc.lineAt(sel.head),offset=sel.to-change.to,size=sel.to-sel.from;newSel=startState.changeByRange(range=>
{if(range.from==sel.from&&range.to==sel.to)return{changes,range:mainSel||range.map(changes)};var to=range.to-offset,from=to-replaced.length;if(range.to-range.from!=size||view.state.sliceDoc(from,to)!=replaced||compositionRange&&range.to>=compositionRange.from&&range.from<=compositionRange.to)return{range};to=startState.changes({from,to,insert:change.insert});from=range.to-sel.to;return{changes:to,range:mainSel?state$jscomp$0.EditorSelection.range(Math.max(0,mainSel.anchor+from),Math.max(0,mainSel.head+
from)):range.map(to)}})}else newSel={changes,selection:mainSel&&startState.selection.replaceRange(mainSel)}}domChange="input.type";view.composing&&(domChange+=".compose",view.inputState.compositionFirstChange&&(domChange+=".start",view.inputState.compositionFirstChange=!1));view.dispatch(newSel,{scrollIntoView:!0,userEvent:domChange});return!0}return newSel&&!newSel.main.eq(sel)?(domChange=!1,preferredPos="select",view.inputState.lastSelectionTime>Date.now()-50&&("select"==view.inputState.lastSelectionOrigin&&
(domChange=!0),preferredPos=view.inputState.lastSelectionOrigin),view.dispatch({selection:newSel,scrollIntoView:domChange,userEvent:preferredPos}),!0):!1}function findDiff(a,b,preferredPos,preferredSide){var minLen=Math.min(a.length,b.length);let from=0;for(;from<minLen&&a.charCodeAt(from)==b.charCodeAt(from);)from++;if(from==minLen&&a.length==b.length)return null;minLen=a.length;let toB=b.length;for(;0<minLen&&0<toB&&a.charCodeAt(minLen-1)==b.charCodeAt(toB-1);)minLen--,toB--;"end"==preferredSide&&
(preferredPos-=minLen+Math.max(0,from-Math.min(minLen,toB))-from);minLen<from&&a.length<b.length?(from-=preferredPos<=from&&preferredPos>=minLen?from-preferredPos:0,toB=from+(toB-minLen),minLen=from):toB<from&&(from-=preferredPos<=from&&preferredPos>=toB?from-preferredPos:0,minLen=from+(minLen-toB),toB=from);return{from,toA:minLen,toB}}function findChild(cView,dom,dir){for(;dom;){var curView=ContentView.get(dom);if(curView&&curView.parent==cView)return curView;curView=dom.parentNode;dom=curView!=
cView.dom?curView:0<dir?dom.nextSibling:dom.previousSibling}return null}function safariSelectionRangeHack(view){function read(event){event.preventDefault();event.stopImmediatePropagation();found=event.getTargetRanges()[0]}let found=null;view.contentDOM.addEventListener("beforeinput",read,!0);view.dom.ownerDocument.execCommand("indent");view.contentDOM.removeEventListener("beforeinput",read,!0);if(!found)return null;let anchorNode=found.startContainer,anchorOffset=found.startOffset,focusNode=found.endContainer,
focusOffset=found.endOffset;view=view.docView.domAtPos(view.state.selection.main.anchor);isEquivalentPosition(view.node,view.offset,focusNode,focusOffset)&&([anchorNode,anchorOffset,focusNode,focusOffset]=[focusNode,focusOffset,anchorNode,anchorOffset]);return{anchorNode,anchorOffset,focusNode,focusOffset}}function attrsFromFacet(view,facet,base){for(let sources=view.state.facet(facet),i=sources.length-1;0<=i;i--)facet=sources[i],(facet="function"==typeof facet?facet(view):facet)&&combineAttrs(facet,
base);return base}function modifiers(name,event,shift){event.altKey&&(name="Alt-"+name);event.ctrlKey&&(name="Ctrl-"+name);event.metaKey&&(name="Meta-"+name);!1!==shift&&event.shiftKey&&(name="Shift-"+name);return name}function getKeymap(state){state=state.facet(keymap);let map=Keymaps.get(state);map||Keymaps.set(state,map=buildKeymap(state.reduce((a,b)=>a.concat(b),[])));return map}function buildKeymap(bindings,platform=currentPlatform){let bound=Object.create(null),isPrefix=Object.create(null),
checkPrefix=(name,is)=>{let current=isPrefix[name];if(null==current)isPrefix[name]=is;else if(current!=is)throw Error("Key binding "+name+" is used both as a regular binding and as a multi-stroke prefix");},add=(scope,key,command,preventDefault)=>{var _a,_b,scopeObj=bound[scope]||(bound[scope]=Object.create(null));key=key.split(/ (?!$)/).map(k=>{k=k.split(/-(?!$)/);let result=k[k.length-1];"Space"==result&&(result=" ");let alt,ctrl,shift,meta;for(let i=0;i<k.length-1;++i){const mod=k[i];if(/^(cmd|meta|m)$/i.test(mod))meta=
!0;else if(/^a(lt)?$/i.test(mod))alt=!0;else if(/^(c|ctrl|control)$/i.test(mod))ctrl=!0;else if(/^s(hift)?$/i.test(mod))shift=!0;else if(/^mod$/i.test(mod))"mac"==platform?meta=!0:ctrl=!0;else throw Error("Unrecognized modifier name: "+mod);}alt&&(result="Alt-"+result);ctrl&&(result="Ctrl-"+result);meta&&(result="Meta-"+result);shift&&(result="Shift-"+result);return result});for(let i=1;i<key.length;i++){let prefix=key.slice(0,i).join(" ");checkPrefix(prefix,!0);scopeObj[prefix]||(scopeObj[prefix]=
{preventDefault:!0,run:[view=>{let ourObj=storedPrefix={view,prefix,scope};setTimeout(()=>{storedPrefix==ourObj&&(storedPrefix=null)},4E3);return!0}]})}key=key.join(" ");checkPrefix(key,!1);scopeObj=scopeObj[key]||(scopeObj[key]={preventDefault:!1,run:(null===(_b=null===(_a=scopeObj._any)||void 0===_a?void 0:_a.run)||void 0===_b?void 0:_b.slice())||[]});command&&scopeObj.run.push(command);preventDefault&&(scopeObj.preventDefault=!0)};for(let b of bindings){bindings=b.scope?b.scope.split(" "):["editor"];
if(b.any)for(let scope of bindings){var scopeObj$jscomp$0=bound[scope]||(bound[scope]=Object.create(null));scopeObj$jscomp$0._any||(scopeObj$jscomp$0._any={preventDefault:!1,run:[]});for(let key in scopeObj$jscomp$0)scopeObj$jscomp$0[key].run.push(b.any)}if(scopeObj$jscomp$0=b[platform]||b.key)for(let scope of bindings)add(scope,scopeObj$jscomp$0,b.run,b.preventDefault),b.shift&&add(scope,"Shift-"+scopeObj$jscomp$0,b.shift,b.preventDefault)}return bound}function runHandlers(map,event,view,scope){let name=
w3cKeyname.keyName(event);var charCode=state$jscomp$0.codePointAt(name,0);charCode=state$jscomp$0.codePointSize(charCode)==name.length&&" "!=name;let prefix="",fallthrough=!1;storedPrefix&&storedPrefix.view==view&&storedPrefix.scope==scope&&(prefix=storedPrefix.prefix+" ",fallthrough=0>modifierCodes.indexOf(event.keyCode))&&(storedPrefix=null);let ran=new Set,runFor=binding=>{if(binding){for(let cmd of binding.run)if(!ran.has(cmd)&&(ran.add(cmd),cmd(view,event)))return!0;binding.preventDefault&&(fallthrough=
!0)}return!1};map=map[scope];let baseName,shiftName;if(map){if(runFor(map[prefix+modifiers(name,event,!charCode)]))return!0;if(charCode&&(event.altKey||event.metaKey||event.ctrlKey)&&!(browser.windows&&event.ctrlKey&&event.altKey)&&(baseName=w3cKeyname.base[event.keyCode])&&baseName!=name){if(runFor(map[prefix+modifiers(baseName,event,!0)])||event.shiftKey&&(shiftName=w3cKeyname.shift[event.keyCode])!=name&&shiftName!=baseName&&runFor(map[prefix+modifiers(shiftName,event,!1)]))return!0}else if(charCode&&
event.shiftKey&&runFor(map[prefix+modifiers(name,event,!0)]))return!0;if(runFor(map._any))return!0}return fallthrough}function getBase(view){let rect=view.scrollDOM.getBoundingClientRect();return{left:(view.textDirection==exports.Direction.LTR?rect.left:rect.right-view.scrollDOM.clientWidth)-view.scrollDOM.scrollLeft,top:rect.top-view.scrollDOM.scrollTop}}function wrappedLine(view,pos,inside){pos=state$jscomp$0.EditorSelection.cursor(pos);return{from:Math.max(inside.from,view.moveToLineBoundary(pos,
!1,!0).from),to:Math.min(inside.to,view.moveToLineBoundary(pos,!0,!0).from),type:exports.BlockType.Text}}function blockAt(view,pos){view=view.lineBlockAt(pos);if(Array.isArray(view.type))for(let l of view.type)if(l.to>pos||l.to==pos&&(l.to==view.to||l.type==exports.BlockType.Text))return l;return view}function rectanglesForRange(view,className,range){function piece(left,top,right,bottom){return new RectangleMarker(className,left-base.left,top-base.top-.01,right-left,bottom-top+.01)}function pieces({top,
bottom,horizontal}){let pieces=[];for(let i=0;i<horizontal.length;i+=2)pieces.push(piece(horizontal[i],top,horizontal[i+1],bottom));return pieces}function drawForLine(from$jscomp$0,to$jscomp$0,line){function addSpan(from,fromOpen,to,toOpen,dir){from=view.coordsAtPos(from,from==line.to?-2:2);to=view.coordsAtPos(to,to==line.from?2:-2);top=Math.min(from.top,to.top,top);bottom=Math.max(from.bottom,to.bottom,bottom);dir==exports.Direction.LTR?horizontal.push(ltr&&fromOpen?leftSide:from.left,ltr&&toOpen?
rightSide:to.right):horizontal.push(!ltr&&toOpen?leftSide:to.left,!ltr&&fromOpen?rightSide:from.right)}let top=1E9,bottom=-1E9,horizontal=[],start=null!==from$jscomp$0&&void 0!==from$jscomp$0?from$jscomp$0:line.from,end=null!==to$jscomp$0&&void 0!==to$jscomp$0?to$jscomp$0:line.to;for(let r of view.visibleRanges)if(r.to>start&&r.from<end)for(let pos=Math.max(r.from,start),endPos=Math.min(r.to,end);;){let docLine=view.state.doc.lineAt(pos);for(let span of view.bidiSpans(docLine)){let spanFrom=span.from+
docLine.from,spanTo=span.to+docLine.from;if(spanFrom>=endPos)break;spanTo>pos&&addSpan(Math.max(spanFrom,pos),null==from$jscomp$0&&spanFrom<=start,Math.min(spanTo,endPos),null==to$jscomp$0&&spanTo>=end,span.dir)}pos=docLine.to+1;if(pos>=endPos)break}0==horizontal.length&&addSpan(start,null==from$jscomp$0,end,null==to$jscomp$0,view.textDirection);return{top,bottom,horizontal}}function drawForWidget(block,top){block=contentRect.top+(top?block.top:block.bottom);return{top:block,bottom:block,horizontal:[]}}
if(range.to<=view.viewport.from||range.from>=view.viewport.to)return[];var from$jscomp$1=Math.max(range.from,view.viewport.from),to$jscomp$1=Math.min(range.to,view.viewport.to);let ltr=view.textDirection==exports.Direction.LTR;var content=view.contentDOM;let contentRect=content.getBoundingClientRect(),base=getBase(view);content=window.getComputedStyle(content.firstChild);let leftSide=contentRect.left+parseInt(content.paddingLeft)+Math.min(0,parseInt(content.textIndent)),rightSide=contentRect.right-
parseInt(content.paddingRight);content=blockAt(view,from$jscomp$1);let endBlock=blockAt(view,to$jscomp$1),visualStart=content.type==exports.BlockType.Text?content:null,visualEnd=endBlock.type==exports.BlockType.Text?endBlock:null;view.lineWrapping&&(visualStart&&(visualStart=wrappedLine(view,from$jscomp$1,visualStart)),visualEnd&&(visualEnd=wrappedLine(view,to$jscomp$1,visualEnd)));if(visualStart&&visualEnd&&visualStart.from==visualEnd.from)return pieces(drawForLine(range.from,range.to,visualStart));
from$jscomp$1=visualStart?drawForLine(range.from,null,visualStart):drawForWidget(content,!1);range=visualEnd?drawForLine(null,range.to,visualEnd):drawForWidget(endBlock,!0);to$jscomp$1=[];(visualStart||content).to<(visualEnd||endBlock).from-1?to$jscomp$1.push(piece(leftSide,from$jscomp$1.bottom,rightSide,range.top)):from$jscomp$1.bottom<range.top&&view.elementAtHeight((from$jscomp$1.bottom+range.top)/2).type==exports.BlockType.Text&&(from$jscomp$1.bottom=range.top=(from$jscomp$1.bottom+range.top)/
2);return pieces(from$jscomp$1).concat(to$jscomp$1).concat(pieces(range))}function layer$jscomp$0(config){return[ViewPlugin.define(v=>new LayerView(v,config)),layerOrder.of(config)]}function configChanged(update){return update.startState.facet(selectionConfig)!=update.state.facet(selectionConfig)}function iterMatches(doc,re,from,to,f){re.lastIndex=0;for(let cursor=doc.iterRange(from,to),pos=from,m;!cursor.next().done;pos+=cursor.value.length)if(!cursor.lineBreak)for(;m=re.exec(cursor.value);)f(pos+
m.index,m)}function matchRanges(view,maxLength){let visible=view.visibleRanges;if(1==visible.length&&visible[0].from==view.viewport.from&&visible[0].to==view.viewport.to)return visible;let result=[];for(let {from,to}of visible)from=Math.max(view.state.doc.lineAt(from).from,from-maxLength),to=Math.min(view.state.doc.lineAt(to).to,to+maxLength),result.length&&result[result.length-1].to>=from?result[result.length-1].to=to:result.push({from,to});return result}function specialCharPlugin(){return _plugin||
(_plugin=ViewPlugin.fromClass(class{constructor(view){this.view=view;this.decorations=Decoration.none;this.decorationCache=Object.create(null);this.decorator=this.makeDecorator(view.state.facet(specialCharConfig));this.decorations=this.decorator.createDeco(view)}makeDecorator(conf){return new MatchDecorator({regexp:conf.specialChars,decoration:(m,view,pos)=>{var {doc}=view.state;m=state$jscomp$0.codePointAt(m[0],0);return 9==m?(doc=doc.lineAt(pos),view=view.state.tabSize,pos=state$jscomp$0.countColumn(doc.text,
view,pos-doc.from),Decoration.replace({widget:new TabWidget((view-pos%view)*this.view.defaultCharacterWidth)})):this.decorationCache[m]||(this.decorationCache[m]=Decoration.replace({widget:new SpecialCharWidget(conf,m)}))},boundary:conf.replaceTabs?void 0:/[^]/})}update(update){let conf=update.state.facet(specialCharConfig);update.startState.facet(specialCharConfig)!=conf?(this.decorator=this.makeDecorator(conf),this.decorations=this.decorator.createDeco(update.view)):this.decorations=this.decorator.updateDeco(update,
this.decorations)}},{decorations:v=>v.decorations}))}function getPos(view,event){var offset=view.posAtCoords({x:event.clientX,y:event.clientY},!1);let line=view.state.doc.lineAt(offset),off=offset-line.from;2E3<off?view=-1:off==line.length?(event=event.clientX,view=(offset=view.coordsAtPos(view.viewport.from))?Math.round(Math.abs((offset.left-event)/view.defaultCharacterWidth)):-1):view=state$jscomp$0.countColumn(line.text,view.state.tabSize,offset-line.from);return{line:line.number,col:view,off}}
function rectangleSelectionStyle(view,event$jscomp$0){let start$jscomp$0=getPos(view,event$jscomp$0),startSel=view.state.selection;return start$jscomp$0?{update(update){if(update.docChanged){var newStart=update.changes.mapPos(update.startState.doc.line(start$jscomp$0.line).from);newStart=update.state.doc.lineAt(newStart);start$jscomp$0={line:newStart.number,col:start$jscomp$0.col,off:Math.min(start$jscomp$0.off,newStart.length)};startSel=startSel.map(update.changes)}},get(event,_extend,multiple){var cur=
getPos(view,event);if(!cur)return startSel;event=view.state;var a=start$jscomp$0,startLine=Math.min(a.line,cur.line);_extend=Math.max(a.line,cur.line);let ranges=[];if(2E3<a.off||2E3<cur.off||0>a.col||0>cur.col){var startOff=Math.min(a.off,cur.off);for(cur=Math.max(a.off,cur.off);startLine<=_extend;startLine++)a=event.doc.line(startLine),a.length<=cur&&ranges.push(state$jscomp$0.EditorSelection.range(a.from+startOff,a.to+cur))}else for(startOff=Math.min(a.col,cur.col),cur=Math.max(a.col,cur.col);startLine<=
_extend;startLine++){a=event.doc.line(startLine);let start=state$jscomp$0.findColumn(a.text,startOff,event.tabSize,!0);if(0>start)ranges.push(state$jscomp$0.EditorSelection.cursor(a.to));else{let end=state$jscomp$0.findColumn(a.text,cur,event.tabSize);ranges.push(state$jscomp$0.EditorSelection.range(a.from+start,a.from+end))}}return ranges.length?multiple?state$jscomp$0.EditorSelection.create(ranges.concat(startSel.ranges)):state$jscomp$0.EditorSelection.create(ranges):startSel}}:null}function windowSpace(view){({win:view}=
view);return{top:0,left:0,bottom:view.innerHeight,right:view.innerWidth}}function isInTooltip(elt){for(;elt;elt=elt.parentNode)if(1==elt.nodeType&&elt.classList.contains("cm-tooltip"))return!0;return!1}function rm(node){let next=node.nextSibling;node.remove();return next}function gutters(config){let result=[gutterView];config&&!1===config.fixed&&result.push(unfixGutters.of(!0));return result}function asArray(val){return Array.isArray(val)?val:[val]}function advanceCursor(cursor,collect,pos){for(;cursor.value&&
cursor.from<=pos;)cursor.from==pos&&collect.push(cursor.value),cursor.next()}function formatNumber(view,number){return view.state.facet(lineNumberConfig).formatNumber(number,view.state)}function maxLineNumber(lines){let last=9;for(;last<lines;)last=10*last+9;return last}function matcher(decorator){return ViewPlugin.define(view=>({decorations:decorator.createDeco(view),update(u){this.decorations=decorator.updateDeco(u,this.decorations)}}),{decorations:v=>v.decorations})}Object.defineProperty(exports,
...
null}}ContentView.prototype.breakAfter=0;class ChildCursor{constructor(children,pos,i){this.children=children;this.pos=pos;this.i=i;this.off=0}findPos(pos,bias=1){for(;;){if(pos>this.pos||pos==this.pos&&(0<bias||0==this.i||this.children[this.i-1].breakAfter))return this.off=pos-this.pos,this;let next=this.children[--this.i];this.pos-=next.length+next.breakAfter}}}let nav="undefined"!=typeof navigator?navigator:{userAgent:"",vendor:"",platform:""},doc$jscomp$0="undefined"!=typeof document?document:
{documentElement:{style:{}}};const ie_edge=/Edge\/(\d+)/.exec(nav.userAgent),ie_upto10=/MSIE \d/.test(nav.userAgent),ie_11up=/Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(nav.userAgent),ie=!!(ie_upto10||ie_11up||ie_edge),gecko=!ie&&/gecko\/(\d+)/i.test(nav.userAgent),chrome=!ie&&/Chrome\/(\d+)/.exec(nav.userAgent),webkit="webkitFontSmoothing"in doc$jscomp$0.documentElement.style,safari=!ie&&/Apple Computer/.test(nav.vendor),ios=safari&&(/Mobile\/\w+/.test(nav.userAgent)||2<nav.maxTouchPoints);var browser=
{mac:ios||/Mac/.test(nav.platform),windows:/Win/.test(nav.platform),linux:/Linux|X11/.test(nav.platform),ie,ie_version:ie_upto10?doc$jscomp$0.documentMode||6:ie_11up?+ie_11up[1]:ie_edge?+ie_edge[1]:0,gecko,gecko_version:gecko?+(/Firefox\/(\d+)/.exec(nav.userAgent)||[0,0])[1]:0,chrome:!!chrome,chrome_version:chrome?+chrome[1]:0,ios,android:/Android\b/.test(nav.userAgent),webkit,safari,webkit_version:webkit?+(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent)||[0,0])[1]:0,tabSize:null!=doc$jscomp$0.documentElement.style.tabSize?
"tab-size":"-moz-tab-size"};class TextView extends ContentView{constructor(text){super();this.text=text}get length(){return this.text.length}createDOM(textDOM){this.setDOM(textDOM||document.createTextNode(this.text))}sync(track){this.dom||this.createDOM();this.dom.nodeValue!=this.text&&(track&&track.node==this.dom&&(track.written=!0),this.dom.nodeValue=this.text)}reuseDOM(dom){3==dom.nodeType&&this.createDOM(dom)}merge(from,to,source){if(source&&(!(source instanceof TextView)||256<this.length-(to-
from)+source.length))return!1;this.text=this.text.slice(0,from)+(source?source.text:"")+this.text.slice(to);this.markDirty();return!0}split(from){let result=new TextView(this.text.slice(from));this.text=this.text.slice(0,from);this.markDirty();return result}localPosFromDOM(node,offset){return node==this.dom?offset:offset?this.text.length:0}domAtPos(pos){return new DOMPos(this.dom,pos)}domBoundsAround(_from,_to,offset){return{from:offset,to:offset+this.length,startDOM:this.dom,endDOM:this.dom.nextSibling}}coordsAt(pos,
side){return textCoords(this.dom,pos,side)}}class MarkView extends ContentView{constructor(mark,children=[],length=0){super();this.mark=mark;this.children=children;this.length=length;for(let ch of children)ch.setParent(this)}setAttrs(dom){clearAttributes(dom);this.mark.class&&(dom.className=this.mark.class);if(this.mark.attrs)for(let name in this.mark.attrs)dom.setAttribute(name,this.mark.attrs[name]);return dom}reuseDOM(node){node.nodeName==this.mark.tagName.toUpperCase()&&(this.setDOM(node),this.dirty|=
6)}sync(track){this.dom?this.dirty&4&&this.setAttrs(this.dom):this.setDOM(this.setAttrs(document.createElement(this.mark.tagName)));super.sync(track)}merge(from,to,source,_hasStart,openStart,openEnd){if(source&&(!(source instanceof MarkView&&source.mark.eq(this.mark))||from&&0>=openStart||to<this.length&&0>=openEnd))return!1;mergeChildrenInto(this,from,to,source?source.children:[],openStart-1,openEnd-1);this.markDirty();return!0}split(from){let result=[];var off=0;let detachFrom=-1,i=0;for(let elt of this.children){let end=
...
let rect;if(!side.length)return Rect0;for(let i=0<pos?side.length-1:0;!(rect=side[i],0<pos?0==i:i==side.length-1||rect.top<rect.bottom);i+=0<pos?-1:1);return this.length?rect:flattenRect(rect,0<this.side)}get isEditable(){return!1}destroy(){super.destroy();this.dom&&this.widget.destroy(this.dom)}}class CompositionView extends WidgetView{domAtPos(pos){let {topView,text}=this.widget;return topView?scanCompositionTree(pos,0,topView,text,(v,p)=>v.domAtPos(p),p=>new DOMPos(text,Math.min(p,text.nodeValue.length))):
new DOMPos(text,Math.min(pos,text.nodeValue.length))}sync(){this.setDOM(this.widget.toDOM())}localPosFromDOM(node,offset){let {topView,text}=this.widget;return topView?posFromDOMInCompositionTree(node,offset,topView,text):Math.min(offset,this.length)}ignoreMutation(){return!1}get overrideDOMText(){return null}coordsAt(pos$jscomp$0,side$jscomp$0){let {topView,text}=this.widget;return topView?scanCompositionTree(pos$jscomp$0,side$jscomp$0,topView,text,(v,pos,side)=>v.coordsAt(pos,side),(pos,side)=>
textCoords(text,pos,side)):textCoords(text,pos$jscomp$0,side$jscomp$0)}destroy(){var _a;super.destroy();null===(_a=this.widget.topView)||void 0===_a?void 0:_a.destroy()}get isEditable(){return!0}canReuseDOM(){return!0}}class WidgetBufferView extends ContentView{constructor(side){super();this.side=side}get length(){return 0}merge(){return!1}become(other){return other instanceof WidgetBufferView&&other.side==this.side}split(){return new WidgetBufferView(this.side)}sync(){if(!this.dom){let dom=document.createElement("img");
dom.className="cm-widgetBuffer";dom.setAttribute("aria-hidden","true");this.setDOM(dom)}}getSide(){return this.side}domAtPos(pos){return DOMPos.before(this.dom)}localPosFromDOM(){return 0}domBoundsAround(){return null}coordsAt(pos){pos=this.dom.getBoundingClientRect();a:{var JSCompiler_inline_result=0<this.side?-1:1;let parent=this.parent,index=parent?parent.children.indexOf(this):-1;for(;parent&&0<=index;)if(0>JSCompiler_inline_result?0<index:index<parent.children.length){var next=parent.children[index+
JSCompiler_inline_result];if(next instanceof TextView&&(next=next.coordsAt(0>JSCompiler_inline_result?next.length:0,JSCompiler_inline_result))){JSCompiler_inline_result=next;break a}index+=JSCompiler_inline_result}else if(parent instanceof MarkView&&parent.parent)index=parent.parent.children.indexOf(parent)+(0>JSCompiler_inline_result?0:1),parent=parent.parent;else{if((JSCompiler_inline_result=parent.dom.lastChild)&&"BR"==JSCompiler_inline_result.nodeName){JSCompiler_inline_result=JSCompiler_inline_result.getClientRects()[0];
break a}break}JSCompiler_inline_result=void 0}return JSCompiler_inline_result&&JSCompiler_inline_result.top<pos.bottom&&JSCompiler_inline_result.bottom>pos.top?{left:pos.left,right:pos.right,top:JSCompiler_inline_result.top,bottom:JSCompiler_inline_result.bottom}:pos}get overrideDOMText(){return state$jscomp$0.Text.empty}}TextView.prototype.children=WidgetView.prototype.children=WidgetBufferView.prototype.children=noChildren;class WidgetType{eq(widget){return!1}updateDOM(dom){return!1}compare(other){return this==
...
LineDecoration&&this.spec.class==other.spec.class&&attrsEq(this.spec.attributes,other.spec.attributes)}range(from,to=from){if(to!=from)throw new RangeError("Line decoration ranges must be zero-length");return super.range(from,to)}}LineDecoration.prototype.mapMode=state$jscomp$0.MapMode.TrackBefore;LineDecoration.prototype.point=!0;class PointDecoration extends Decoration{constructor(spec,startSide,endSide,block,widget,isReplace){super(startSide,endSide,widget,spec);this.block=block;this.isReplace=
isReplace;this.mapMode=block?0>=startSide?state$jscomp$0.MapMode.TrackBefore:state$jscomp$0.MapMode.TrackAfter:state$jscomp$0.MapMode.TrackDel}get type(){return this.startSide<this.endSide?exports.BlockType.WidgetRange:0>=this.startSide?exports.BlockType.WidgetBefore:exports.BlockType.WidgetAfter}get heightRelevant(){return this.block||!!this.widget&&5<=this.widget.estimatedHeight}eq(other){var JSCompiler_temp;if(JSCompiler_temp=other instanceof PointDecoration){JSCompiler_temp=this.widget;var b=
other.widget;JSCompiler_temp=JSCompiler_temp==b||!!(JSCompiler_temp&&b&&JSCompiler_temp.compare(b))}return JSCompiler_temp&&this.block==other.block&&this.startSide==other.startSide&&this.endSide==other.endSide}range(from,to=from){if(this.isReplace&&(from>to||from==to&&0<this.startSide&&0>=this.endSide))throw new RangeError("Invalid range for replacement decoration");if(!this.isReplace&&to!=from)throw new RangeError("Widget decorations can only have zero-length ranges");return super.range(from,to)}}
PointDecoration.prototype.point=!0;class LineView extends ContentView{constructor(){super(...arguments);this.children=[];this.length=0;this.prevAttrs=void 0;this.attrs=null;this.breakAfter=0}merge(from,to,source,hasStart,openStart,openEnd){if(source){if(!(source instanceof LineView))return!1;this.dom||source.transferDOM(this)}hasStart&&this.setDeco(source?source.attrs:null);mergeChildrenInto(this,from,to,source?source.children:[],openStart,openEnd);return!0}split(at){let end=new LineView;end.breakAfter=
this.breakAfter;if(0==this.length)return end;let {i,off}=this.childPos(at);off&&(end.append(this.children[i].split(off),0),this.children[i].merge(off,this.children[i].length,null,!1,0,0),i++);for(let j=i;j<this.children.length;j++)end.append(this.children[j],0);for(;0<i&&0==this.children[i-1].length;)this.children[--i].destroy();this.children.length=i;this.markDirty();this.length=at;return end}transferDOM(other){this.dom&&(this.markDirty(),other.setDOM(this.dom),other.prevAttrs=void 0===this.prevAttrs?
this.attrs:this.prevAttrs,this.prevAttrs=void 0,this.dom=null)}setDeco(attrs){attrsEq(this.attrs,attrs)||(this.dom&&(this.prevAttrs=this.attrs,this.markDirty()),this.attrs=attrs)}append(child,openStart){joinInlineInto(this,child,openStart)}addLineDeco(deco){let attrs=deco.spec.attributes;deco=deco.spec.class;attrs&&(this.attrs=combineAttrs(attrs,this.attrs||{}));deco&&(this.attrs=combineAttrs({class:deco},this.attrs||{}))}domAtPos(pos){return inlineDOMAtPos(this,pos)}reuseDOM(node){"DIV"==node.nodeName&&
(this.setDOM(node),this.dirty|=6)}sync(track){var _a;this.dom?this.dirty&4&&(clearAttributes(this.dom),this.dom.className="cm-line",this.prevAttrs=this.attrs?null:void 0):(this.setDOM(document.createElement("div")),this.dom.className="cm-line",this.prevAttrs=this.attrs?null:void 0);void 0!==this.prevAttrs&&(updateAttrs(this.dom,this.prevAttrs,this.attrs),this.dom.classList.add("cm-line"),this.prevAttrs=void 0);super.sync(track);for(track=this.dom.lastChild;track&&ContentView.get(track)instanceof MarkView;)track=
track.lastChild;track&&this.length&&("BR"==track.nodeName||0!=(null===(_a=ContentView.get(track))||void 0===_a?void 0:_a.isEditable)||browser.ios&&this.children.some(ch=>ch instanceof TextView))||(_a=document.createElement("BR"),_a.cmIgnore=!0,this.dom.appendChild(_a))}measureTextSize(){if(0==this.children.length||20<this.length)return null;let totalWidth=0;for(let child of this.children){if(!(child instanceof TextView)||/[^ -~]/.test(child.text))return null;let rects=clientRectsFor(child.dom);if(1!=
rects.length)return null;totalWidth+=rects[0].width}return totalWidth?{lineHeight:this.dom.getBoundingClientRect().height,charWidth:totalWidth/this.length}:null}coordsAt(pos,side){return coordsInChildren(this,pos,side)}become(_other){return!1}get type(){return exports.BlockType.Text}static find(docView,pos){for(let i=0,off=0;i<docView.children.length;i++){let block=docView.children[i],end=off+block.length;if(end>=pos){if(block instanceof LineView)return block;if(end>pos)break}off=end+block.breakAfter}return null}}
...
pos==this.length)}split(at){let len=this.length-at;this.length=at;at=new BlockWidgetView(this.widget,len,this.type);at.breakAfter=this.breakAfter;return at}get children(){return noChildren}sync(){this.dom&&this.widget.updateDOM(this.dom)||(this.dom&&this.prevWidget&&this.prevWidget.destroy(this.dom),this.prevWidget=null,this.setDOM(this.widget.toDOM(this.editorView)),this.dom.contentEditable="false")}get overrideDOMText(){return this.parent?this.parent.view.state.doc.slice(this.posAtStart,this.posAtEnd):
state$jscomp$0.Text.empty}domBoundsAround(){return null}become(other){return other instanceof BlockWidgetView&&other.type==this.type&&other.widget.constructor==this.widget.constructor?(other.widget.eq(this.widget)||this.markDirty(!0),this.dom&&!this.prevWidget&&(this.prevWidget=this.widget),this.widget=other.widget,this.length=other.length,this.breakAfter=other.breakAfter,!0):!1}ignoreMutation(){return!0}ignoreEvent(event){return this.widget.ignoreEvent(event)}destroy(){super.destroy();this.dom&&
this.widget.destroy(this.dom)}}class ContentBuilder{constructor(doc,pos,end,disallowBlockEffectsFor){this.doc=doc;this.pos=pos;this.end=end;this.disallowBlockEffectsFor=disallowBlockEffectsFor;this.content=[];this.curLine=null;this.pendingBuffer=this.breakAtStart=0;this.bufferMarks=[];this.atCursorPos=!0;this.openEnd=this.openStart=-1;this.text="";this.textOff=0;this.cursor=doc.iter();this.skip=pos}posCovered(){if(0==this.content.length)return!this.breakAtStart&&this.doc.lineAt(this.pos).from!=this.pos;
let last=this.content[this.content.length-1];return!last.breakAfter&&!(last instanceof BlockWidgetView&&last.type==exports.BlockType.WidgetBefore)}getLine(){this.curLine||(this.content.push(this.curLine=new LineView),this.atCursorPos=!0);return this.curLine}flushBuffer(active=this.bufferMarks){this.pendingBuffer&&(this.curLine.append(wrapMarks(new WidgetBufferView(-1),active),active.length),this.pendingBuffer=0)}addBlockWidget(view){this.flushBuffer();this.curLine=null;this.content.push(view)}finish(openEnd){this.pendingBuffer&&
openEnd<=this.bufferMarks.length?this.flushBuffer():this.pendingBuffer=0;this.posCovered()||this.getLine()}buildText(length,active,openStart){for(;0<length;){if(this.textOff==this.text.length){let {value,lineBreak,done}=this.cursor.next(this.skip);this.skip=0;if(done)throw Error("Ran out of text content when drawing inline views");if(lineBreak){this.posCovered()||this.getLine();this.content.length?this.content[this.content.length-1].breakAfter=1:this.breakAtStart=1;this.flushBuffer();this.curLine=
null;this.atCursorPos=!0;length--;continue}else this.text=value,this.textOff=0}let take=Math.min(this.text.length-this.textOff,length,512);this.flushBuffer(active.slice(active.length-openStart));this.getLine().append(wrapMarks(new TextView(this.text.slice(this.textOff,this.textOff+take)),active),openStart);this.atCursorPos=!0;this.textOff+=take;length-=take;openStart=0}}span(from,to,active,openStart){this.buildText(to-from,active,openStart);this.pos=to;0>this.openStart&&(this.openStart=openStart)}point(from,
to,deco,active,openStart,index){if(this.disallowBlockEffectsFor[index]&&deco instanceof PointDecoration){if(deco.block)throw new RangeError("Block decorations may not be specified via plugins");if(to>this.doc.lineAt(this.pos).to)throw new RangeError("Decorations that replace line breaks may not be specified via plugins");}index=to-from;if(deco instanceof PointDecoration)if(deco.block)({type:from}=deco),from!=exports.BlockType.WidgetAfter||this.posCovered()||this.getLine(),this.addBlockWidget(new BlockWidgetView(deco.widget||
new NullWidget("div"),index,from));else{let view=WidgetView.create(deco.widget||new NullWidget("span"),index,index?0:deco.startSide),cursorBefore=this.atCursorPos&&!view.isEditable&&openStart<=active.length&&(from<to||0<deco.startSide);deco=!view.isEditable&&(from<to||openStart>active.length||0>=deco.startSide);let line=this.getLine();2!=this.pendingBuffer||cursorBefore||(this.pendingBuffer=0);this.flushBuffer(active);cursorBefore&&(line.append(wrapMarks(new WidgetBufferView(1),active),openStart),
openStart=active.length+Math.max(0,openStart-active.length));line.append(wrapMarks(view,active),openStart);if(this.pendingBuffer=(this.atCursorPos=deco)?from<to||openStart>active.length?1:2:0)this.bufferMarks=active.slice()}else this.doc.lineAt(this.pos).from==this.pos&&this.getLine().addLineDeco(deco);index&&(this.textOff+index<=this.text.length?this.textOff+=index:(this.skip+=index-(this.text.length-this.textOff),this.text="",this.textOff=0),this.pos=to);0>this.openStart&&(this.openStart=openStart)}static build(text,
...
class InputState{constructor(view){this.lastScrollLeft=this.lastScrollTop=this.lastFocusTime=this.lastTouchTime=this.lastKeyTime=this.lastKeyCode=0;this.chromeScrollHack=-1;this.pendingIOSKey=void 0;this.lastSelectionOrigin=null;this.lastContextMenu=this.lastEscPress=this.lastSelectionTime=0;this.scrollHandlers=[];this.registeredEvents=[];this.customHandlers=[];this.composing=-1;this.compositionFirstChange=null;this.compositionEndedAt=0;this.mouseSelection=null;let handleEvent=(handler,event)=>{this.ignoreDuringComposition(event)||
"keydown"==event.type&&this.keydown(view,event)||(this.mustFlushObserver(event)&&view.observer.forceFlush(),this.runCustomHandlers(event.type,view,event)?event.preventDefault():handler(view,event))};for(let type in handlers){let handler=handlers[type];view.contentDOM.addEventListener(type,event=>{eventBelongsToEditor(view,event)&&handleEvent(handler,event)},handlerOptions[type]);this.registeredEvents.push(type)}view.scrollDOM.addEventListener("mousedown",event=>{event.target==view.scrollDOM&&handleEvent(handlers.mousedown,
event)});browser.chrome&&102==browser.chrome_version&&view.scrollDOM.addEventListener("wheel",()=>{0>this.chromeScrollHack?view.contentDOM.style.pointerEvents="none":window.clearTimeout(this.chromeScrollHack);this.chromeScrollHack=setTimeout(()=>{this.chromeScrollHack=-1;view.contentDOM.style.pointerEvents=""},100)},{passive:!0});this.notifiedFocused=view.hasFocus;browser.safari&&view.contentDOM.addEventListener("input",()=>null)}setSelectionOrigin(origin){this.lastSelectionOrigin=origin;this.lastSelectionTime=
Date.now()}ensureHandlers(view,plugins){var _a;this.customHandlers=[];for(let plugin of plugins)if(plugins=null===(_a=plugin.update(view).spec)||void 0===_a?void 0:_a.domEventHandlers){this.customHandlers.push({plugin:plugin.value,handlers:plugins});for(let type in plugins)0>this.registeredEvents.indexOf(type)&&"scroll"!=type&&(this.registeredEvents.push(type),view.contentDOM.addEventListener(type,event=>{eventBelongsToEditor(view,event)&&this.runCustomHandlers(type,view,event)&&event.preventDefault()}))}}runCustomHandlers(type,
view,event){for(let set of this.customHandlers){let handler=set.handlers[type];if(handler)try{if(handler.call(set.plugin,event,view)||event.defaultPrevented)return!0}catch(e){logException(view.state,e)}}return!1}runScrollHandlers(view,event){this.lastScrollTop=view.scrollDOM.scrollTop;this.lastScrollLeft=view.scrollDOM.scrollLeft;for(let set of this.customHandlers){let handler=set.handlers.scroll;if(handler)try{handler.call(set.plugin,event,view)}catch(e){logException(view.state,e)}}}keydown(view,
event){this.lastKeyCode=event.keyCode;this.lastKeyTime=Date.now();if(9==event.keyCode&&Date.now()<this.lastEscPress+2E3)return!0;if(browser.android&&browser.chrome&&!event.synthetic&&(13==event.keyCode||8==event.keyCode))return view.observer.delayAndroidKey(event.key,event.keyCode),!0;let pending;return!browser.ios||event.synthetic||event.altKey||event.metaKey||!((pending=PendingKeys.find(key=>key.keyCode==event.keyCode))&&!event.ctrlKey||-1<"dthko".indexOf(event.key)&&event.ctrlKey&&!event.shiftKey)?
!1:(this.pendingIOSKey=pending||event,setTimeout(()=>this.flushIOSKey(view),250),!0)}flushIOSKey(view){let key=this.pendingIOSKey;if(!key)return!1;this.pendingIOSKey=void 0;return dispatchKey(view.contentDOM,key.key,key.keyCode)}ignoreDuringComposition(event){return/^key/.test(event.type)?0<this.composing?!0:browser.safari&&!browser.ios&&100>Date.now()-this.compositionEndedAt?(this.compositionEndedAt=0,!0):!1:!1}mustFlushObserver(event){return"keydown"==event.type&&229!=event.keyCode}startMouseSelection(mouseSelection){this.mouseSelection&&
this.mouseSelection.destroy();this.mouseSelection=mouseSelection}update(update){this.mouseSelection&&this.mouseSelection.update(update);update.transactions.length&&(this.lastKeyCode=this.lastSelectionTime=0)}destroy(){this.mouseSelection&&this.mouseSelection.destroy()}}const PendingKeys=[{key:"Backspace",keyCode:8,inputType:"deleteContentBackward"},{key:"Enter",keyCode:13,inputType:"insertParagraph"},{key:"Delete",keyCode:46,inputType:"deleteContentForward"}],modifierCodes=[16,17,18,20,91,92,224,
225];class MouseSelection{constructor(view,startEvent,style,mustSelect){this.view=view;this.style=style;this.mustSelect=mustSelect;this.scrollSpeed={x:0,y:0};this.scrolling=-1;this.lastEvent=startEvent;a:{mustSelect=view.contentDOM;style=mustSelect.ownerDocument;for(mustSelect=mustSelect.parentNode;mustSelect&&mustSelect!=style.body;)if(1==mustSelect.nodeType){if(mustSelect.scrollHeight>mustSelect.clientHeight||mustSelect.scrollWidth>mustSelect.clientWidth){style=mustSelect;break a}mustSelect=mustSelect.assignedSlot||
mustSelect.parentNode}else if(11==mustSelect.nodeType)mustSelect=mustSelect.host;else break;style=null}this.scrollParent=style;style=view.contentDOM.ownerDocument;style.addEventListener("mousemove",this.move=this.move.bind(this));style.addEventListener("mouseup",this.up=this.up.bind(this));this.extend=startEvent.shiftKey;if(style=view.state.facet(state$jscomp$0.EditorState.allowMultipleSelections))style=view.state.facet(clickAddsSelectionRange),style=style.length?style[0](startEvent):browser.mac?
startEvent.metaKey:startEvent.ctrlKey;this.multiple=style;style=view.state.facet(dragMovesSelection$1);this.dragMove=style.length?style[0](startEvent):browser.mac?!startEvent.altKey:!startEvent.ctrlKey;this.dragging=isInPrimarySelection(view,startEvent)&&1==getClickType(startEvent)?null:!1;!1===this.dragging&&(startEvent.preventDefault(),this.select(startEvent))}move(event){var _a;if(0==event.buttons)return this.destroy();if(!1===this.dragging){this.select(this.lastEvent=event);var sx=0,sy=0,rect=
(null===(_a=this.scrollParent)||void 0===_a?void 0:_a.getBoundingClientRect())||{left:0,top:0,right:this.view.win.innerWidth,bottom:this.view.win.innerHeight};event.clientX<=rect.left?sx=-(.7*(rect.left-event.clientX)+8):event.clientX>=rect.right&&(sx=.7*(event.clientX-rect.right)+8);event.clientY<=rect.top?sy=-(.7*(rect.top-event.clientY)+8):event.clientY>=rect.bottom&&(sy=.7*(event.clientY-rect.bottom)+8);this.setScrollSpeed(sx,sy)}}up(event){null==this.dragging&&this.select(this.lastEvent);this.dragging||
event.preventDefault();this.destroy()}destroy(){this.setScrollSpeed(0,0);let doc=this.view.contentDOM.ownerDocument;doc.removeEventListener("mousemove",this.move);doc.removeEventListener("mouseup",this.up);this.view.inputState.mouseSelection=null}setScrollSpeed(sx,sy){this.scrollSpeed={x:sx,y:sy};sx||sy?0>this.scrolling&&(this.scrolling=setInterval(()=>this.scroll(),50)):-1<this.scrolling&&(clearInterval(this.scrolling),this.scrolling=-1)}scroll(){this.scrollParent?(this.scrollParent.scrollLeft+=
this.scrollSpeed.x,this.scrollParent.scrollTop+=this.scrollSpeed.y):this.view.win.scrollBy(this.scrollSpeed.x,this.scrollSpeed.y);!1===this.dragging&&this.select(this.lastEvent)}select(event){event=this.style.get(event,this.extend,this.multiple);!this.mustSelect&&event.eq(this.view.state.selection)&&event.main.assoc==this.view.state.selection.main.assoc||this.view.dispatch({selection:event,userEvent:"select.pointer"});this.mustSelect=!1}update(update){update.docChanged&&this.dragging&&(this.dragging=
this.dragging.map(update.changes));this.style.update(update)&&setTimeout(()=>this.select(this.lastEvent),20)}}const handlers=Object.create(null),handlerOptions=Object.create(null),brokenClipboardAPI=browser.ie&&15>browser.ie_version||browser.ios&&604>browser.webkit_version;handlers.keydown=(view,event)=>{view.inputState.setSelectionOrigin("select");27==event.keyCode?view.inputState.lastEscPress=Date.now():0>modifierCodes.indexOf(event.keyCode)&&(view.inputState.lastEscPress=0)};handlers.touchstart=
(view,e)=>{view.inputState.lastTouchTime=Date.now();view.inputState.setSelectionOrigin("select.pointer")};handlers.touchmove=view=>{view.inputState.setSelectionOrigin("select.pointer")};handlerOptions.touchstart=handlerOptions.touchmove={passive:!0};handlers.mousedown=(view,event)=>{view.observer.flush();if(!(view.inputState.lastTouchTime>Date.now()-2E3)){var style=null;for(var makeStyle of view.state.facet(mouseSelectionStyle))if(style=makeStyle(view,event))break;style||0!=event.button||(style=basicMouseSelection(view,
event));style&&((makeStyle=view.root.activeElement!=view.contentDOM)&&view.observer.ignore(()=>focusPreventScroll(view.contentDOM)),view.inputState.startMouseSelection(new MouseSelection(view,event,style,makeStyle)))}};const BadMouseDetail=browser.ie&&11>=browser.ie_version;let lastMouseDown=null,lastMouseDownCount=0,lastMouseDownTime=0;handlers.dragstart=(view,event)=>{let {selection:{main}}=view.state,{mouseSelection}=view.inputState;mouseSelection&&(mouseSelection.dragging=main);event.dataTransfer&&
(event.dataTransfer.setData("Text",view.state.sliceDoc(main.from,main.to)),event.dataTransfer.effectAllowed="copyMove")};handlers.drop=(view,event)=>{if(event.dataTransfer){if(view.state.readOnly)return event.preventDefault();var files=event.dataTransfer.files;if(files&&files.length){event.preventDefault();let text=Array(files.length),read=0,finishFile=()=>{++read==files.length&&dropText(view,event,text.filter(s=>null!=s).join(view.state.lineBreak),!1)};for(let i=0;i<files.length;i++){let reader=
new FileReader;reader.onerror=finishFile;reader.onload=()=>{/[\x00-\x08\x0e-\x1f]{2}/.test(reader.result)||(text[i]=reader.result);finishFile()};reader.readAsText(files[i])}}else dropText(view,event,event.dataTransfer.getData("Text"),!0)}};handlers.paste=(view,event)=>{if(view.state.readOnly)return event.preventDefault();view.observer.flush();let data=brokenClipboardAPI?null:event.clipboardData;data?(doPaste(view,data.getData("text/plain")),event.preventDefault()):capturePaste(view)};let lastLinewiseCopy=
null;handlers.copy=handlers.cut=(view,event)=>{var JSCompiler_inline_result=view.state;let content=[],ranges=[];var linewise=!1;for(var range of JSCompiler_inline_result.selection.ranges)range.empty||(content.push(JSCompiler_inline_result.sliceDoc(range.from,range.to)),ranges.push(range));if(!content.length){linewise=-1;for(let {from}of JSCompiler_inline_result.selection.ranges)range=JSCompiler_inline_result.doc.lineAt(from),range.number>linewise&&(content.push(range.text),ranges.push({from:range.from,
to:Math.min(JSCompiler_inline_result.doc.length,range.to+1)})),linewise=range.number;linewise=!0}JSCompiler_inline_result={text:content.join(JSCompiler_inline_result.lineBreak),ranges,linewise};let {text,ranges:ranges$jscomp$0,linewise:linewise$jscomp$0}=JSCompiler_inline_result;if(text||linewise$jscomp$0)lastLinewiseCopy=linewise$jscomp$0?text:null,(JSCompiler_inline_result=brokenClipboardAPI?null:event.clipboardData)?(event.preventDefault(),JSCompiler_inline_result.clearData(),JSCompiler_inline_result.setData("text/plain",
text)):captureCopy(view,text),"cut"!=event.type||view.state.readOnly||view.dispatch({changes:ranges$jscomp$0,scrollIntoView:!0,userEvent:"delete.cut"})};handlers.focus=view=>{view.inputState.lastFocusTime=Date.now();view.scrollDOM.scrollTop||!view.inputState.lastScrollTop&&!view.inputState.lastScrollLeft||(view.scrollDOM.scrollTop=view.inputState.lastScrollTop,view.scrollDOM.scrollLeft=view.inputState.lastScrollLeft);updateForFocusChange(view)};handlers.blur=view=>{view.observer.clearSelectionRange();
updateForFocusChange(view)};handlers.compositionstart=handlers.compositionupdate=view=>{null==view.inputState.compositionFirstChange&&(view.inputState.compositionFirstChange=!0);0>view.inputState.composing&&(view.inputState.composing=0)};handlers.compositionend=view=>{view.inputState.composing=-1;view.inputState.compositionEndedAt=Date.now();view.inputState.compositionFirstChange=null;browser.chrome&&browser.android&&view.observer.flushSoon();setTimeout(()=>{0>view.inputState.composing&&view.docView.compositionDeco.size&&
view.update([])},50)};handlers.contextmenu=view=>{view.inputState.lastContextMenu=Date.now()};handlers.beforeinput=(view,event)=>{var _a$jscomp$0;let pending;if(browser.chrome&&browser.android&&(pending=PendingKeys.find(key=>key.inputType==event.inputType))&&(view.observer.delayAndroidKey(pending.key,pending.keyCode),"Backspace"==pending.key||"Delete"==pending.key)){let startViewHeight=(null===(_a$jscomp$0=window.visualViewport)||void 0===_a$jscomp$0?void 0:_a$jscomp$0.height)||0;setTimeout(()=>{var _a;
((null===(_a=window.visualViewport)||void 0===_a?void 0:_a.height)||0)>startViewHeight+10&&view.hasFocus&&(view.contentDOM.blur(),view.focus())},100)}};const wrappingWhiteSpace=["pre-wrap","normal","pre-line","break-spaces"];class HeightOracle{constructor(lineWrapping){this.lineWrapping=lineWrapping;this.doc=state$jscomp$0.Text.empty;this.heightSamples={};this.lineHeight=14;this.charWidth=7;this.lineLength=30;this.heightChanged=!1}heightForGap(from,to){let lines=this.doc.lineAt(to).number-this.doc.lineAt(from).number+
...
!0;this.editorWidth=this.editorHeight=this.contentDOMHeight=this.contentDOMWidth=this.paddingBottom=this.paddingTop=0;this.scaler=IdScaler;this.scrollTarget=null;this.printing=!1;this.mustMeasureContent=!0;this.defaultTextDirection=exports.Direction.LTR;this.visibleRanges=[];this.mustEnforceCursorAssoc=!1;let guessWrapping=state$1.facet(contentAttributes).some(v=>"function"!=typeof v&&"cm-lineWrapping"==v.class);this.heightOracle=new HeightOracle(guessWrapping);this.stateDeco=state$1.facet(decorations).filter(d=>
"function"!=typeof d);this.heightMap=HeightMap.empty().applyChanges(this.stateDeco,state$jscomp$0.Text.empty,this.heightOracle.setDoc(state$1.doc),[new ChangedRange(0,0,0,state$1.doc.length)]);this.viewport=this.getViewport(0,null);this.updateViewportLines();this.updateForViewport();this.lineGaps=this.ensureLineGaps([]);this.lineGapDeco=Decoration.set(this.lineGaps.map(gap=>gap.draw(!1)));this.computeVisibleRanges()}updateForViewport(){let viewports=[this.viewport],{main}=this.state.selection;for(let i=
0;1>=i;i++){let pos=i?main.head:main.anchor;if(!viewports.some(({from,to})=>pos>=from&&pos<=to)){let {from,to}=this.lineBlockAt(pos);viewports.push(new Viewport(from,to))}}this.viewports=viewports.sort((a,b)=>a.from-b.from);this.scaler=7E6>=this.heightMap.height?IdScaler:new BigScaler(this.heightOracle.doc,this.heightMap,this.viewports)}updateViewportLines(){this.viewportLines=[];this.heightMap.forEachLine(this.viewport.from,this.viewport.to,this.state.doc,0,0,block=>{this.viewportLines.push(1==this.scaler.scale?
...
state$jscomp$0.Facet.define({combine:values=>-1<values.indexOf(!0)}),baseThemeID=styleMod.StyleModule.newName(),baseLightID=styleMod.StyleModule.newName(),baseDarkID=styleMod.StyleModule.newName(),lightDarkIDs={"\x26light":"."+baseLightID,"\x26dark":"."+baseDarkID},baseTheme$1=buildTheme("."+baseThemeID,{"\x26":{position:"relative !important",boxSizing:"border-box","\x26.cm-focused":{outline:"1px dotted #212121"},display:"flex !important",flexDirection:"column"},".cm-scroller":{display:"flex !important",
alignItems:"flex-start !important",fontFamily:"monospace",lineHeight:1.4,height:"100%",overflowX:"auto",position:"relative",zIndex:0},".cm-content":{margin:0,flexGrow:2,flexShrink:0,display:"block",whiteSpace:"pre",wordWrap:"normal",boxSizing:"border-box",padding:"4px 0",outline:"none","\x26[contenteditable\x3dtrue]":{WebkitUserModify:"read-write-plaintext-only"}},".cm-lineWrapping":{whiteSpace_fallback:"pre-wrap",whiteSpace:"break-spaces",wordBreak:"break-word",overflowWrap:"anywhere",flexShrink:1},
"\x26light .cm-content":{caretColor:"black"},"\x26dark .cm-content":{caretColor:"white"},".cm-line":{display:"block",padding:"0 2px 0 6px"},".cm-layer":{contain:"size style","\x26 \x3e *":{position:"absolute"}},"\x26light .cm-selectionBackground":{background:"#d9d9d9"},"\x26dark .cm-selectionBackground":{background:"#222"},"\x26light.cm-focused .cm-selectionBackground":{background:"#d7d4f0"},"\x26dark.cm-focused .cm-selectionBackground":{background:"#233"},".cm-cursorLayer":{pointerEvents:"none"},
"\x26.cm-focused .cm-cursorLayer":{animation:"steps(1) cm-blink 1.2s infinite"},"@keyframes cm-blink":{"0%":{},"50%":{opacity:0},"100%":{}},"@keyframes cm-blink2":{"0%":{},"50%":{opacity:0},"100%":{}},".cm-cursor, .cm-dropCursor":{borderLeft:"1.2px solid black",marginLeft:"-0.6px",pointerEvents:"none"},".cm-cursor":{display:"none"},"\x26dark .cm-cursor":{borderLeftColor:"#444"},"\x26.cm-focused .cm-cursor":{display:"block"},"\x26light .cm-activeLine":{backgroundColor:"#cceeff44"},"\x26dark .cm-activeLine":{backgroundColor:"#99eeff33"},
...
"\x26:active":{backgroundImage:"linear-gradient(#111, #333)"}},".cm-textfield":{verticalAlign:"middle",color:"inherit",fontSize:"70%",border:"1px solid silver",padding:".2em .5em"},"\x26light .cm-textfield":{backgroundColor:"white"},"\x26dark .cm-textfield":{border:"1px solid #555",backgroundColor:"inherit"}},lightDarkIDs);class DOMChange{constructor(view,start,end,typeOver){this.typeOver=typeOver;this.bounds=null;this.text="";let {impreciseHead:iHead,impreciseAnchor:iAnchor}=view.docView;if(view.state.readOnly&&
-1<start)this.newSel=null;else if(-1<start&&(this.bounds=view.docView.domBoundsAround(start,end,0))){if(iHead||iAnchor)start=[];else if(start=[],view.root.activeElement==view.contentDOM){var {anchorNode,anchorOffset,focusNode,focusOffset}=view.observer.selectionRange;anchorNode&&(start.push(new DOMPoint(anchorNode,anchorOffset)),focusNode==anchorNode&&focusOffset==anchorOffset||start.push(new DOMPoint(focusNode,focusOffset)))}view=new DOMReader(start,view.state);view.readRange(this.bounds.startDOM,
this.bounds.endDOM);this.text=view.text;view=this.bounds.from;0==start.length?view=null:(end=start[0].pos,start=2==start.length?start[1].pos:end,view=-1<end&&-1<start?state$jscomp$0.EditorSelection.single(end+view,start+view):null);this.newSel=view}else end=view.observer.selectionRange,start=iHead&&iHead.node==end.focusNode&&iHead.offset==end.focusOffset||!contains(view.contentDOM,end.focusNode)?view.state.selection.main.head:view.docView.posFromDOM(end.focusNode,end.focusOffset),view=iAnchor&&iAnchor.node==
end.anchorNode&&iAnchor.offset==end.anchorOffset||!contains(view.contentDOM,end.anchorNode)?view.state.selection.main.anchor:view.docView.posFromDOM(end.anchorNode,end.anchorOffset),this.newSel=state$jscomp$0.EditorSelection.single(view,start)}}const observeOptions={childList:!0,characterData:!0,subtree:!0,attributes:!0,characterDataOldValue:!0},useCharData=browser.ie&&11>=browser.ie_version;class DOMObserver{constructor(view){this.view=view;this.active=!1;this.selectionRange=new DOMSelectionState;
this.selectionChanged=!1;this.resizeTimeout=this.delayedFlush=-1;this.queue=[];this.delayedAndroidKey=null;this.flushingAndroidKey=-1;this.lastChange=0;this.scrollTargets=[];this.resizeContent=this.resizeScroll=this.intersection=null;this.intersecting=!1;this.gapIntersection=null;this.gaps=[];this.parentCheck=-1;this.dom=view.contentDOM;this.observer=new MutationObserver(mutations=>{for(let mut of mutations)this.queue.push(mut);(browser.ie&&11>=browser.ie_version||browser.ios&&view.composing)&&mutations.some(m=>
"childList"==m.type&&m.removedNodes.length||"characterData"==m.type&&m.oldValue.length>m.target.nodeValue.length)?this.flushSoon():this.flush()});useCharData&&(this.onCharData=event=>{this.queue.push({target:event.target,type:"characterData",oldValue:event.prevValue});this.flushSoon()});this.onSelectionChange=this.onSelectionChange.bind(this);this.onResize=this.onResize.bind(this);this.onPrint=this.onPrint.bind(this);this.onScroll=this.onScroll.bind(this);"function"==typeof ResizeObserver&&(this.resizeScroll=
new ResizeObserver(()=>{var _a;if((null===(_a=this.view.docView)||void 0===_a?void 0:_a.lastUpdate)<Date.now()-75)this.onResize()}),this.resizeScroll.observe(view.scrollDOM),this.resizeContent=new ResizeObserver(()=>this.view.requestMeasure()),this.resizeContent.observe(view.contentDOM));this.addWindowListeners(this.win=view.win);this.start();"function"==typeof IntersectionObserver&&(this.intersection=new IntersectionObserver(entries=>{0>this.parentCheck&&(this.parentCheck=setTimeout(this.listenForScroll.bind(this),
...
this.onScroll);win.document.addEventListener("selectionchange",this.onSelectionChange)}removeWindowListeners(win){win.removeEventListener("scroll",this.onScroll);win.removeEventListener("resize",this.onResize);win.removeEventListener("beforeprint",this.onPrint);win.document.removeEventListener("selectionchange",this.onSelectionChange)}destroy(){var _a,_b,_c,_d;this.stop();null===(_a=this.intersection)||void 0===_a?void 0:_a.disconnect();null===(_b=this.gapIntersection)||void 0===_b?void 0:_b.disconnect();
null===(_c=this.resizeScroll)||void 0===_c?void 0:_c.disconnect();null===(_d=this.resizeContent)||void 0===_d?void 0:_d.disconnect();for(let dom of this.scrollTargets)dom.removeEventListener("scroll",this.onScroll);this.removeWindowListeners(this.win);clearTimeout(this.parentCheck);clearTimeout(this.resizeTimeout);this.win.cancelAnimationFrame(this.delayedFlush);this.win.cancelAnimationFrame(this.flushingAndroidKey)}}class EditorView{constructor(config={}){this.plugins=[];this.pluginMap=new Map;this.editorAttrs=
{};this.contentAttrs={};this.bidiCache=[];this.destroyed=!1;this.updateState=2;this.measureScheduled=-1;this.measureRequests=[];this.contentDOM=document.createElement("div");this.scrollDOM=document.createElement("div");this.scrollDOM.tabIndex=-1;this.scrollDOM.className="cm-scroller";this.scrollDOM.appendChild(this.contentDOM);this.announceDOM=document.createElement("div");this.announceDOM.style.cssText="position: fixed; top: -10000px";this.announceDOM.setAttribute("aria-live","polite");this.dom=
document.createElement("div");this.dom.appendChild(this.announceDOM);this.dom.appendChild(this.scrollDOM);this._dispatch=config.dispatch||(tr=>this.update([tr]));this.dispatch=this.dispatch.bind(this);this._root=config.root||getRoot(config.parent)||document;this.viewState=new ViewState(config.state||state$jscomp$0.EditorState.create(config));this.plugins=this.state.facet(viewPlugin).map(spec=>new PluginInstance(spec));for(let plugin of this.plugins)plugin.update(this);this.observer=new DOMObserver(this);
...
(this.measureScheduled=this.win.requestAnimationFrame(()=>this.measure()));if(request&&!(-1<this.measureRequests.indexOf(request))){if(null!=request.key)for(let i=0;i<this.measureRequests.length;i++)if(this.measureRequests[i].key===request.key){this.measureRequests[i]=request;return}this.measureRequests.push(request)}}plugin(plugin){let known=this.pluginMap.get(plugin);(void 0===known||known&&known.spec!=plugin)&&this.pluginMap.set(plugin,known=this.plugins.find(p=>p.spec==plugin)||null);return known&&
known.update(this).value}get documentTop(){return this.contentDOM.getBoundingClientRect().top+this.viewState.paddingTop}get documentPadding(){return{top:this.viewState.paddingTop,bottom:this.viewState.paddingBottom}}elementAtHeight(height){this.readMeasured();return this.viewState.elementAtHeight(height)}lineBlockAtHeight(height){this.readMeasured();return this.viewState.lineBlockAtHeight(height)}get viewportLineBlocks(){return this.viewState.viewportLines}lineBlockAt(pos){return this.viewState.lineBlockAt(pos)}get contentHeight(){return this.viewState.contentHeight}moveByChar(start,
...
new WeakMap;let storedPrefix=null;class RectangleMarker{constructor(className,left,top,width,height){this.className=className;this.left=left;this.top=top;this.width=width;this.height=height}draw(){let elt=document.createElement("div");elt.className=this.className;this.adjust(elt);return elt}update(elt,prev){if(prev.className!=this.className)return!1;this.adjust(elt);return!0}adjust(elt){elt.style.left=this.left+"px";elt.style.top=this.top+"px";null!=this.width&&(elt.style.width=this.width+"px");elt.style.height=
this.height+"px"}eq(p){return this.left==p.left&&this.top==p.top&&this.width==p.width&&this.height==p.height&&this.className==p.className}static forRange(view,className,range){if(range.empty){range=view.coordsAtPos(range.head,range.assoc||1);if(!range)return[];view=getBase(view);return[new RectangleMarker(className,range.left-view.left,range.top-view.top,null,range.bottom-range.top)]}return rectanglesForRange(view,className,range)}}class LayerView{constructor(view,layer){this.view=view;this.layer=
layer;this.drawn=[];this.measureReq={read:this.measure.bind(this),write:this.draw.bind(this)};this.dom=view.scrollDOM.appendChild(document.createElement("div"));this.dom.classList.add("cm-layer");layer.above&&this.dom.classList.add("cm-layer-above");layer.class&&this.dom.classList.add(layer.class);this.dom.setAttribute("aria-hidden","true");this.setOrder(view.state);view.requestMeasure(this.measureReq);layer.mount&&layer.mount(this.dom,view)}update(update){update.startState.facet(layerOrder)!=update.state.facet(layerOrder)&&
this.setOrder(update.state);(this.layer.update(update,this.dom)||update.geometryChanged)&&update.view.requestMeasure(this.measureReq)}setOrder(state){let pos=0;for(state=state.facet(layerOrder);pos<state.length&&state[pos]!=this.layer;)pos++;this.dom.style.zIndex=String((this.layer.above?150:-1)-pos)}measure(){return this.layer.markers(this.view)}draw(markers){if(markers.length!=this.drawn.length||markers.some((p,i)=>{i=this.drawn[i];return!(p.constructor==i.constructor&&p.eq(i))})){let old=this.dom.firstChild;
var oldI=0;for(let marker of markers)marker.update&&old&&marker.constructor&&this.drawn[oldI].constructor&&marker.update(old,this.drawn[oldI])?(old=old.nextSibling,oldI++):this.dom.insertBefore(marker.draw(),old);for(;old;)oldI=old.nextSibling,old.remove(),old=oldI;this.drawn=markers}}destroy(){this.layer.destroy&&this.layer.destroy(this.dom,this.view);this.dom.remove()}}const layerOrder=state$jscomp$0.Facet.define(),CanHidePrimary=!browser.ios,selectionConfig=state$jscomp$0.Facet.define({combine(configs){return state$jscomp$0.combineConfig(configs,
{cursorBlinkRate:1200,drawRangeCursor:!0},{cursorBlinkRate:(a,b)=>Math.min(a,b),drawRangeCursor:(a,b)=>a||b})}}),cursorLayer=layer$jscomp$0({above:!0,markers(view){let {state:state$1}=view,conf=state$1.facet(selectionConfig),cursors=[];for(let r of state$1.selection.ranges){var prim=r==state$1.selection.main;if(r.empty?!prim||CanHidePrimary:conf.drawRangeCursor){prim=prim?"cm-cursor cm-cursor-primary":"cm-cursor cm-cursor-secondary";let cursor=r.empty?r:state$jscomp$0.EditorSelection.cursor(r.head,
r.head>r.anchor?-1:1);for(let piece of RectangleMarker.forRange(view,prim,cursor))cursors.push(piece)}}return cursors},update(update,dom){update.transactions.some(tr=>tr.selection)&&(dom.style.animationName="cm-blink"==dom.style.animationName?"cm-blink2":"cm-blink");let confChange=configChanged(update);confChange&&(dom.style.animationDuration=update.state.facet(selectionConfig).cursorBlinkRate+"ms");return update.docChanged||update.selectionSet||confChange},mount(dom,view){dom.style.animationDuration=
view.state.facet(selectionConfig).cursorBlinkRate+"ms"},class:"cm-cursorLayer"}),selectionLayer=layer$jscomp$0({above:!1,markers(view){return view.state.selection.ranges.map(r=>r.empty?[]:RectangleMarker.forRange(view,"cm-selectionBackground",r)).reduce((a,b)=>a.concat(b))},update(update,dom){return update.docChanged||update.selectionSet||update.viewportChanged||configChanged(update)},class:"cm-selectionLayer"}),themeSpec={".cm-line":{"\x26 ::selection":{backgroundColor:"transparent !important"},
...
!tooltip.strictSide&&(above?pos.top-(size.bottom-size.top)-offset.y<space.top:pos.bottom+(size.bottom-size.top)+offset.y>space.bottom)&&above==space.bottom-pos.bottom>pos.top-space.top&&(above=!above);tooltip=(above?pos.top-space.top:space.bottom-pos.bottom)-arrowHeight;if(tooltip<height&&!1!==tView.resize){if(tooltip<this.view.defaultLineHeight){dom.style.top="-10000px";continue}dom.style.height=(height=tooltip)+"px"}else dom.style.height&&(dom.style.height="");tooltip=above?pos.top-height-arrowHeight-
offset.y:pos.bottom+arrowHeight+offset.y;width=left+width;if(!0!==tView.overlap)for(let r of others)r.left<width&&r.right>left&&r.top<tooltip+height&&r.bottom>tooltip&&(tooltip=above?r.top-height-2-arrowHeight:r.bottom+arrowHeight+2);"absolute"==this.position?(dom.style.top=tooltip-measured.parent.top+"px",dom.style.left=left-measured.parent.left+"px"):(dom.style.top=tooltip+"px",dom.style.left=left+"px");arrow&&(arrow.style.left=`${pos.left+(ltr?offset.x:-offset.x)-(left+14-7)}px`);!0!==tView.overlap&&
others.push({left,top:tooltip,right:width,bottom:tooltip+height});dom.classList.toggle("cm-tooltip-above",above);dom.classList.toggle("cm-tooltip-below",!above);tView.positioned&&tView.positioned(measured.space)}}maybeMeasure(){if(this.manager.tooltips.length&&(this.view.inView&&this.view.requestMeasure(this.measureReq),this.inView!=this.view.inView&&(this.inView=this.view.inView,!this.inView)))for(let tv of this.manager.tooltipViews)tv.dom.style.top="-10000px"}},{eventHandlers:{scroll(){this.maybeMeasure()}}}),
baseTheme=EditorView.baseTheme({".cm-tooltip":{zIndex:100,boxSizing:"border-box"},"\x26light .cm-tooltip":{border:"1px solid #bbb",backgroundColor:"#f5f5f5"},"\x26light .cm-tooltip-section:not(:first-child)":{borderTop:"1px solid #bbb"},"\x26dark .cm-tooltip":{backgroundColor:"#333338",color:"white"},".cm-tooltip-arrow":{height:"7px",width:"14px",position:"absolute",zIndex:-1,overflow:"hidden","\x26:before, \x26:after":{content:"''",position:"absolute",width:0,height:0,borderLeft:"7px solid transparent",
...
noOffset={x:0,y:0},showTooltip=state$jscomp$0.Facet.define({enables:[tooltipPlugin,baseTheme]}),showHoverTooltip=state$jscomp$0.Facet.define();class HoverTooltipHost{constructor(view){this.view=view;this.mounted=!1;this.dom=document.createElement("div");this.dom.classList.add("cm-tooltip-hover");this.manager=new TooltipViewManager(view,showHoverTooltip,t=>this.createHostedView(t))}static create(view){return new HoverTooltipHost(view)}createHostedView(tooltip){tooltip=tooltip.create(this.view);tooltip.dom.classList.add("cm-tooltip-section");
this.dom.appendChild(tooltip.dom);this.mounted&&tooltip.mount&&tooltip.mount(this.view);return tooltip}mount(view){for(let hostedView of this.manager.tooltipViews)hostedView.mount&&hostedView.mount(view);this.mounted=!0}positioned(space){for(let hostedView of this.manager.tooltipViews)hostedView.positioned&&hostedView.positioned(space)}update(update){this.manager.update(update)}}const showHoverTooltipHost=showTooltip.compute([showHoverTooltip],state=>{state=state.facet(showHoverTooltip).filter(t=>
t);return 0===state.length?null:{pos:Math.min(...state.map(t=>t.pos)),end:Math.max(...state.filter(t=>null!=t.end).map(t=>t.end)),create:HoverTooltipHost.create,above:state[0].above,arrow:state.some(t=>t.arrow)}});class HoverPlugin{constructor(view,source,field,setHover,hoverTime){this.view=view;this.source=source;this.field=field;this.setHover=setHover;this.hoverTime=hoverTime;this.restartTimeout=this.hoverTimeout=-1;this.pending=null;this.lastMove={x:0,y:0,target:view.dom,time:0};this.checkHover=
this.checkHover.bind(this);view.dom.addEventListener("mouseleave",this.mouseleave=this.mouseleave.bind(this));view.dom.addEventListener("mousemove",this.mousemove=this.mousemove.bind(this))}update(){this.pending&&(this.pending=null,clearTimeout(this.restartTimeout),this.restartTimeout=setTimeout(()=>this.startHover(),20))}get active(){return this.view.state.field(this.field)}checkHover(){this.hoverTimeout=-1;if(!this.active){var hovered=Date.now()-this.lastMove.time;hovered<this.hoverTime?this.hoverTimeout=
setTimeout(this.checkHover,this.hoverTime-hovered):this.startHover()}}startHover(){clearTimeout(this.restartTimeout);var {lastMove}=this;let pos=this.view.contentDOM.contains(lastMove.target)?this.view.posAtCoords(lastMove):null;if(null!=pos){var posCoords=this.view.coordsAtPos(pos);if(!(null==posCoords||lastMove.y<posCoords.top||lastMove.y>posCoords.bottom||lastMove.x<posCoords.left-this.view.defaultCharacterWidth||lastMove.x>posCoords.right+this.view.defaultCharacterWidth)){var bidi=this.view.bidiSpans(this.view.state.doc.lineAt(pos)).find(s=>
s.from<=pos&&s.to>=pos);bidi=bidi&&bidi.dir==exports.Direction.RTL?-1:1;lastMove=this.source(this.view,pos,lastMove.x<posCoords.left?-bidi:bidi);if(null===lastMove||void 0===lastMove?0:lastMove.then){let pending=this.pending={pos};lastMove.then(result=>{this.pending==pending&&(this.pending=null,result&&this.view.dispatch({effects:this.setHover.of(result)}))},e=>logException(this.view.state,e,"hover tooltip"))}else lastMove&&this.view.dispatch({effects:this.setHover.of(lastMove)})}}}mousemove(event){var _a;
this.lastMove={x:event.clientX,y:event.clientY,target:event.target,time:Date.now()};0>this.hoverTimeout&&(this.hoverTimeout=setTimeout(this.checkHover,this.hoverTime));var tooltip=this.active;if(tooltip&&!isInTooltip(this.lastMove.target)||this.pending){var {pos}=tooltip||this.pending;tooltip=null!==(_a=null===tooltip||void 0===tooltip?void 0:tooltip.end)&&void 0!==_a?_a:pos;if(pos==tooltip)pos=this.view.posAtCoords(this.lastMove)!=pos;else{a:{_a=this.view;var from=pos,to=tooltip;pos=event.clientX;
event=event.clientY;tooltip=document.createRange();from=_a.domAtPos(from);_a=_a.domAtPos(to);tooltip.setEnd(_a.node,_a.offset);tooltip.setStart(from.node,from.offset);_a=tooltip.getClientRects();tooltip.detach();for(tooltip=0;tooltip<_a.length;tooltip++)if(from=_a[tooltip],6>=Math.max(from.top-event,event-from.bottom,from.left-pos,pos-from.right)){pos=!0;break a}pos=!1}pos=!pos}pos&&(this.view.dispatch({effects:this.setHover.of(null)}),this.pending=null)}}mouseleave(e){clearTimeout(this.hoverTimeout);
this.hoverTimeout=-1;this.active&&!isInTooltip(e.relatedTarget)&&this.view.dispatch({effects:this.setHover.of(null)})}destroy(){clearTimeout(this.hoverTimeout);this.view.dom.removeEventListener("mouseleave",this.mouseleave);this.view.dom.removeEventListener("mousemove",this.mousemove)}}const closeHoverTooltipEffect=state$jscomp$0.StateEffect.define(),closeHoverTooltips=closeHoverTooltipEffect.of(null),panelConfig=state$jscomp$0.Facet.define({combine(configs){let topContainer,bottomContainer;for(let c of configs)topContainer=
topContainer||c.topContainer,bottomContainer=bottomContainer||c.bottomContainer;return{topContainer,bottomContainer}}}),panelPlugin=ViewPlugin.fromClass(class{constructor(view){this.input=view.state.facet(showPanel);this.specs=this.input.filter(s=>s);this.panels=this.specs.map(spec=>spec(view));let conf=view.state.facet(panelConfig);this.top=new PanelGroup(view,!0,conf.topContainer);this.bottom=new PanelGroup(view,!1,conf.bottomContainer);this.top.sync(this.panels.filter(p=>p.top));this.bottom.sync(this.panels.filter(p=>
...
value.fixed?view.textDirection==exports.Direction.LTR?{left:value.dom.offsetWidth}:{right:value.dom.offsetWidth}:null})});class UpdateContext{constructor(gutter,viewport,height){this.gutter=gutter;this.height=height;this.i=0;this.cursor=state$jscomp$0.RangeSet.iter(gutter.markers,viewport.from)}line(view,line,extraMarkers){let localMarkers=[];advanceCursor(this.cursor,localMarkers,line.from);extraMarkers.length&&(localMarkers=localMarkers.concat(extraMarkers));(extraMarkers=this.gutter.config.lineMarker(view,
line,localMarkers))&&localMarkers.unshift(extraMarkers);extraMarkers=this.gutter;if(0!=localMarkers.length||extraMarkers.config.renderEmptyElements){var above=line.top-this.height;this.i==extraMarkers.elements.length?(view=new GutterElement(view,line.height,above,localMarkers),extraMarkers.elements.push(view),extraMarkers.dom.appendChild(view.dom)):extraMarkers.elements[this.i].update(view,line.height,above,localMarkers);this.height=line.bottom;this.i++}}finish(){let gutter=this.gutter;for(;gutter.elements.length>
this.i;){let last=gutter.elements.pop();gutter.dom.removeChild(last.dom);last.destroy()}}}class SingleGutterView{constructor(view,config){this.view=view;this.config=config;this.elements=[];this.spacer=null;this.dom=document.createElement("div");this.dom.className="cm-gutter"+(this.config.class?" "+this.config.class:"");for(let prop in config.domEventHandlers)this.dom.addEventListener(prop,event=>{var target=event.target;if(target!=this.dom&&this.dom.contains(target)){for(;target.parentNode!=this.dom;)target=
target.parentNode;target=target.getBoundingClientRect();target=(target.top+target.bottom)/2}else target=event.clientY;target=view.lineBlockAtHeight(target-view.documentTop);config.domEventHandlers[prop](view,target,event)&&event.preventDefault()});this.markers=asArray(config.markers(view));config.initialSpacer&&(this.spacer=new GutterElement(view,0,0,[config.initialSpacer(view)]),this.dom.appendChild(this.spacer.dom),this.spacer.dom.style.cssText+="visibility: hidden; pointer-events: none")}update(update){let prevMarkers=
...
WhitespaceDeco=new Map,whitespaceHighlighter=matcher(new MatchDecorator({regexp:/\t| +/g,decoration:match=>{match=match[0];let deco=WhitespaceDeco.get(match);deco||WhitespaceDeco.set(match,deco=Decoration.mark({attributes:"\t"===match?{class:"cm-highlightTab"}:{class:"cm-highlightSpace","data-display":match.replace(/ /g,"·")}}));return deco},boundary:/\S/})),trailingHighlighter=matcher(new MatchDecorator({regexp:/\s+$/g,decoration:Decoration.mark({class:"cm-trailingSpace"}),boundary:/\S/})),__test=
{HeightMap,HeightOracle,MeasuredHeights,QueryType,ChangedRange,computeOrder,moveVisually};exports.BidiSpan=BidiSpan;exports.BlockInfo=BlockInfo;exports.Decoration=Decoration;exports.EditorView=EditorView;exports.GutterMarker=GutterMarker;exports.MatchDecorator=MatchDecorator;exports.RectangleMarker=RectangleMarker;exports.ViewPlugin=ViewPlugin;exports.ViewUpdate=ViewUpdate;exports.WidgetType=WidgetType;exports.__test=__test;exports.closeHoverTooltips=closeHoverTooltips;exports.crosshairCursor=function(options=
{}){let [code,getter]=keys[options.key||"Alt"],plugin=ViewPlugin.fromClass(class{constructor(view){this.view=view;this.isDown=!1}set(isDown){this.isDown!=isDown&&(this.isDown=isDown,this.view.update([]))}},{eventHandlers:{keydown(e){this.set(e.keyCode==code||getter(e))},keyup(e){e.keyCode!=code&&getter(e)||this.set(!1)},mousemove(e){this.set(getter(e))}}});return[plugin,EditorView.contentAttributes.of(view=>{var _a;return(null===(_a=view.plugin(plugin))||void 0===_a?0:_a.isDown)?showCrosshair:null})]};
exports.drawSelection=function(config={}){return[selectionConfig.of(config),cursorLayer,selectionLayer,hideNativeSelection,nativeSelectionHidden.of(!0)]};exports.dropCursor=function(){return[dropCursorPos,drawDropCursor]};exports.getPanel=function(view,panel){panel=(view=view.plugin(panelPlugin))?view.specs.indexOf(panel):-1;return-1<panel?view.panels[panel]:null};exports.getTooltip=function(view,tooltip){view=view.plugin(tooltipPlugin);if(!view)return null;tooltip=view.manager.tooltips.indexOf(tooltip);
return 0>tooltip?null:view.manager.tooltipViews[tooltip]};exports.gutter=function(config){return[gutters(),activeGutters.of(Object.assign(Object.assign({},defaults),config))]};exports.gutterLineClass=gutterLineClass;exports.gutters=gutters;exports.hasHoverTooltips=function(state){return state.facet(showHoverTooltip).some(x=>x)};exports.highlightActiveLine=function(){return activeLineHighlighter};exports.highlightActiveLineGutter=function(){return activeLineGutterHighlighter};exports.highlightSpecialChars=
function(config={}){return[specialCharConfig.of(config),specialCharPlugin()]};exports.highlightTrailingWhitespace=function(){return trailingHighlighter};exports.highlightWhitespace=function(){return whitespaceHighlighter};exports.hoverTooltip=function(source,options={}){let setHover=state$jscomp$0.StateEffect.define(),hoverState=state$jscomp$0.StateField.define({create(){return null},update(value,tr){if(value&&(options.hideOnChange&&(tr.docChanged||tr.selection)||options.hideOn&&options.hideOn(tr,
value)))return null;if(value&&tr.docChanged){let newPos=tr.changes.mapPos(value.pos,-1,state$jscomp$0.MapMode.TrackDel);if(null==newPos)return null;let copy=Object.assign(Object.create(null),value);copy.pos=newPos;null!=value.end&&(copy.end=tr.changes.mapPos(value.end));value=copy}for(let effect of tr.effects)effect.is(setHover)&&(value=effect.value),effect.is(closeHoverTooltipEffect)&&(value=null);return value},provide:f=>showHoverTooltip.from(f)});return[hoverState,ViewPlugin.define(view=>new HoverPlugin(view,
source,hoverState,setHover,options.hoverTime||300)),showHoverTooltipHost]};exports.keymap=keymap;exports.layer=layer$jscomp$0;exports.lineNumberMarkers=lineNumberMarkers;exports.lineNumbers=function(config={}){return[lineNumberConfig.of(config),gutters(),lineNumberGutter]};exports.logException=logException;exports.panels=function(config){return config?[panelConfig.of(config)]:[]};exports.placeholder=function(content){return ViewPlugin.fromClass(class{constructor(view){this.view=view;this.placeholder=
Decoration.set([Decoration.widget({widget:new Placeholder(content),side:1}).range(0)])}get decorations(){return this.view.state.doc.length?Decoration.none:this.placeholder}},{decorations:v=>v.decorations})};exports.rectangularSelection=function(options){let filter=(null===options||void 0===options?void 0:options.eventFilter)||(e=>e.altKey&&0==e.button);return EditorView.mouseSelectionStyle.of((view,event)=>filter(event)?rectangleSelectionStyle(view,event):null)};exports.repositionTooltips=function(view){var _a;
null===(_a=view.plugin(tooltipPlugin))||void 0===_a?void 0:_a.maybeMeasure()};exports.runScopeHandlers=function(view,event,scope){return runHandlers(getKeymap(view.state),event,view,scope)};exports.scrollPastEnd=function(){return[plugin,contentAttributes.of(view=>{var _a;return(null===(_a=view.plugin(plugin))||void 0===_a?void 0:_a.attrs)||null})]};exports.showPanel=showPanel;exports.showTooltip=showTooltip;exports.tooltips=function(config={}){return tooltipConfig.of(config)}}
