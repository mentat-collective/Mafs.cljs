...
var G__41067 = devtools.prefs.pref(v);
v = G__41067;
continue;
} else {
return v;
...
}catch (e41021){var _e__39526__auto__ = e41021;
return false;
}})();
...
}catch (e41032){var _e__39526__auto__ = e41032;
return false;
}})();
...
}catch (e41034){var _e__39526__auto__ = e41034;
return false;
}}
}
});
...
var vec__41043 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41043,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41043,(1),null);
...
return cljs.core.some((function (p1__41047_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41047_SHARP_);
}),template);
});
