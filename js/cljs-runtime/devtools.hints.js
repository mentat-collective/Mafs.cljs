...
var map__41025 = top_item;
var map__41025__$1 = cljs.core.__destructure_map(map__41025);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41025__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41025__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41025__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e41024){var _e = e41024;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___41058 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___41058)){
var seen_errors_41059 = temp__5751__auto___41058;
if(cljs.core.truth_(seen_errors_41059.has(self))){
} else {
seen_errors_41059.add(self);

var temp__5753__auto___41060 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___41060)){
var sense_41061 = temp__5753__auto___41060;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_41061)].join(''));
} else {
}
}
} else {
