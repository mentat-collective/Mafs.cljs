...
var map__53729 = cljs.core.meta(iobj);
var map__53729__$1 = cljs.core.__destructure_map(map__53729);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53729__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53729__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__53729__$1,new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file));
...
var st = (function (){var or__5045__auto__ = (function (){var temp__5753__auto__ = new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(d);
...
var map__53740 = (function (){var or__5045__auto__ = stack;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
var G__53741 = env;
var G__53741__$1 = (((G__53741 == null))?null:cljs.core.deref(G__53741));
var G__53741__$2 = (((G__53741__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__53741__$1));
var G__53741__$3 = (((G__53741__$2 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__53741__$2,id));
var G__53741__$4 = (((G__53741__$3 == null))?null:cljs.core.deref(G__53741__$3));
var G__53741__$5 = (((G__53741__$4 == null))?null:cljs.core.last(G__53741__$4));
if((G__53741__$5 == null)){
return null;
} else {
return cljs.core.meta(G__53741__$5);
}
}
})();
var map__53740__$1 = cljs.core.__destructure_map(map__53740);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53740__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53740__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53740__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
var new_exception = (function (){var new_d = (function (){var G__53744 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("sci","error","sci/error",-979082803),new cljs.core.Keyword(null,"line","line",212345235),line,new cljs.core.Keyword(null,"column","column",2078222095),column,new cljs.core.Keyword(null,"message","message",-406056002),ex_msg__$1,new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557),st,new cljs.core.Keyword(null,"file","file",-1269645878),file], null);
if(cljs.core.truth_(phase)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53744,new cljs.core.Keyword(null,"phase","phase",575722892),phase);
} else {
return G__53744;
}
})();
...
var len__5769__auto___53798 = arguments.length;
var i__5770__auto___53799 = (0);
while(true){
if((i__5770__auto___53799 < len__5769__auto___53798)){
args__5775__auto__.push((arguments[i__5770__auto___53799]));

var G__53801 = (i__5770__auto___53799 + (1));
i__5770__auto___53799 = G__53801;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq53746){
var G__53747 = cljs.core.first(seq53746);
var seq53746__$1 = cljs.core.next(seq53746);
var G__53748 = cljs.core.first(seq53746__$1);
var seq53746__$2 = cljs.core.next(seq53746__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53747,G__53748,seq53746__$2);
}));

sci.impl.utils.strip_core_ns = (function sci$impl$utils$strip_core_ns(sym){
var G__53754 = cljs.core.namespace(sym);
switch (G__53754) {
case "clojure.core":
case "cljs.core":
...
var fexpr__53758 = cljs.core.deref(sci.impl.utils.eval_form_state);
return (fexpr__53758.cljs$core$IFn$_invoke$arity$2 ? fexpr__53758.cljs$core$IFn$_invoke$arity$2(sci_ctx,form) : fexpr__53758.call(null,sci_ctx,form));
});
/**
...
var run = cljs.core.cons(fst,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__53759_SHARP_){
return f(p1__53759_SHARP_);
}),cljs.core.next(s)));
return cljs.core.cons(run,(function (){var G__53760 = pred;
var G__53761 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__53760,G__53761) : sci.impl.utils.split_when.call(null,G__53760,G__53761));
})());
} else {
return null;
}
...
var G__53809 = cljs.core.next(params__$1);
var G__53810 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,cljs.core.first(params__$1));
var G__53811 = lets;
params__$1 = G__53809;
new_params = G__53810;
lets = G__53811;
...
var G__53813 = cljs.core.next(params__$1);
var G__53814 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,gparam);
var G__53815 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lets,cljs.core.first(params__$1)),gparam);
params__$1 = G__53813;
new_params = G__53814;
lets = G__53815;
continue;
...
var G__53764 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(expr_meta,new cljs.core.Keyword(null,"ns","ns",441598760),cljs.core.deref(sci.impl.utils.current_ns),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file)], 0));
if(cljs.core.truth_(special_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53764,new cljs.core.Keyword(null,"special","special",-1125941630),true);
} else {
return G__53764;
}
}));
...
/** @this {Function} */
(sci.impl.utils.log.cljs$lang$applyTo = (function (seq53765){
...
var G__53783 = sci.impl.utils.new_var.cljs$core$IFn$_invoke$arity$4(name,null,null,false);
sci.impl.vars.unbind(G__53783);
