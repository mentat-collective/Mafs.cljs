...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48974)].join('')));
...
var G__48991 = nextjournal.clojure_mode.node.type(n).prop(module$node_modules$$lezer$common$dist$index_cjs.NodeProp.closedBy);
if((G__48991 == null)){
return null;
} else {
return (G__48991[(0)]);
...
var G__48992 = nextjournal.clojure_mode.node.type(n).prop(module$node_modules$$lezer$common$dist$index_cjs.NodeProp.openedBy);
if((G__48992 == null)){
return null;
} else {
return (G__48992[(0)]);
...
nextjournal.clojure_mode.node.balanced_QMARK_ = (function nextjournal$clojure_mode$node$balanced_QMARK_(p__48993){
var map__48994 = p__48993;
var map__48994__$1 = (((((!((map__48994 == null))))?(((((map__48994.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48994.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__48994):map__48994);
var node = map__48994__$1;
var firstChild = (function (){var obj48996 = map__48994__$1;
if((!((obj48996 == null)))){
return (obj48996["firstChild"]);
} else {
return undefined;
}
})();
var lastChild = (function (){var obj48997 = map__48994__$1;
if((!((obj48997 == null)))){
return (obj48997["lastChild"]);
} else {
return undefined;
}
})();
...
var temp__5808__auto__ = (function (){var G__49000 = dir;
switch (G__49000) {
case (1):
...
return nextjournal.clojure_mode.node.children.cljs$core$IFn$_invoke$arity$3(parent,(function (){var G__49001 = dir;
switch (G__49001) {
case (1):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__49001)].join('')));
...
var G__49006 = cljs.core.compare(nextjournal.clojure_mode.node.start(to_node),nextjournal.clojure_mode.node.start(node));
switch (G__49006) {
case (0):
...
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,cljs.core.iterate((function (p1__49007_SHARP_){
return nextjournal.clojure_mode.node.move_toward(p1__49007_SHARP_,to_node);
}),node));
});
...
var or__5045__auto__ = nextjournal.clojure_mode.node.highest(node,(function (p1__49012_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(from,nextjournal.clojure_mode.node.start(p1__49012_SHARP_));
}));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var vec__49016 = cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [from,to], null));
var from__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49016,(0),null);
var to__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49016,(1),null);
...
var vec__49019 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__49022,node_between){
var vec__49023 = p__49022;
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49023,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49023,(1),null);
...
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [from__$2,to__$2], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49013_SHARP_){
var G__49026 = p1__49013_SHARP_;
if(nextjournal.clojure_mode.node.edge_QMARK_(p1__49013_SHARP_)){
return nextjournal.clojure_mode.node.up(G__49026);
} else {
return G__49026;
}
}),nextjournal.clojure_mode.node.nodes_between(from_node,to_node)));
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49019,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49019,(1),null);
 ...
 */
nextjournal.clojure_mode.node.inner_span = (function nextjournal$clojure_mode$node$inner_span(p__49027){
var map__49028 = p__49027;
...
var node = map__49028__$1;
var firstChild = (function (){var obj49030 = map__49028__$1;
if((!((obj49030 == null)))){
return (obj49030["firstChild"]);
} else {
return undefined;
}
})();
var lastChild = (function (){var obj49031 = map__49028__$1;
if((!((obj49031 == null)))){
return (obj49031["lastChild"]);
} else {
return undefined;
}
})();
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__49033 = nextjournal.clojure_mode.node.prefix(node);
if((G__49033 == null)){
return null;
} else {
return nextjournal.clojure_mode.node.string.cljs$core$IFn$_invoke$arity$2(state,G__49033);
}
...
return nextjournal.clojure_mode.node.up(G__49034);
} else {
return G__49034;
}
});
...
var G__49036 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(-1));
if((G__49036 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__49036,(function (p1__49035_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(pos,nextjournal.clojure_mode.node.end(p1__49035_SHARP_));
}));
}
});
/**
...
var G__49038 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(1));
if((G__49038 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__49038,(function (p1__49037_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(pos,nextjournal.clojure_mode.node.start(p1__49037_SHARP_));
}));
}
});
nextjournal.clojure_mode.node.nearest_touching = (function nextjournal$clojure_mode$node$nearest_touching(state,pos,dir){
var L = (function (){var G__49041 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(-1));
if((G__49041 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__49041,(function (p__49042){
...
var to = (function (){var obj49045 = map__49043__$1;
if((!((obj49045 == null)))){
return (obj49045["to"]);
} else {
return undefined;
...
var R = (function (){var G__49046 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(1));
if((G__49046 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__49046,(function (p__49047){
var map__49048 = p__49047;
var map__49048__$1 = (((((!((map__49048 == null))))?(((((map__49048.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49048.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__49048):map__49048);
var from = (function (){var obj49050 = map__49048__$1;
if((!((obj49050 == null)))){
return (obj49050["from"]);
} else {
return undefined;
}
})();
...
switch (G__49051) {
case (1):
var or__5045__auto__ = nextjournal.clojure_mode.util.guard(R,cljs.core.every_pred.cljs$core$IFn$_invoke$arity$2(cljs.core.some_QMARK_,(function (p1__49039_SHARP_){
return ((nextjournal.clojure_mode.node.same_edge_QMARK_(p1__49039_SHARP_)) || ((!(nextjournal.clojure_mode.node.right_edge_QMARK_(p1__49039_SHARP_)))));
})));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
break;
case (-1):
var or__5045__auto__ = nextjournal.clojure_mode.util.guard(L,cljs.core.every_pred.cljs$core$IFn$_invoke$arity$2(cljs.core.some_QMARK_,(function (p1__49040_SHARP_){
return ((nextjournal.clojure_mode.node.same_edge_QMARK_(p1__49040_SHARP_)) || ((!(nextjournal.clojure_mode.node.left_edge_QMARK_(p1__49040_SHARP_)))));
})));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__49051)].join('')));
