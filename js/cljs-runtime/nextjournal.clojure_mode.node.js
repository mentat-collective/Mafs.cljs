...
var G__50230 = nextjournal.clojure_mode.node.type(n).prop(module$node_modules$$lezer$common$dist$index_cjs.NodeProp.closedBy);
if((G__50230 == null)){
return null;
} else {
return (G__50230[(0)]);
...
var G__50231 = nextjournal.clojure_mode.node.type(n).prop(module$node_modules$$lezer$common$dist$index_cjs.NodeProp.openedBy);
if((G__50231 == null)){
return null;
} else {
return (G__50231[(0)]);
...
nextjournal.clojure_mode.node.balanced_QMARK_ = (function nextjournal$clojure_mode$node$balanced_QMARK_(p__50232){
...
var node = map__50233__$1;
var firstChild = (function (){var obj50235 = map__50233__$1;
if((!((obj50235 == null)))){
return (obj50235["firstChild"]);
} else {
return undefined;
}
})();
var lastChild = (function (){var obj50236 = map__50233__$1;
if((!((obj50236 == null)))){
return (obj50236["lastChild"]);
} else {
return undefined;
}
})();
...
var temp__5808__auto__ = (function (){var G__50239 = dir;
switch (G__50239) {
case (1):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50239)].join('')));
...
return nextjournal.clojure_mode.node.children.cljs$core$IFn$_invoke$arity$3(parent,(function (){var G__50240 = dir;
switch (G__50240) {
case (1):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50240)].join('')));
...
var G__50245 = cljs.core.compare(nextjournal.clojure_mode.node.start(to_node),nextjournal.clojure_mode.node.start(node));
switch (G__50245) {
case (0):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50245)].join('')));

}
}
});
nextjournal.clojure_mode.node.nodes_between = (function nextjournal$clojure_mode$node$nodes_between(node,to_node){
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,cljs.core.iterate((function (p1__50246_SHARP_){
return nextjournal.clojure_mode.node.move_toward(p1__50246_SHARP_,to_node);
}),node));
});
...
var or__5045__auto__ = nextjournal.clojure_mode.node.highest(node,(function (p1__50251_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(from,nextjournal.clojure_mode.node.start(p1__50251_SHARP_));
}));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var vec__50255 = cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [from,to], null));
var from__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50255,(0),null);
var to__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50255,(1),null);
...
var vec__50258 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__50261,node_between){
var vec__50262 = p__50261;
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50262,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50262,(1),null);
...
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [from__$2,to__$2], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50252_SHARP_){
var G__50265 = p1__50252_SHARP_;
if(nextjournal.clojure_mode.node.edge_QMARK_(p1__50252_SHARP_)){
return nextjournal.clojure_mode.node.up(G__50265);
} else {
return G__50265;
}
}),nextjournal.clojure_mode.node.nodes_between(from_node,to_node)));
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50258,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50258,(1),null);
 ...
 */
nextjournal.clojure_mode.node.inner_span = (function nextjournal$clojure_mode$node$inner_span(p__50266){
...
var node = map__50267__$1;
var firstChild = (function (){var obj50269 = map__50267__$1;
if((!((obj50269 == null)))){
return (obj50269["firstChild"]);
} else {
return undefined;
}
})();
var lastChild = (function (){var obj50270 = map__50267__$1;
if((!((obj50270 == null)))){
return (obj50270["lastChild"]);
} else {
return undefined;
}
})();
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__50272 = nextjournal.clojure_mode.node.prefix(node);
if((G__50272 == null)){
return null;
} else {
return nextjournal.clojure_mode.node.string.cljs$core$IFn$_invoke$arity$2(state,G__50272);
}
...
return nextjournal.clojure_mode.node.up(G__50273);
} else {
return G__50273;
}
});
...
var G__50275 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(-1));
if((G__50275 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__50275,(function (p1__50274_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(pos,nextjournal.clojure_mode.node.end(p1__50274_SHARP_));
}));
}
});
/**
...
var G__50277 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(1));
if((G__50277 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__50277,(function (p1__50276_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(pos,nextjournal.clojure_mode.node.start(p1__50276_SHARP_));
}));
}
});
nextjournal.clojure_mode.node.nearest_touching = (function nextjournal$clojure_mode$node$nearest_touching(state,pos,dir){
var L = (function (){var G__50280 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(-1));
if((G__50280 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__50280,(function (p__50281){
...
var to = (function (){var obj50284 = map__50282__$1;
if((!((obj50284 == null)))){
return (obj50284["to"]);
} else {
return undefined;
...
var R = (function (){var G__50285 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(1));
if((G__50285 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__50285,(function (p__50286){
...
var from = (function (){var obj50289 = map__50287__$1;
if((!((obj50289 == null)))){
return (obj50289["from"]);
} else {
return undefined;
}
})();
...
switch (G__50290) {
case (1):
var or__5045__auto__ = nextjournal.clojure_mode.util.guard(R,cljs.core.every_pred.cljs$core$IFn$_invoke$arity$2(cljs.core.some_QMARK_,(function (p1__50278_SHARP_){
return ((nextjournal.clojure_mode.node.same_edge_QMARK_(p1__50278_SHARP_)) || ((!(nextjournal.clojure_mode.node.right_edge_QMARK_(p1__50278_SHARP_)))));
})));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
break;
case (-1):
var or__5045__auto__ = nextjournal.clojure_mode.util.guard(L,cljs.core.every_pred.cljs$core$IFn$_invoke$arity$2(cljs.core.some_QMARK_,(function (p1__50279_SHARP_){
return ((nextjournal.clojure_mode.node.same_edge_QMARK_(p1__50279_SHARP_)) || ((!(nextjournal.clojure_mode.node.left_edge_QMARK_(p1__50279_SHARP_)))));
})));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50290)].join('')));
