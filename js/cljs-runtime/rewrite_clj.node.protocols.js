...
var rewrite_clj$node$protocols$Node$tag$dyn_63074 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_63074(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_63078 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_63078(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_63079 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_63079(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_63080 = (function (node,opts){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_63080(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_63082 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_63082(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_63084 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_63084(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62992_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__62992_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_63093 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_63093(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_63094 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_63094(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_63096 = (function (node,children){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_63096(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_63098 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_63098(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_63121 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_63121(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_63131 = (function (node,map_qualifier){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_63131(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_63147 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_63147(node);
}
});
...
var map__63026 = cljs.core.meta(node);
var map__63026__$1 = cljs.core.__destructure_map(map__63026);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63026__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63026__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63026__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63026__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__63044,p__63045){
var vec__63046 = p__63044;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63046,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63046,(1),null);
var vec__63049 = p__63045;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63049,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63049,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__63052 = col_extent;
if((row_extent === (0))){
return (G__63052 + col);
} else {
return G__63052;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__63059 = rewrite_clj.node.protocols.children(node);
var G__63059__$1 = (((G__63059 == null))?null:cljs.core.first(G__63059));
if((G__63059__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__63059__$1);
}
} else {
