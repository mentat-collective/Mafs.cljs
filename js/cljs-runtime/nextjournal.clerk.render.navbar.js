...
var map__48234 = cljs.core.deref(_BANG_state);
var map__48234__$1 = cljs.core.__destructure_map(map__48234);
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48234__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var scroll_animation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48234__$1,new cljs.core.Keyword(null,"scroll-animation","scroll-animation",2033576100));
var scroll_el = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48234__$1,new cljs.core.Keyword(null,"scroll-el","scroll-el",2005954473));
var set_hash_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48234__$1,new cljs.core.Keyword(null,"set-hash?","set-hash?",1284779132));
var visible_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48234__$1,new cljs.core.Keyword(null,"visible?","visible?",2129863715));
...
var len__5769__auto___48293 = arguments.length;
var i__5770__auto___48294 = (0);
while(true){
if((i__5770__auto___48294 < len__5769__auto___48293)){
args__5775__auto__.push((arguments[i__5770__auto___48294]));

var G__48295 = (i__5770__auto___48294 + (1));
i__5770__auto___48294 = G__48295;
continue;
} else {
}
break;
...
(nextjournal.clerk.render.navbar.toc_items.cljs$core$IFn$_invoke$arity$variadic = (function (_BANG_state,items,p__48263){
var vec__48264 = p__48263;
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48264,(0),null);
var map__48267 = cljs.core.deref(_BANG_state);
var map__48267__$1 = cljs.core.__destructure_map(map__48267);
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48267__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__48268){
var map__48269 = p__48268;
var map__48269__$1 = cljs.core.__destructure_map(map__48269);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48269__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48269__$1,new cljs.core.Keyword(null,"title","title",636505583));
var items__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48269__$1,new cljs.core.Keyword(null,"items","items",1031954938));
...
/** @this {Function} */
(nextjournal.clerk.render.navbar.toc_items.cljs$lang$applyTo = (function (seq48260){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48261,G__48262,seq48260__$2);
}));
...
var map__48273 = cljs.core.deref(_BANG_state);
var map__48273__$1 = cljs.core.__destructure_map(map__48273);
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48273__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48273__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (i,p__48274){
var map__48275 = p__48274;
var map__48275__$1 = cljs.core.__destructure_map(map__48275);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48275__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48275__$1,new cljs.core.Keyword(null,"title","title",636505583));
var expanded_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48275__$1,new cljs.core.Keyword(null,"expanded?","expanded?",2055832296));
var loading_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48275__$1,new cljs.core.Keyword(null,"loading?","loading?",1905707049));
var items__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48275__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var toc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48275__$1,new cljs.core.Keyword(null,"toc","toc",2050089251));
...
setTimeout((function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(_BANG_state,(function (p1__48272_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc_in(p1__48272_SHARP_,cljs.core.vec(cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(update_at,i,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"loading?","loading?",1905707049)], 0))),false),new cljs.core.Keyword(null,"toc","toc",2050089251),toc);
}));
}),(500));
} else {
}
...
var map__48276 = cljs.core.deref(_BANG_state);
var map__48276__$1 = cljs.core.__destructure_map(map__48276);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48276__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48276__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var toc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48276__$1,new cljs.core.Keyword(null,"toc","toc",2050089251));
...
var args__5775__auto__ = [];
var len__5769__auto___48296 = arguments.length;
var i__5770__auto___48297 = (0);
while(true){
if((i__5770__auto___48297 < len__5769__auto___48296)){
args__5775__auto__.push((arguments[i__5770__auto___48297]));

var G__48298 = (i__5770__auto___48297 + (1));
i__5770__auto___48297 = G__48298;
continue;
} else {
}
break;
...
(nextjournal.clerk.render.navbar.toggle_button.cljs$core$IFn$_invoke$arity$variadic = (function (_BANG_state,content,p__48280){
var vec__48281 = p__48280;
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48281,(0),null);
var map__48284 = cljs.core.deref(_BANG_state);
var map__48284__$1 = cljs.core.__destructure_map(map__48284);
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48284__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var mobile_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48284__$1,new cljs.core.Keyword(null,"mobile-open?","mobile-open?",192715821));
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48284__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
...
/** @this {Function} */
(nextjournal.clerk.render.navbar.toggle_button.cljs$lang$applyTo = (function (seq48277){
var G__48278 = cljs.core.first(seq48277);
var seq48277__$1 = cljs.core.next(seq48277);
var G__48279 = cljs.core.first(seq48277__$1);
var seq48277__$2 = cljs.core.next(seq48277__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48278,G__48279,seq48277__$2);
}));
...
var with_let48286 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let48286","with-let48286",1798410688));
var temp__5808__auto___48299 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___48299 == null)){
} else {
var c__40743__auto___48300 = temp__5808__auto___48299;
if((with_let48286.generation === c__40743__auto___48300.ratomGeneration)){
...
(with_let48286.generation = c__40743__auto___48300.ratomGeneration);
}

var init48287 = (with_let48286.length === (0));
var map__48289 = ((((init48287) || (cljs.core.not(with_let48286.hasOwnProperty((0))))))?(with_let48286[(0)] = cljs.core.deref(_BANG_state)):(with_let48286[(0)]));
var map__48289__$1 = cljs.core.__destructure_map(map__48289);
var local_storage_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48289__$1,new cljs.core.Keyword(null,"local-storage-key","local-storage-key",-1983909558));
var component_key = ((((init48287) || (cljs.core.not(with_let48286.hasOwnProperty((1))))))?(with_let48286[(1)] = (function (){var or__5045__auto__ = local_storage_key;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var resize = ((((init48287) || (cljs.core.not(with_let48286.hasOwnProperty((2))))))?(with_let48286[(2)] = (function (){
...
var ref_fn = ((((init48287) || (cljs.core.not(with_let48286.hasOwnProperty((3))))))?(with_let48286[(3)] = (function (p1__48285_SHARP_){
if(cljs.core.truth_(p1__48285_SHARP_)){
if(cljs.core.truth_(local_storage_key)){
cljs.core.add_watch(_BANG_state,new cljs.core.Keyword("nextjournal.clerk.render.navbar","persist","nextjournal.clerk.render.navbar/persist",-1947943071),(function (_,___$1,old,p__48290){
var map__48291 = p__48290;
var map__48291__$1 = cljs.core.__destructure_map(map__48291);
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48291__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
...
var res48288 = (function (){var map__48292 = cljs.core.deref(_BANG_state);
var map__48292__$1 = cljs.core.__destructure_map(map__48292);
var animation_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48292__$1,new cljs.core.Keyword(null,"animation-mode","animation-mode",245298782));
var hide_toggle_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48292__$1,new cljs.core.Keyword(null,"hide-toggle?","hide-toggle?",-1874012773));
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48292__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
var mobile_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48292__$1,new cljs.core.Keyword(null,"mobile-open?","mobile-open?",192715821));
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48292__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var mobile_width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48292__$1,new cljs.core.Keyword(null,"mobile-width","mobile-width",-48320880));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48292__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48292__$1,new cljs.core.Keyword(null,"width","width",-384071477));
