...
var map__49666 = cljs.core.deref(_BANG_state);
var map__49666__$1 = cljs.core.__destructure_map(map__49666);
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49666__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var scroll_animation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49666__$1,new cljs.core.Keyword(null,"scroll-animation","scroll-animation",2033576100));
var scroll_el = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49666__$1,new cljs.core.Keyword(null,"scroll-el","scroll-el",2005954473));
var set_hash_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49666__$1,new cljs.core.Keyword(null,"set-hash?","set-hash?",1284779132));
var visible_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49666__$1,new cljs.core.Keyword(null,"visible?","visible?",2129863715));
...
var len__5769__auto___49738 = arguments.length;
var i__5770__auto___49739 = (0);
while(true){
if((i__5770__auto___49739 < len__5769__auto___49738)){
args__5775__auto__.push((arguments[i__5770__auto___49739]));

var G__49740 = (i__5770__auto___49739 + (1));
i__5770__auto___49739 = G__49740;
continue;
} else {
}
break;
...
(nextjournal.clerk.render.navbar.toc_items.cljs$core$IFn$_invoke$arity$variadic = (function (_BANG_state,items,p__49708){
var vec__49709 = p__49708;
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49709,(0),null);
var map__49714 = cljs.core.deref(_BANG_state);
var map__49714__$1 = cljs.core.__destructure_map(map__49714);
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49714__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__49715){
var map__49716 = p__49715;
var map__49716__$1 = cljs.core.__destructure_map(map__49716);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49716__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49716__$1,new cljs.core.Keyword(null,"title","title",636505583));
var items__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49716__$1,new cljs.core.Keyword(null,"items","items",1031954938));
...
/** @this {Function} */
(nextjournal.clerk.render.navbar.toc_items.cljs$lang$applyTo = (function (seq49698){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49699,G__49700,seq49698__$2);
}));
...
var map__49718 = cljs.core.deref(_BANG_state);
var map__49718__$1 = cljs.core.__destructure_map(map__49718);
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49718__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49718__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (i,p__49719){
var map__49720 = p__49719;
var map__49720__$1 = cljs.core.__destructure_map(map__49720);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49720__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49720__$1,new cljs.core.Keyword(null,"title","title",636505583));
var expanded_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49720__$1,new cljs.core.Keyword(null,"expanded?","expanded?",2055832296));
var loading_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49720__$1,new cljs.core.Keyword(null,"loading?","loading?",1905707049));
var items__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49720__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var toc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49720__$1,new cljs.core.Keyword(null,"toc","toc",2050089251));
...
setTimeout((function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(_BANG_state,(function (p1__49717_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc_in(p1__49717_SHARP_,cljs.core.vec(cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(update_at,i,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"loading?","loading?",1905707049)], 0))),false),new cljs.core.Keyword(null,"toc","toc",2050089251),toc);
}));
}),(500));
} else {
}
...
var map__49721 = cljs.core.deref(_BANG_state);
var map__49721__$1 = cljs.core.__destructure_map(map__49721);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49721__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49721__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var toc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49721__$1,new cljs.core.Keyword(null,"toc","toc",2050089251));
...
var args__5775__auto__ = [];
var len__5769__auto___49741 = arguments.length;
var i__5770__auto___49742 = (0);
while(true){
if((i__5770__auto___49742 < len__5769__auto___49741)){
args__5775__auto__.push((arguments[i__5770__auto___49742]));

var G__49743 = (i__5770__auto___49742 + (1));
i__5770__auto___49742 = G__49743;
continue;
} else {
}
break;
...
(nextjournal.clerk.render.navbar.toggle_button.cljs$core$IFn$_invoke$arity$variadic = (function (_BANG_state,content,p__49725){
var vec__49726 = p__49725;
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49726,(0),null);
var map__49729 = cljs.core.deref(_BANG_state);
var map__49729__$1 = cljs.core.__destructure_map(map__49729);
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49729__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var mobile_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49729__$1,new cljs.core.Keyword(null,"mobile-open?","mobile-open?",192715821));
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49729__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
...
/** @this {Function} */
(nextjournal.clerk.render.navbar.toggle_button.cljs$lang$applyTo = (function (seq49722){
var G__49723 = cljs.core.first(seq49722);
var seq49722__$1 = cljs.core.next(seq49722);
var G__49724 = cljs.core.first(seq49722__$1);
var seq49722__$2 = cljs.core.next(seq49722__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49723,G__49724,seq49722__$2);
}));
...
var with_let49731 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let49731","with-let49731",1057990433));
var temp__5808__auto___49744 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___49744 == null)){
} else {
var c__40743__auto___49745 = temp__5808__auto___49744;
if((with_let49731.generation === c__40743__auto___49745.ratomGeneration)){
...
(with_let49731.generation = c__40743__auto___49745.ratomGeneration);
}

var init49732 = (with_let49731.length === (0));
var map__49734 = ((((init49732) || (cljs.core.not(with_let49731.hasOwnProperty((0))))))?(with_let49731[(0)] = cljs.core.deref(_BANG_state)):(with_let49731[(0)]));
var map__49734__$1 = cljs.core.__destructure_map(map__49734);
var local_storage_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49734__$1,new cljs.core.Keyword(null,"local-storage-key","local-storage-key",-1983909558));
var component_key = ((((init49732) || (cljs.core.not(with_let49731.hasOwnProperty((1))))))?(with_let49731[(1)] = (function (){var or__5045__auto__ = local_storage_key;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var resize = ((((init49732) || (cljs.core.not(with_let49731.hasOwnProperty((2))))))?(with_let49731[(2)] = (function (){
...
var ref_fn = ((((init49732) || (cljs.core.not(with_let49731.hasOwnProperty((3))))))?(with_let49731[(3)] = (function (p1__49730_SHARP_){
if(cljs.core.truth_(p1__49730_SHARP_)){
if(cljs.core.truth_(local_storage_key)){
cljs.core.add_watch(_BANG_state,new cljs.core.Keyword("nextjournal.clerk.render.navbar","persist","nextjournal.clerk.render.navbar/persist",-1947943071),(function (_,___$1,old,p__49735){
var map__49736 = p__49735;
var map__49736__$1 = cljs.core.__destructure_map(map__49736);
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49736__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
...
var res49733 = (function (){var map__49737 = cljs.core.deref(_BANG_state);
var map__49737__$1 = cljs.core.__destructure_map(map__49737);
var animation_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49737__$1,new cljs.core.Keyword(null,"animation-mode","animation-mode",245298782));
var hide_toggle_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49737__$1,new cljs.core.Keyword(null,"hide-toggle?","hide-toggle?",-1874012773));
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49737__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
var mobile_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49737__$1,new cljs.core.Keyword(null,"mobile-open?","mobile-open?",192715821));
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49737__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var mobile_width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49737__$1,new cljs.core.Keyword(null,"mobile-width","mobile-width",-48320880));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49737__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49737__$1,new cljs.core.Keyword(null,"width","width",-384071477));
