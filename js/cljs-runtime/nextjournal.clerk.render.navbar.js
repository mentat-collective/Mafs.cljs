...
var map__48241 = cljs.core.deref(_BANG_state);
var map__48241__$1 = cljs.core.__destructure_map(map__48241);
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48241__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var scroll_animation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48241__$1,new cljs.core.Keyword(null,"scroll-animation","scroll-animation",2033576100));
var scroll_el = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48241__$1,new cljs.core.Keyword(null,"scroll-el","scroll-el",2005954473));
var set_hash_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48241__$1,new cljs.core.Keyword(null,"set-hash?","set-hash?",1284779132));
var visible_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48241__$1,new cljs.core.Keyword(null,"visible?","visible?",2129863715));
...
args__5775__auto__.push((arguments[i__5770__auto___48378]));
...
(nextjournal.clerk.render.navbar.toc_items.cljs$core$IFn$_invoke$arity$variadic = (function (_BANG_state,items,p__48347){
var vec__48348 = p__48347;
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48348,(0),null);
var map__48351 = cljs.core.deref(_BANG_state);
var map__48351__$1 = cljs.core.__destructure_map(map__48351);
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48351__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__48354){
var map__48355 = p__48354;
var map__48355__$1 = cljs.core.__destructure_map(map__48355);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48355__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48355__$1,new cljs.core.Keyword(null,"title","title",636505583));
var items__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48355__$1,new cljs.core.Keyword(null,"items","items",1031954938));
...
/** @this {Function} */
(nextjournal.clerk.render.navbar.toc_items.cljs$lang$applyTo = (function (seq48343){
var G__48344 = cljs.core.first(seq48343);
var seq48343__$1 = cljs.core.next(seq48343);
var G__48345 = cljs.core.first(seq48343__$1);
var seq48343__$2 = cljs.core.next(seq48343__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48344,G__48345,seq48343__$2);
}));
...
var map__48357 = cljs.core.deref(_BANG_state);
var map__48357__$1 = cljs.core.__destructure_map(map__48357);
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48357__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48357__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (i,p__48358){
var map__48359 = p__48358;
var map__48359__$1 = cljs.core.__destructure_map(map__48359);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48359__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48359__$1,new cljs.core.Keyword(null,"title","title",636505583));
var expanded_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48359__$1,new cljs.core.Keyword(null,"expanded?","expanded?",2055832296));
var loading_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48359__$1,new cljs.core.Keyword(null,"loading?","loading?",1905707049));
var items__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48359__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var toc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48359__$1,new cljs.core.Keyword(null,"toc","toc",2050089251));
...
setTimeout((function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(_BANG_state,(function (p1__48356_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc_in(p1__48356_SHARP_,cljs.core.vec(cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(update_at,i,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"loading?","loading?",1905707049)], 0))),false),new cljs.core.Keyword(null,"toc","toc",2050089251),toc);
}));
}),(500));
} else {
}
...
var map__48360 = cljs.core.deref(_BANG_state);
var map__48360__$1 = cljs.core.__destructure_map(map__48360);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48360__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48360__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var toc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48360__$1,new cljs.core.Keyword(null,"toc","toc",2050089251));
...
var args__5775__auto__ = [];
var len__5769__auto___48381 = arguments.length;
var i__5770__auto___48382 = (0);
while(true){
if((i__5770__auto___48382 < len__5769__auto___48381)){
args__5775__auto__.push((arguments[i__5770__auto___48382]));

var G__48383 = (i__5770__auto___48382 + (1));
i__5770__auto___48382 = G__48383;
continue;
} else {
}
break;
...
(nextjournal.clerk.render.navbar.toggle_button.cljs$core$IFn$_invoke$arity$variadic = (function (_BANG_state,content,p__48364){
var vec__48365 = p__48364;
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48365,(0),null);
var map__48368 = cljs.core.deref(_BANG_state);
var map__48368__$1 = cljs.core.__destructure_map(map__48368);
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48368__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var mobile_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48368__$1,new cljs.core.Keyword(null,"mobile-open?","mobile-open?",192715821));
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48368__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
...
/** @this {Function} */
(nextjournal.clerk.render.navbar.toggle_button.cljs$lang$applyTo = (function (seq48361){
...
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48362,G__48363,seq48361__$2);
}));
...
var with_let48370 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let48370","with-let48370",-1931119124));
var temp__5808__auto___48386 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___48386 == null)){
} else {
var c__40743__auto___48387 = temp__5808__auto___48386;
if((with_let48370.generation === c__40743__auto___48387.ratomGeneration)){
...
(with_let48370.generation = c__40743__auto___48387.ratomGeneration);
}

var init48371 = (with_let48370.length === (0));
var map__48373 = ((((init48371) || (cljs.core.not(with_let48370.hasOwnProperty((0))))))?(with_let48370[(0)] = cljs.core.deref(_BANG_state)):(with_let48370[(0)]));
var map__48373__$1 = cljs.core.__destructure_map(map__48373);
var local_storage_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48373__$1,new cljs.core.Keyword(null,"local-storage-key","local-storage-key",-1983909558));
var component_key = ((((init48371) || (cljs.core.not(with_let48370.hasOwnProperty((1))))))?(with_let48370[(1)] = (function (){var or__5045__auto__ = local_storage_key;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var resize = ((((init48371) || (cljs.core.not(with_let48370.hasOwnProperty((2))))))?(with_let48370[(2)] = (function (){
...
var ref_fn = ((((init48371) || (cljs.core.not(with_let48370.hasOwnProperty((3))))))?(with_let48370[(3)] = (function (p1__48369_SHARP_){
if(cljs.core.truth_(p1__48369_SHARP_)){
if(cljs.core.truth_(local_storage_key)){
cljs.core.add_watch(_BANG_state,new cljs.core.Keyword("nextjournal.clerk.render.navbar","persist","nextjournal.clerk.render.navbar/persist",-1947943071),(function (_,___$1,old,p__48374){
var map__48375 = p__48374;
var map__48375__$1 = cljs.core.__destructure_map(map__48375);
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48375__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
...
var res48372 = (function (){var map__48376 = cljs.core.deref(_BANG_state);
var map__48376__$1 = cljs.core.__destructure_map(map__48376);
var animation_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48376__$1,new cljs.core.Keyword(null,"animation-mode","animation-mode",245298782));
var hide_toggle_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48376__$1,new cljs.core.Keyword(null,"hide-toggle?","hide-toggle?",-1874012773));
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48376__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
var mobile_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48376__$1,new cljs.core.Keyword(null,"mobile-open?","mobile-open?",192715821));
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48376__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var mobile_width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48376__$1,new cljs.core.Keyword(null,"mobile-width","mobile-width",-48320880));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48376__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48376__$1,new cljs.core.Keyword(null,"width","width",-384071477));
