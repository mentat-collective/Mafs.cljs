...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f,(function (p1__55606_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__55606_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),true);
}));
}));
...
return sci.impl.utils.new_var.cljs$core$IFn$_invoke$arity$4(sym,f,(function (){var G__55612 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"ns","ns",441598760),ns__$1,new cljs.core.Keyword(null,"macro","macro",-867863404),true,new cljs.core.Keyword("sci","built-in","sci/built-in",1244659599),true], null);
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__55612,extra_meta], 0));
} else {
return G__55612;
}
})(),ctx_QMARK_);
...
return sci.impl.utils.new_var.cljs$core$IFn$_invoke$arity$4(sym,f,(function (){var G__55615 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ns","ns",441598760),ns__$1,new cljs.core.Keyword("sci","built-in","sci/built-in",1244659599),true], null);
if(cljs.core.truth_((function (){var and__5043__auto__ = (!(sci.impl.copy_vars.elide_vars));
if(and__5043__auto__){
return extra_meta;
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__55615,extra_meta], 0));
} else {
return G__55615;
}
})(),ctx_QMARK___$1);
