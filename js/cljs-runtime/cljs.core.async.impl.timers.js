...
var i_45043 = (self__.level + (1));
while(true){
if((i_45043 <= (new_level + (1)))){
(update[i_45043] = self__.header);

var G__45044 = (i_45043 + (1));
i_45043 = G__45044;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_45046 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_45046[i]));
} else {
x__$2.forward.push((((i < links_45046.length))?(links_45046[i]):null));
}

if((i < links_45046.length)){
(links_45046[i] = x__$2);
} else {
links_45046.push(x__$2);
}
...
var i_45052 = (0);
while(true){
if((i_45052 <= self__.level)){
var links_45053 = (update[i_45052]).forward;
if((x__$1 === (((i_45052 < links_45053.length))?(links_45053[i_45052]):null))){
(links_45053[i_45052] = (x__$1.forward[i_45052]));

var G__45057 = (i_45052 + (1));
i_45052 = G__45057;
continue;
} else {
var G__45058 = (i_45052 + (1));
i_45052 = G__45058;
continue;
}
} else {
...
var G__45060 = nx;
var G__45061 = (level__$1 - (1));
x = G__45060;
level__$1 = G__45061;
continue;
} else {
var G__45062 = x;
var G__45063 = (level__$1 - (1));
x = G__45062;
level__$1 = G__45063;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__45068 = nx;
var G__45069 = (level__$1 - (1));
x = G__45068;
level__$1 = G__45069;
continue;
} else {
var G__45070 = x;
var G__45071 = (level__$1 - (1));
x = G__45070;
level__$1 = G__45071;
continue;
}
