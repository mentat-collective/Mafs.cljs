...
if((c === "\n")){
var G__63796 = escape_QMARK_;
var G__63797 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__63796;
lines = G__63797;
continue;
} else {
buf.append(c);

var G__63798 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__63799 = lines;
escape_QMARK_ = G__63798;
lines = G__63799;
continue;
