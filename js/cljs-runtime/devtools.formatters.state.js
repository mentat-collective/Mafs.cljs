...
var len__5769__auto___41074 = arguments.length;
var i__5770__auto___41075 = (0);
while(true){
if((i__5770__auto___41075 < len__5769__auto___41074)){
args__5775__auto__.push((arguments[i__5770__auto___41075]));

var G__41076 = (i__5770__auto___41075 + (1));
i__5770__auto___41075 = G__41076;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq41026){
var G__41027 = cljs.core.first(seq41026);
var seq41026__$1 = cljs.core.next(seq41026);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41027,seq41026__$1);
}));
...
return cljs.core.some((function (p1__41048_SHARP_){
return (p1__41048_SHARP_ === object);
}),history__$1);
});
