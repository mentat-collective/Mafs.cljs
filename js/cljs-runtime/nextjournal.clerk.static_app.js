...
nextjournal.clerk.static_app.doc_url = (function nextjournal$clerk$static_app$doc_url(p__48550,path){
var map__48551 = p__48550;
var map__48551__$1 = cljs.core.__destructure_map(map__48551);
var path__GT_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48551__$1,new cljs.core.Keyword(null,"path->url","path->url",619884785));
var current_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48551__$1,new cljs.core.Keyword(null,"current-path","current-path",-113759954));
var bundle_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48551__$1,new cljs.core.Keyword(null,"bundle?","bundle?",-35631730));
...
var url__$1 = (function (){var G__48552 = url;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48552),"index.html"].join('');
} else {
return G__48552;
}
})();
...
nextjournal.clerk.static_app.show = (function nextjournal$clerk$static_app$show(p__48553){
var map__48554 = p__48553;
var map__48554__$1 = cljs.core.__destructure_map(map__48554);
var view_data = map__48554__$1;
var sha = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48554__$1,new cljs.core.Keyword("git","sha","git/sha",-950222993));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48554__$1,new cljs.core.Keyword("git","url","git/url",276391304));
var bundle_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48554__$1,new cljs.core.Keyword(null,"bundle?","bundle?",-35631730));
var doc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48554__$1,new cljs.core.Keyword(null,"doc","doc",1913296891));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48554__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var url__GT_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48554__$1,new cljs.core.Keyword(null,"url->path","url->path",1929246367));
...
nextjournal.clerk.render.set_state_BANG_(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"doc","doc",1913296891),(function (){var G__48555 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(doc,new cljs.core.Keyword(null,"bundle?","bundle?",-35631730),bundle_QMARK_);
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__48555,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("nextjournal","value","nextjournal/value",-1912768947),new cljs.core.Keyword(null,"blocks","blocks",-610462153)], null),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.into,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.clerk.static_app.hiccup(header)], null)));
} else {
return G__48555;
}
})()], null));
...
nextjournal.clerk.static_app.index = (function nextjournal$clerk$static_app$index(p__48557){
var map__48558 = p__48557;
var map__48558__$1 = cljs.core.__destructure_map(map__48558);
var view_data = map__48558__$1;
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48558__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
if((typeof document !== 'undefined')){
(document.title = "Clerk");
} else {
}

var with_let48559 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let48559","with-let48559",438523851));
var temp__5808__auto___48567 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___48567 == null)){
} else {
var c__40743__auto___48568 = temp__5808__auto___48567;
if((with_let48559.generation === c__40743__auto___48568.ratomGeneration)){
...
var map__48562 = cljs.core.deref(nextjournal.clerk.static_app._BANG_match);
var map__48562__$1 = cljs.core.__destructure_map(map__48562);
var match = map__48562__$1;
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48562__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var path_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48562__$1,new cljs.core.Keyword(null,"path-params","path-params",-48130597));
var map__48563 = data;
var map__48563__$1 = cljs.core.__destructure_map(map__48563);
var view = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48563__$1,new cljs.core.Keyword(null,"view","view",1247994814));
...
nextjournal.clerk.static_app.init = (function nextjournal$clerk$static_app$init(p__48565){
var map__48566 = p__48565;
var map__48566__$1 = cljs.core.__destructure_map(map__48566);
var state = map__48566__$1;
var bundle_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48566__$1,new cljs.core.Keyword(null,"bundle?","bundle?",-35631730));
var path__GT_doc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48566__$1,new cljs.core.Keyword(null,"path->doc","path->doc",-634415134));
var path__GT_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48566__$1,new cljs.core.Keyword(null,"path->url","path->url",619884785));
var current_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48566__$1,new cljs.core.Keyword(null,"current-path","current-path",-113759954));
...
if(cljs.core.truth_(bundle_QMARK_)){
var router_48569 = reitit.frontend.router.cljs$core$IFn$_invoke$arity$1(nextjournal.clerk.static_app.get_routes(url__GT_doc));
reitit.frontend.easy.start_BANG_(router_48569,(function (p1__48564_SHARP_){
return cljs.core.reset_BANG_(nextjournal.clerk.static_app._BANG_match,p1__48564_SHARP_);
