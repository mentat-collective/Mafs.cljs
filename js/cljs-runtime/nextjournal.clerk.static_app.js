...
nextjournal.clerk.static_app.doc_url = (function nextjournal$clerk$static_app$doc_url(p__48634,path){
var map__48635 = p__48634;
var map__48635__$1 = cljs.core.__destructure_map(map__48635);
var path__GT_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48635__$1,new cljs.core.Keyword(null,"path->url","path->url",619884785));
var current_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48635__$1,new cljs.core.Keyword(null,"current-path","current-path",-113759954));
var bundle_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48635__$1,new cljs.core.Keyword(null,"bundle?","bundle?",-35631730));
...
var url__$1 = (function (){var G__48636 = url;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48636),"index.html"].join('');
} else {
return G__48636;
}
})();
...
nextjournal.clerk.static_app.show = (function nextjournal$clerk$static_app$show(p__48637){
var map__48638 = p__48637;
var map__48638__$1 = cljs.core.__destructure_map(map__48638);
var view_data = map__48638__$1;
var sha = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48638__$1,new cljs.core.Keyword("git","sha","git/sha",-950222993));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48638__$1,new cljs.core.Keyword("git","url","git/url",276391304));
var bundle_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48638__$1,new cljs.core.Keyword(null,"bundle?","bundle?",-35631730));
var doc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48638__$1,new cljs.core.Keyword(null,"doc","doc",1913296891));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48638__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var url__GT_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48638__$1,new cljs.core.Keyword(null,"url->path","url->path",1929246367));
...
nextjournal.clerk.render.set_state_BANG_(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"doc","doc",1913296891),(function (){var G__48639 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(doc,new cljs.core.Keyword(null,"bundle?","bundle?",-35631730),bundle_QMARK_);
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__48639,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("nextjournal","value","nextjournal/value",-1912768947),new cljs.core.Keyword(null,"blocks","blocks",-610462153)], null),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.into,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.clerk.static_app.hiccup(header)], null)));
} else {
return G__48639;
}
})()], null));
...
nextjournal.clerk.static_app.index = (function nextjournal$clerk$static_app$index(p__48641){
var map__48642 = p__48641;
var map__48642__$1 = cljs.core.__destructure_map(map__48642);
var view_data = map__48642__$1;
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48642__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
if((typeof document !== 'undefined')){
(document.title = "Clerk");
} else {
}

var with_let48643 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let48643","with-let48643",740039616));
var temp__5808__auto___48651 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___48651 == null)){
} else {
var c__40743__auto___48652 = temp__5808__auto___48651;
if((with_let48643.generation === c__40743__auto___48652.ratomGeneration)){
...
(with_let48643.generation = c__40743__auto___48652.ratomGeneration);
}

var init48644 = (with_let48643.length === (0));
var _BANG_state = ((((init48644) || (cljs.core.not(with_let48643.hasOwnProperty((0))))))?(with_let48643[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"dark-mode?","dark-mode?",2063785096),nextjournal.clerk.render.localstorage_get(nextjournal.clerk.render.local_storage_dark_mode_key)], null))):(with_let48643[(0)]));
var ref_fn = ((((init48644) || (cljs.core.not(with_let48643.hasOwnProperty((1))))))?(with_let48643[(1)] = (function (p1__48640_SHARP_){
if(cljs.core.truth_(p1__48640_SHARP_)){
return nextjournal.clerk.render.setup_dark_mode_BANG_(_BANG_state);
} else {
return null;
}
})):(with_let48643[(1)]));
var res48645 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.bg-gray-100.dark:bg-gray-900.flex.justify-center.overflow-y-auto.w-screen.h-screen.p-4.md:p-0","div.bg-gray-100.dark:bg-gray-900.flex.justify-center.overflow-y-auto.w-screen.h-screen.p-4.md:p-0",-28305780),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ref","ref",1289896967),ref_fn], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.fixed.top-2.left-2.md:left-auto.md:right-2.z-10","div.fixed.top-2.left-2.md:left-auto.md:right-2.z-10",-1924941252),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.clerk.render.dark_mode_toggle,_BANG_state], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.md:my-12.w-full.md:max-w-lg","div.md:my-12.w-full.md:max-w-lg",94095376),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.bg-white.dark:bg-gray-800.shadow-lg.rounded-lg.border.dark:border-gray-800.dark:text-white","div.bg-white.dark:bg-gray-800.shadow-lg.rounded-lg.border.dark:border-gray-800.dark:text-white",775975420),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.px-4.md:px-8.py-3","div.px-4.md:px-8.py-3",-415507650),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1.text-xl","h1.text-xl",-128714254),"Clerk"], null)], null),cljs.core.into.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (path){
...
var map__48646 = cljs.core.deref(nextjournal.clerk.static_app._BANG_match);
var map__48646__$1 = cljs.core.__destructure_map(map__48646);
var match = map__48646__$1;
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48646__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var path_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48646__$1,new cljs.core.Keyword(null,"path-params","path-params",-48130597));
var map__48647 = data;
var map__48647__$1 = cljs.core.__destructure_map(map__48647);
var view = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48647__$1,new cljs.core.Keyword(null,"view","view",1247994814));
...
nextjournal.clerk.static_app.init = (function nextjournal$clerk$static_app$init(p__48649){
var map__48650 = p__48649;
var map__48650__$1 = cljs.core.__destructure_map(map__48650);
var state = map__48650__$1;
var bundle_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48650__$1,new cljs.core.Keyword(null,"bundle?","bundle?",-35631730));
var path__GT_doc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48650__$1,new cljs.core.Keyword(null,"path->doc","path->doc",-634415134));
var path__GT_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48650__$1,new cljs.core.Keyword(null,"path->url","path->url",619884785));
var current_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48650__$1,new cljs.core.Keyword(null,"current-path","current-path",-113759954));
...
if(cljs.core.truth_(bundle_QMARK_)){
var router_48653 = reitit.frontend.router.cljs$core$IFn$_invoke$arity$1(nextjournal.clerk.static_app.get_routes(url__GT_doc));
reitit.frontend.easy.start_BANG_(router_48653,(function (p1__48648_SHARP_){
return cljs.core.reset_BANG_(nextjournal.clerk.static_app._BANG_match,p1__48648_SHARP_);
