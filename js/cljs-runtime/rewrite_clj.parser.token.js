...
var len__5769__auto___63822 = arguments.length;
var i__5770__auto___63823 = (0);
while(true){
if((i__5770__auto___63823 < len__5769__auto___63822)){
args__5775__auto__.push((arguments[i__5770__auto___63823]));

var G__63824 = (i__5770__auto___63823 + (1));
i__5770__auto___63823 = G__63824;
continue;
} else {
}
break;
...
(rewrite_clj.parser.token.read_to_boundary.cljs$core$IFn$_invoke$arity$variadic = (function (reader,p__63818){
var vec__63819 = p__63818;
var allowed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63819,(0),null);
var allowed_QMARK_ = cljs.core.set(allowed);
return rewrite_clj.reader.read_until(reader,(function (p1__63815_SHARP_){
var and__5043__auto__ = cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__63815_SHARP_) : allowed_QMARK_.call(null,p1__63815_SHARP_)));
if(and__5043__auto__){
return rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__63815_SHARP_);
} else {
...
/** @this {Function} */
(rewrite_clj.parser.token.read_to_boundary.cljs$lang$applyTo = (function (seq63816){
var G__63817 = cljs.core.first(seq63816);
var seq63816__$1 = cljs.core.next(seq63816);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__63817,seq63816__$1);
}));
