...
var sym_seq = (function (){var iter__5523__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__63132(s__63133){
return (new cljs.core.LazySeq(null,(function (){
var s__63133__$1 = s__63133;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__63133__$1);
if(temp__5753__auto__){
var s__63133__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63133__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__63133__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__63135 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__63134 = (0);
while(true){
if((i__63134 < size__5522__auto__)){
var i = cljs.core._nth(c__5521__auto__,i__63134);
...
cljs.core.chunk_append(b__63135,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__63258 = (i__63134 + (1));
i__63134 = G__63258;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63135),rewrite_clj$node$fn$fn_walk_$_iter__63132(cljs.core.chunk_rest(s__63133__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63135),null);
}
} else {
var i = cljs.core.first(s__63133__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__63132(cljs.core.rest(s__63133__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__63130_SHARP_){
var or__5045__auto__ = rewrite_clj.node.fn.arg_symbol__GT_gensym(sym_seq,vararg_QMARK_,max_fixed_arg_ndx,p1__63130_SHARP_);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return p1__63130_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k63151,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k63151,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__63165){
var vec__63168 = p__63165;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63168,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63168,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__63150){
var self__ = this;
var G__63150__$1 = this;
return (new cljs.core.RecordIter((0),G__63150__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this63152,other63153){
var self__ = this;
var this63152__$1 = this;
return (((!((other63153 == null)))) && ((((this63152__$1.constructor === other63153.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63152__$1.children,other63153.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63152__$1.__extmap,other63153.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k63151){
var self__ = this;
var this__5350__auto____$1 = this;
var G__63224 = k63151;
var G__63224__$1 = (((G__63224 instanceof cljs.core.Keyword))?G__63224.fqn:null);
switch (G__63224__$1) {
case "children":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k63151);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__63150){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__63228 = cljs.core.keyword_identical_QMARK_;
var expr__63229 = k__5352__auto__;
if(cljs.core.truth_((pred__63228.cljs$core$IFn$_invoke$arity$2 ? pred__63228.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__63229) : pred__63228.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__63229)))){
return (new rewrite_clj.node.fn.FnNode(G__63150,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__63150),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__63150){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__63150,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__63154){
var extmap__5385__auto__ = (function (){var G__63241 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__63154,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__63154)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__63241);
} else {
return G__63241;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__63154),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
