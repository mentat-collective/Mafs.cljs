...
var len__5769__auto___41196 = arguments.length;
var i__5770__auto___41197 = (0);
while(true){
if((i__5770__auto___41197 < len__5769__auto___41196)){
args__5775__auto__.push((arguments[i__5770__auto___41197]));

var G__41199 = (i__5770__auto___41197 + (1));
i__5770__auto___41197 = G__41199;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41118){
var G__41119 = cljs.core.first(seq41118);
var seq41118__$1 = cljs.core.next(seq41118);
var G__41120 = cljs.core.first(seq41118__$1);
var seq41118__$2 = cljs.core.next(seq41118__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41119,G__41120,seq41118__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41140_SHARP_){
return (!((cljs.core.meta(p1__41140_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41165__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41166){var _e__39526__auto__ = e41166;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e41168){var _e__39526__auto__ = e41168;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__41171 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__41172 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__41172);

try{var map__41173 = opts;
var map__41173__$1 = cljs.core.__destructure_map(map__41173);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41173__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__41171);
}});
...
var temp__5751__auto___41215 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___41215)){
var managed_print_level_41216 = temp__5751__auto___41215;
var _STAR_print_level_STAR__orig_val__41175_41217 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41176_41218 = managed_print_level_41216;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41176_41218);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__41174_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__41174_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41175_41217);
}} else {
job_fn();
}
