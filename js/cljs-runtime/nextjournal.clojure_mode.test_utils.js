...
var vec__50580 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__50584,match){
var vec__50585 = p__50584;
var doc__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50585,(0),null);
var ranges = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50585,(1),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (doc__$1,p__50594){
...
var empty = (function (){var obj50598 = map__50595__$1;
if((!((obj50598 == null)))){
return (obj50598["empty"]);
} else {
return undefined;
}
})();
var from = (function (){var obj50599 = map__50595__$1;
if((!((obj50599 == null)))){
return (obj50599["from"]);
} else {
return undefined;
}
})();
var to = (function (){var obj50600 = map__50595__$1;
if((!((obj50600 == null)))){
return (obj50600["to"]);
} else {
return undefined;
...
var _ = (function (){var G__50602 = ({"state": state, "dispatch": (function (p1__50601_SHARP_){
return cljs.core.reset_BANG_(_BANG_tr,p1__50601_SHARP_);
})});
return (cmd.cljs$core$IFn$_invoke$arity$1 ? cmd.cljs$core$IFn$_invoke$arity$1(G__50602) : cmd.call(null,G__50602));
})();
var tr = cljs.core.deref(_BANG_tr);
return nextjournal.clojure_mode.test_utils.state_str((function (){var obj50603 = tr;
if((!((obj50603 == null)))){
return (obj50603["state"]);
} else {
return undefined;
}
})());
