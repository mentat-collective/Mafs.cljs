...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__63835 = cljs.core.get_global_hierarchy;
return (fexpr__63835.cljs$core$IFn$_invoke$arity$0 ? fexpr__63835.cljs$core$IFn$_invoke$arity$0() : fexpr__63835.call(null));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__63837_SHARP_){
var _STAR_delimiter_STAR__orig_val__63838 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__63839 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__63839);

try{return rewrite_clj.parser.core.parse_next(p1__63837_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__63838);
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__5775__auto__ = [];
var len__5769__auto___63853 = arguments.length;
var i__5770__auto___63855 = (0);
while(true){
if((i__5770__auto___63855 < len__5769__auto___63853)){
args__5775__auto__.push((arguments[i__5770__auto___63855]));

var G__63856 = (i__5770__auto___63855 + (1));
i__5770__auto___63855 = G__63856;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__63844){
var vec__63845 = p__63844;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63845,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq63840){
var G__63841 = cljs.core.first(seq63840);
var seq63840__$1 = cljs.core.next(seq63840);
var G__63842 = cljs.core.first(seq63840__$1);
var seq63840__$2 = cljs.core.next(seq63840__$1);
var G__63843 = cljs.core.first(seq63840__$2);
var seq63840__$3 = cljs.core.next(seq63840__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__63841,G__63842,G__63843,seq63840__$3);
}));
...
var G__63849 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__63849)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__63849)){
...
return cljs.core.cons((function (){var G__63851 = rewrite_clj.reader.peek(reader);
switch (G__63851) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__63849)){
