...
var sci$impl$types$IBox$setVal$dyn_53172 = (function (_this,_v){
...
return sci$impl$types$IBox$setVal$dyn_53172(_this,_v);
}
});

var sci$impl$types$IBox$getVal$dyn_53173 = (function (_this){
var x__5393__auto__ = (((_this == null))?null:_this);
...
return sci$impl$types$IBox$getVal$dyn_53173(_this);
}
});
...
var sci$impl$types$IReified$getInterfaces$dyn_53174 = (function (_){
...
return sci$impl$types$IReified$getInterfaces$dyn_53174(_);
}
});

var sci$impl$types$IReified$getMethods$dyn_53175 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$IReified$getMethods$dyn_53175(_);
}
});

var sci$impl$types$IReified$getProtocols$dyn_53176 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$IReified$getProtocols$dyn_53176(_);
}
});
...
var sci$impl$types$SciTypeInstance$_get_type$dyn_53177 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$SciTypeInstance$_get_type$dyn_53177(_);
}
});

var sci$impl$types$SciTypeInstance$_mutate$dyn_53178 = (function (_,k,v){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$SciTypeInstance$_mutate$dyn_53178(_,k,v);
}
});
...
var or__5045__auto____$2 = (function (){var G__53133 = x;
var G__53133__$1 = (((G__53133 == null))?null:cljs.core.meta(G__53133));
if((G__53133__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(G__53133__$1);
}
})();
...
/** @this {Function} */
(sci.impl.types.type_impl.cljs$lang$applyTo = (function (seq53121){
var G__53122 = cljs.core.first(seq53121);
var seq53121__$1 = cljs.core.next(seq53121);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53122,seq53121__$1);
}));
...
var or__5045__auto____$1 = (function (){var G__53138 = x;
var G__53138__$1 = (((G__53138 == null))?null:cljs.core.meta(G__53138));
if((G__53138__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(G__53138__$1);
}
})();
if(cljs.core.truth_(or__5045__auto____$1)){
return or__5045__auto____$1;
...
var sci$impl$types$Stack$stack$dyn_53182 = (function (this$){
...
return sci$impl$types$Stack$stack$dyn_53182(this$);
}
});
...
(sci.impl.types.NodeR.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k53143,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k53143,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__53150){
var vec__53155 = p__53150;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53155,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53155,(1),null);
...
(sci.impl.types.NodeR.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__53142){
var self__ = this;
var G__53142__$1 = this;
return (new cljs.core.RecordIter((0),G__53142__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"stack","stack",-793405930)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this53144,other53145){
var self__ = this;
var this53144__$1 = this;
return (((!((other53145 == null)))) && ((((this53144__$1.constructor === other53145.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this53144__$1.f,other53145.f)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this53144__$1.stack,other53145.stack)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this53144__$1.__extmap,other53145.__extmap)))))))));
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k53143){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k53143);

}
}));

(sci.impl.types.NodeR.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__53142){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__53165 = cljs.core.keyword_identical_QMARK_;
var expr__53166 = k__5352__auto__;
if(cljs.core.truth_((pred__53165.cljs$core$IFn$_invoke$arity$2 ? pred__53165.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),expr__53166) : pred__53165.call(null,new cljs.core.Keyword(null,"f","f",-1597136552),expr__53166)))){
return (new sci.impl.types.NodeR(G__53142,self__.stack,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__53165.cljs$core$IFn$_invoke$arity$2 ? pred__53165.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"stack","stack",-793405930),expr__53166) : pred__53165.call(null,new cljs.core.Keyword(null,"stack","stack",-793405930),expr__53166)))){
return (new sci.impl.types.NodeR(self__.f,G__53142,self__.__meta,self__.__extmap,null));
} else {
return (new sci.impl.types.NodeR(self__.f,self__.stack,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__53142),null));
}
}
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__53142){
var self__ = this;
var this__5342__auto____$1 = this;
return (new sci.impl.types.NodeR(self__.f,self__.stack,G__53142,self__.__extmap,self__.__hash));
}));
 ...
 */
sci.impl.types.map__GT_NodeR = (function sci$impl$types$map__GT_NodeR(G__53146){
var extmap__5385__auto__ = (function (){var G__53168 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__53146,new cljs.core.Keyword(null,"f","f",-1597136552),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"stack","stack",-793405930)], 0));
if(cljs.core.record_QMARK_(G__53146)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__53168);
} else {
return G__53168;
}
})();
return (new sci.impl.types.NodeR(new cljs.core.Keyword(null,"f","f",-1597136552).cljs$core$IFn$_invoke$arity$1(G__53146),new cljs.core.Keyword(null,"stack","stack",-793405930).cljs$core$IFn$_invoke$arity$1(G__53146),null,cljs.core.not_empty(extmap__5385__auto__),null));
});

sci.impl.types.eval = (function sci$impl$types$eval(expr,ctx,bindings){
if((expr instanceof sci.impl.types.NodeR)){
var fexpr__53169 = expr.f;
return (fexpr__53169.cljs$core$IFn$_invoke$arity$3 ? fexpr__53169.cljs$core$IFn$_invoke$arity$3(expr,ctx,bindings) : fexpr__53169.call(null,expr,ctx,bindings));
} else {
return expr;
}
});
...
var sci$impl$types$HasName$getName$dyn_53193 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$HasName$getName$dyn_53193(_);
}
});
