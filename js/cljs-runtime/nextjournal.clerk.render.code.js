...
nextjournal.clerk.render.code.style__GT_hiccup_tag = (function nextjournal$clerk$render$code$style__GT_hiccup_tag(p__48133){
var map__48137 = p__48133;
...
var tagName = (function (){var obj48140 = map__48137__$1;
if((!((obj48140 == null)))){
return (obj48140["tagName"]);
} else {
return undefined;
}
})();
var class$ = (function (){var obj48141 = map__48137__$1;
if((!((obj48141 == null)))){
return (obj48141["class"]);
} else {
return undefined;
}
})();
...
nextjournal.clerk.render.code.intersects_QMARK_ = (function nextjournal$clerk$render$code$intersects_QMARK_(p__48144,range){
var map__48146 = p__48144;
var map__48146__$1 = (((((!((map__48146 == null))))?(((((map__48146.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48146.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__48146):map__48146);
var from = (function (){var obj48148 = map__48146__$1;
if((!((obj48148 == null)))){
return (obj48148["from"]);
} else {
return undefined;
}
})();
var to = (function (){var obj48149 = map__48146__$1;
if((!((obj48149 == null)))){
return (obj48149["to"]);
} else {
return undefined;
...
var map__48150 = text.line(i);
var map__48150__$1 = (((((!((map__48150 == null))))?(((((map__48150.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48150.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__48150):map__48150);
var line = map__48150__$1;
var from = (function (){var obj48152 = map__48150__$1;
if((!((obj48152 == null)))){
return (obj48152["from"]);
} else {
return undefined;
}
})();
var to = (function (){var obj48153 = map__48150__$1;
if((!((obj48153 == null)))){
return (obj48153["to"]);
} else {
return undefined;
...
var length = (function (){var obj48154 = map__48150__$1;
if((!((obj48154 == null)))){
return (obj48154["length"]);
} else {
return undefined;
}
})();
...
var G__48177 = buf;
if((pos < to)){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(G__48177,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [text.sliceString(pos,to)], null));
} else {
return G__48177;
}
} else {
var map__48178 = temp__5806__auto__;
var map__48178__$1 = cljs.core.__destructure_map(map__48178);
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48178__$1,new cljs.core.Keyword(null,"from","from",1815293044));
var end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48178__$1,new cljs.core.Keyword(null,"to","to",192099007));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48178__$1,new cljs.core.Keyword(null,"val","val",128701612));
var G__48329 = end;
var G__48330 = cljs.core.next(lds);
var G__48331 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(buf,(function (){var G__48180 = (new cljs.core.List(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.clerk.render.code.style__GT_hiccup_tag(style),text.sliceString((function (){var x__5130__auto__ = from;
...
if((pos < start)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__48180,text.sliceString(pos,start));
} else {
return G__48180;
}
})());
...
var G__48300_48336 = tr.state.sliceDoc();
(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__48300_48336) : f.call(null,G__48300_48336));
} else {
}
...
(nextjournal.clerk.render.code.editor.cljs$core$IFn$_invoke$arity$2 = (function (_BANG_code_str,p__48308){
var map__48309 = p__48308;
var map__48309__$1 = cljs.core.__destructure_map(map__48309);
var extensions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48309__$1,new cljs.core.Keyword(null,"extensions","extensions",-1103629196));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48309__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__48301_SHARP_){
return cljs.core.reset_BANG_(_BANG_code_str,p1__48301_SHARP_);
}));
...
var view = cljs.core.reset_BANG_(_BANG_view,nextjournal.clerk.render.code.make_view(nextjournal.clerk.render.code.make_state(cljs.core.deref(_BANG_code_str),(function (){var G__48312 = nextjournal.clerk.render.code.default_extensions;
var G__48312__$1 = ((cljs.core.seq(extensions))?G__48312.concat(extensions):G__48312);
if(cljs.core.truth_(on_change)){
return G__48312__$1.concat(nextjournal.clerk.render.code.on_change_ext(on_change));
} else {
return G__48312__$1;
}
