...
nextjournal.clerk.render.code.style__GT_hiccup_tag = (function nextjournal$clerk$render$code$style__GT_hiccup_tag(p__48021){
var map__48022 = p__48021;
var map__48022__$1 = (((((!((map__48022 == null))))?(((((map__48022.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48022.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__48022):map__48022);
var tagName = (function (){var obj48024 = map__48022__$1;
if((!((obj48024 == null)))){
return (obj48024["tagName"]);
} else {
return undefined;
}
})();
var class$ = (function (){var obj48025 = map__48022__$1;
if((!((obj48025 == null)))){
return (obj48025["class"]);
} else {
return undefined;
}
})();
...
nextjournal.clerk.render.code.intersects_QMARK_ = (function nextjournal$clerk$render$code$intersects_QMARK_(p__48026,range){
...
var from = (function (){var obj48030 = map__48027__$1;
if((!((obj48030 == null)))){
return (obj48030["from"]);
} else {
return undefined;
}
})();
var to = (function (){var obj48031 = map__48027__$1;
if((!((obj48031 == null)))){
return (obj48031["to"]);
} else {
return undefined;
...
var line = map__48032__$1;
var from = (function (){var obj48035 = map__48032__$1;
if((!((obj48035 == null)))){
return (obj48035["from"]);
} else {
return undefined;
}
})();
var to = (function (){var obj48036 = map__48032__$1;
if((!((obj48036 == null)))){
return (obj48036["to"]);
} else {
return undefined;
...
var length = (function (){var obj48037 = map__48032__$1;
if((!((obj48037 == null)))){
return (obj48037["length"]);
} else {
return undefined;
}
})();
...
var G__48060 = buf;
if((pos < to)){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(G__48060,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [text.sliceString(pos,to)], null));
} else {
return G__48060;
}
} else {
var map__48061 = temp__5806__auto__;
var map__48061__$1 = cljs.core.__destructure_map(map__48061);
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48061__$1,new cljs.core.Keyword(null,"from","from",1815293044));
var end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48061__$1,new cljs.core.Keyword(null,"to","to",192099007));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48061__$1,new cljs.core.Keyword(null,"val","val",128701612));
var G__48078 = end;
var G__48079 = cljs.core.next(lds);
var G__48080 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(buf,(function (){var G__48062 = (new cljs.core.List(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.clerk.render.code.style__GT_hiccup_tag(style),text.sliceString((function (){var x__5130__auto__ = from;
...
if((pos < start)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__48062,text.sliceString(pos,start));
} else {
return G__48062;
}
})());
...
var G__48066_48081 = tr.state.sliceDoc();
(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__48066_48081) : f.call(null,G__48066_48081));
} else {
}
...
(nextjournal.clerk.render.code.editor.cljs$core$IFn$_invoke$arity$2 = (function (_BANG_code_str,p__48073){
var map__48074 = p__48073;
var map__48074__$1 = cljs.core.__destructure_map(map__48074);
var extensions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48074__$1,new cljs.core.Keyword(null,"extensions","extensions",-1103629196));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48074__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__48067_SHARP_){
return cljs.core.reset_BANG_(_BANG_code_str,p1__48067_SHARP_);
}));
...
var view = cljs.core.reset_BANG_(_BANG_view,nextjournal.clerk.render.code.make_view(nextjournal.clerk.render.code.make_state(cljs.core.deref(_BANG_code_str),(function (){var G__48075 = nextjournal.clerk.render.code.default_extensions;
var G__48075__$1 = ((cljs.core.seq(extensions))?G__48075.concat(extensions):G__48075);
if(cljs.core.truth_(on_change)){
return G__48075__$1.concat(nextjournal.clerk.render.code.on_change_ext(on_change));
} else {
return G__48075__$1;
}
