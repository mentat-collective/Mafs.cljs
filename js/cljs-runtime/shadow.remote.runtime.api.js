...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_45186 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_45186(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_45187 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_45187(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_45188 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_45188(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_45189 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_45189(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_45190 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_45190(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_45195 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_45195(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__45176,callback){
var map__45177 = p__45176;
var map__45177__$1 = cljs.core.__destructure_map(map__45177);
var input = map__45177__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45177__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45177__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
