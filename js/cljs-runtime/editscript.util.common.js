...
var vec__50749 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(fp,(k - (1)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(-1),cljs.core.PersistentVector.EMPTY], null));
var dk_1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50749,(0),null);
var vk_1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50749,(1),null);
var dk_1__$1 = (dk_1 + (1));
var vec__50752 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(fp,(k + (1)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(-1),cljs.core.PersistentVector.EMPTY], null));
var dk_PLUS_1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50752,(0),null);
var vk_PLUS_1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50752,(1),null);
...
return (function (p1__50664_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__50664_SHARP_,(1));
...
var vec__50814 = cljs.core.split_with((function (p1__50807_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__50807_SHARP_,m);
}),coll);
var ms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50814,(0),null);
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50814,(1),null);
...
editscript.util.common.vec_edits = (function editscript$util$common$vec_edits(a,b,p__50840){
var map__50845 = p__50840;
var map__50845__$1 = cljs.core.__destructure_map(map__50845);
var vec_timeout = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50845__$1,new cljs.core.Keyword(null,"vec-timeout","vec-timeout",1050752333),(1000));
...
var s = (function (){var G__50887 = b;
var G__50888 = cljs.core.deref(i);
var G__50889 = (cljs.core.deref(i) + c);
return (sf.cljs$core$IFn$_invoke$arity$3 ? sf.cljs$core$IFn$_invoke$arity$3(G__50887,G__50888,G__50889) : sf.call(null,G__50887,G__50888,G__50889));
})();
...
var s = (function (){var G__50894 = b;
var G__50895 = cljs.core.deref(i);
var G__50896 = (cljs.core.deref(i) + c);
return (sf.cljs$core$IFn$_invoke$arity$3 ? sf.cljs$core$IFn$_invoke$arity$3(G__50894,G__50895,G__50896) : sf.call(null,G__50894,G__50895,G__50896));
})();
i.cljs$core$IVolatile$_vreset_BANG_$arity$2(null,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,c)(i.cljs$core$IDeref$_deref$arity$1(null)));
...
editscript.util.common.diff_str = (function editscript$util$common$diff_str(script,path,a,b,p__50901){
var map__50903 = p__50901;
var map__50903__$1 = cljs.core.__destructure_map(map__50903);
var opts = map__50903__$1;
var str_change_limit = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50903__$1,new cljs.core.Keyword(null,"str-change-limit","str-change-limit",529572329),0.2);
var str_diff = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50903__$1,new cljs.core.Keyword(null,"str-diff","str-diff",1239614806));
