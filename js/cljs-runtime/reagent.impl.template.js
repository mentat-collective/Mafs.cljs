...
var G__48104 = o;
reagent.impl.template.goog$module$goog$object.set(G__48104,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__48155__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__48155 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__48156__i = 0, G__48156__a = new Array(arguments.length -  0);
while (G__48156__i < G__48156__a.length) {G__48156__a[G__48156__i] = arguments[G__48156__i + 0]; ++G__48156__i;}
  args = new cljs.core.IndexedSeq(G__48156__a,0,null);
} 
return G__48155__delegate.call(this,args);};
G__48155.cljs$lang$maxFixedArity = 0;
G__48155.cljs$lang$applyTo = (function (arglist__48157){
var args = cljs.core.seq(arglist__48157);
return G__48155__delegate(args);
});
G__48155.cljs$core$IFn$_invoke$arity$variadic = G__48155__delegate;
return G__48155;
})()
;
} else {
...
var G__48107 = o;
reagent.impl.template.goog$module$goog$object.set(G__48107,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__48110 = props;
var G__48110__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48110,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__48110);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48110__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__48112 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48112,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__48112;
}
})(),id_class);
...
var G__48113 = (cljs.core.count(argv) - first_child);
switch (G__48113) {
case (0):
...
var vec__48114 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48114,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48114,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48114,(2),null);
...
var temp__5808__auto___48168 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___48168 == null)){
} else {
var key_48169 = temp__5808__auto___48168;
(jsprops.key = key_48169);
}
...
var temp__5808__auto___48170 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___48170 == null)){
} else {
var key_48171 = temp__5808__auto___48170;
(jsprops.key = key_48171);
}
...
var temp__5808__auto___48175 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___48175 == null)){
} else {
var key_48176 = temp__5808__auto___48175;
(jsprops.key = key_48176);
}
...
var temp__5808__auto___48179 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___48179 == null)){
} else {
var key_48181 = temp__5808__auto___48179;
(jsprops.key = key_48181);
}
...
var temp__5808__auto___48182 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___48182 == null)){
} else {
var key_48183 = temp__5808__auto___48182;
(jsprops.key = key_48183);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48119_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__48119_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__48120 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48120,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48120,(1),null);
...
break;
default:
var G__48187 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__48188 = compiler;
v = G__48187;
compiler = G__48188;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template48134 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template48134 = (function (opts,id,fn_to_element,parse_fn,meta48135){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta48135 = meta48135;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template48134.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_48136,meta48135__$1){
var self__ = this;
var _48136__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template48134(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta48135__$1));
}));

(reagent.impl.template.t_reagent$impl$template48134.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_48136){
var self__ = this;
var _48136__$1 = this;
return self__.meta48135;
}));

(reagent.impl.template.t_reagent$impl$template48134.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template48134.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template48134.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template48134.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template48134.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template48134.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta48135","meta48135",-1458256766,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template48134.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template48134.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template48134");

(reagent.impl.template.t_reagent$impl$template48134.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template48134");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template48134.
 */
reagent.impl.template.__GT_t_reagent$impl$template48134 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template48134(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta48135){
return (new reagent.impl.template.t_reagent$impl$template48134(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta48135));
});

}

return (new reagent.impl.template.t_reagent$impl$template48134(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
