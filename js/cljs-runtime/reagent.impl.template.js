...
var G__49508 = o;
reagent.impl.template.goog$module$goog$object.set(G__49508,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__49513 = o;
reagent.impl.template.goog$module$goog$object.set(G__49513,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__49540__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__49540 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__49541__i = 0, G__49541__a = new Array(arguments.length -  0);
while (G__49541__i < G__49541__a.length) {G__49541__a[G__49541__i] = arguments[G__49541__i + 0]; ++G__49541__i;}
  args = new cljs.core.IndexedSeq(G__49541__a,0,null);
} 
return G__49540__delegate.call(this,args);};
G__49540.cljs$lang$maxFixedArity = 0;
G__49540.cljs$lang$applyTo = (function (arglist__49542){
var args = cljs.core.seq(arglist__49542);
return G__49540__delegate(args);
});
G__49540.cljs$core$IFn$_invoke$arity$variadic = G__49540__delegate;
return G__49540;
})()
;
} else {
...
var G__49514 = props;
var G__49514__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49514,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__49514);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49514__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__49520 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49520,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__49520;
}
})(),id_class);
...
var G__49521 = (cljs.core.count(argv) - first_child);
switch (G__49521) {
case (0):
...
var vec__49522 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49522,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49522,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49522,(2),null);
...
var temp__5808__auto___49550 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___49550 == null)){
} else {
var key_49551 = temp__5808__auto___49550;
(jsprops.key = key_49551);
}
...
var temp__5808__auto___49552 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___49552 == null)){
} else {
var key_49553 = temp__5808__auto___49552;
(jsprops.key = key_49553);
}
...
var temp__5808__auto___49555 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___49555 == null)){
} else {
var key_49557 = temp__5808__auto___49555;
(jsprops.key = key_49557);
}
...
var temp__5808__auto___49564 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___49564 == null)){
} else {
var key_49565 = temp__5808__auto___49564;
(jsprops.key = key_49565);
}
...
var temp__5808__auto___49566 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___49566 == null)){
} else {
var key_49567 = temp__5808__auto___49566;
(jsprops.key = key_49567);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49525_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__49525_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__49526 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49526,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49526,(1),null);
...
break;
default:
var G__49569 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__49570 = compiler;
v = G__49569;
compiler = G__49570;
continue;
...
var G__49530 = tag;
var G__49530__$1 = (((G__49530 instanceof cljs.core.Keyword))?G__49530.fqn:null);
switch (G__49530__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template49532 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template49532 = (function (opts,id,fn_to_element,parse_fn,meta49533){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta49533 = meta49533;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template49532.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_49534,meta49533__$1){
var self__ = this;
var _49534__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template49532(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta49533__$1));
}));

(reagent.impl.template.t_reagent$impl$template49532.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_49534){
var self__ = this;
var _49534__$1 = this;
return self__.meta49533;
}));

(reagent.impl.template.t_reagent$impl$template49532.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template49532.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template49532.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template49532.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template49532.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template49532.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta49533","meta49533",781541784,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template49532.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template49532.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template49532");

(reagent.impl.template.t_reagent$impl$template49532.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template49532");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template49532.
 */
reagent.impl.template.__GT_t_reagent$impl$template49532 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template49532(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta49533){
return (new reagent.impl.template.t_reagent$impl$template49532(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta49533));
});

}

return (new reagent.impl.template.t_reagent$impl$template49532(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
