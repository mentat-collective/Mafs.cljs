...
var G__50744 = o;
reagent.impl.template.goog$module$goog$object.set(G__50744,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__50750 = o;
reagent.impl.template.goog$module$goog$object.set(G__50750,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__50777__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__50777 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__50778__i = 0, G__50778__a = new Array(arguments.length -  0);
while (G__50778__i < G__50778__a.length) {G__50778__a[G__50778__i] = arguments[G__50778__i + 0]; ++G__50778__i;}
  args = new cljs.core.IndexedSeq(G__50778__a,0,null);
} 
return G__50777__delegate.call(this,args);};
G__50777.cljs$lang$maxFixedArity = 0;
G__50777.cljs$lang$applyTo = (function (arglist__50779){
var args = cljs.core.seq(arglist__50779);
return G__50777__delegate(args);
});
G__50777.cljs$core$IFn$_invoke$arity$variadic = G__50777__delegate;
return G__50777;
})()
;
} else {
...
var G__50752 = props;
var G__50752__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50752,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__50752);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50752__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__50753 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50753,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__50753;
}
})(),id_class);
...
var G__50754 = (cljs.core.count(argv) - first_child);
switch (G__50754) {
case (0):
...
var vec__50756 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50756,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50756,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50756,(2),null);
...
var temp__5808__auto___50781 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___50781 == null)){
} else {
var key_50782 = temp__5808__auto___50781;
(jsprops.key = key_50782);
}
...
var temp__5808__auto___50783 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___50783 == null)){
} else {
var key_50784 = temp__5808__auto___50783;
(jsprops.key = key_50784);
}
...
var temp__5808__auto___50785 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___50785 == null)){
} else {
var key_50786 = temp__5808__auto___50785;
(jsprops.key = key_50786);
}
...
var temp__5808__auto___50793 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___50793 == null)){
} else {
var key_50794 = temp__5808__auto___50793;
(jsprops.key = key_50794);
}
...
var temp__5808__auto___50795 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___50795 == null)){
} else {
var key_50796 = temp__5808__auto___50795;
(jsprops.key = key_50796);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50763_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__50763_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__50765 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50765,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50765,(1),null);
...
break;
default:
var G__50804 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__50805 = compiler;
v = G__50804;
compiler = G__50805;
continue;
...
var G__50769 = tag;
var G__50769__$1 = (((G__50769 instanceof cljs.core.Keyword))?G__50769.fqn:null);
switch (G__50769__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template50771 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template50771 = (function (opts,id,fn_to_element,parse_fn,meta50772){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template50771.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_50773,meta50772__$1){
var self__ = this;
var _50773__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template50771(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta50772__$1));
}));

(reagent.impl.template.t_reagent$impl$template50771.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_50773){
var self__ = this;
var _50773__$1 = this;
return self__.meta50772;
}));

(reagent.impl.template.t_reagent$impl$template50771.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template50771.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template50771.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template50771.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template50771.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template50771.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta50772","meta50772",1035501603,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template50771.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template50771.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template50771");

(reagent.impl.template.t_reagent$impl$template50771.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template50771");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template50771.
 */
reagent.impl.template.__GT_t_reagent$impl$template50771 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template50771(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta50772){
return (new reagent.impl.template.t_reagent$impl$template50771(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta50772));
});

}

return (new reagent.impl.template.t_reagent$impl$template50771(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
