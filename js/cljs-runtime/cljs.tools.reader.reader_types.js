...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_43119 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_43119(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_43120 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_43120(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43121 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43121(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43122 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43122(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43123 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43123(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43124 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43124(reader);
}
});
...
var G__43165 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__43166 = s.append(c);
c = G__43165;
s = G__43166;
continue;
}
