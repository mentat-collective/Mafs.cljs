...
nextjournal.clojure_mode.extensions.match_brackets.state = module$node_modules$$codemirror$state$dist$index_cjs.StateField.define(({"create":cljs.core.constantly(module$node_modules$$codemirror$view$dist$index_cjs.Decoration.none),"update":(function (deco,p__47713){
var map__47718 = p__47713;
...
var tr = map__47718__$1;
var state = (function (){var obj47740 = map__47718__$1;
if((!((obj47740 == null)))){
return (obj47740["state"]);
} else {
return undefined;
}
})();
var docChanged = (function (){var obj47742 = map__47718__$1;
if((!((obj47742 == null)))){
return (obj47742["docChanged"]);
} else {
return undefined;
}
})();
var selection = (function (){var obj47744 = map__47718__$1;
if((!((obj47744 == null)))){
return (obj47744["selection"]);
} else {
return undefined;
}
})();
...
var decos = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (out,p__47776){
var map__47783 = p__47776;
...
var head = (function (){var obj47799 = map__47783__$1;
if((!((obj47799 == null)))){
return (obj47799["head"]);
} else {
return undefined;
}
})();
var empty = (function (){var obj47807 = map__47783__$1;
if((!((obj47807 == null)))){
return (obj47807["empty"]);
} else {
return undefined;
}
})();
...
var G__47826 = tr.state.doc.slice(head,(head + (1))).toString();
var fexpr__47825 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [")",null,"]",null,"}",null], null), null);
return (fexpr__47825.cljs$core$IFn$_invoke$arity$1 ? fexpr__47825.cljs$core$IFn$_invoke$arity$1(G__47826) : fexpr__47825.call(null,G__47826));
} else {
return and__5043__auto__;
}
})();
