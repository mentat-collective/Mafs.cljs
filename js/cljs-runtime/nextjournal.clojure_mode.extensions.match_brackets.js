...
nextjournal.clojure_mode.extensions.match_brackets.state = module$node_modules$$codemirror$state$dist$index_cjs.StateField.define(({"create":cljs.core.constantly(module$node_modules$$codemirror$view$dist$index_cjs.Decoration.none),"update":(function (deco,p__49104){
var map__49105 = p__49104;
var map__49105__$1 = (((((!((map__49105 == null))))?(((((map__49105.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49105.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__49105):map__49105);
var tr = map__49105__$1;
var state = (function (){var obj49112 = map__49105__$1;
if((!((obj49112 == null)))){
return (obj49112["state"]);
} else {
return undefined;
}
})();
var docChanged = (function (){var obj49114 = map__49105__$1;
if((!((obj49114 == null)))){
return (obj49114["docChanged"]);
} else {
return undefined;
}
})();
var selection = (function (){var obj49115 = map__49105__$1;
if((!((obj49115 == null)))){
return (obj49115["selection"]);
} else {
return undefined;
}
})();
...
var decos = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (out,p__49121){
var map__49122 = p__49121;
var map__49122__$1 = (((((!((map__49122 == null))))?(((((map__49122.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49122.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__49122):map__49122);
var head = (function (){var obj49127 = map__49122__$1;
if((!((obj49127 == null)))){
return (obj49127["head"]);
} else {
return undefined;
}
})();
var empty = (function (){var obj49129 = map__49122__$1;
if((!((obj49129 == null)))){
return (obj49129["empty"]);
} else {
return undefined;
}
})();
...
var G__49137 = tr.state.doc.slice(head,(head + (1))).toString();
var fexpr__49136 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [")",null,"]",null,"}",null], null), null);
return (fexpr__49136.cljs$core$IFn$_invoke$arity$1 ? fexpr__49136.cljs$core$IFn$_invoke$arity$1(G__49137) : fexpr__49136.call(null,G__49137));
} else {
return and__5043__auto__;
}
})();
