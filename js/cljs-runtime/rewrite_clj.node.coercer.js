...
var G__63895 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s__$1,(eol_ndx + cljs.core.count(m)));
var G__63896 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lines,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s__$1,(0),eol_ndx));
s__$1 = G__63895;
lines = G__63896;
continue;
} else {
...
var comma_63897 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_63898 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_63897),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__63873){
var vec__63874 = p__63873;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63874,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63874,(1),null);
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_63898,rewrite_clj.node.protocols.coerce(v),comma_63897);
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__63884 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__63884) : f.call(null,G__63884));
})(),sq);
});
