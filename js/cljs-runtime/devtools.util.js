...
var len__5769__auto___42034 = arguments.length;
var i__5770__auto___42035 = (0);
while(true){
if((i__5770__auto___42035 < len__5769__auto___42034)){
args__5775__auto__.push((arguments[i__5770__auto___42035]));

var G__42036 = (i__5770__auto___42035 + (1));
i__5770__auto___42035 = G__42036;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__41905_42038 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__41906_42039 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__41907_42040 = true;
var _STAR_print_fn_STAR__temp_val__41908_42041 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__41907_42040);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__41908_42041);

try{var _STAR_print_level_STAR__orig_val__41909_42042 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41910_42043 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41910_42043);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41909_42042);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__41906_42039);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__41905_42038);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq41904){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq41904));
}));
...
var new_formatters = current_formatters.filter((function (p1__41973_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__41973_SHARP_)));
}));
...
var G__41985_42045 = f;
var target__39524__auto___42046 = G__41985_42045;
if(cljs.core.truth_(target__39524__auto___42046)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41985_42045)].join(''),"\n","target__39524__auto__"].join('')));
}

(target__39524__auto___42046["toString"] = (function (){
...
var G__41997_42047 = "%c%s";
var G__41998_42048 = "color:transparent";
var G__41999_42049 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__41997_42047,G__41998_42048,G__41999_42049) : f.call(null,G__41997_42047,G__41998_42048,G__41999_42049));
...
var args__5775__auto__ = [];
var len__5769__auto___42053 = arguments.length;
var i__5770__auto___42054 = (0);
while(true){
if((i__5770__auto___42054 < len__5769__auto___42053)){
args__5775__auto__.push((arguments[i__5770__auto___42054]));

var G__42055 = (i__5770__auto___42054 + (1));
i__5770__auto___42054 = G__42055;
continue;
} else {
}
break;
...
var vec__42019 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42019,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42019,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__42056__delegate = function (add_fmt,add_args){
...
var G__42056 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__42057__i = 0, G__42057__a = new Array(arguments.length -  1);
while (G__42057__i < G__42057__a.length) {G__42057__a[G__42057__i] = arguments[G__42057__i + 1]; ++G__42057__i;}
  add_args = new cljs.core.IndexedSeq(G__42057__a,0,null);
} 
return G__42056__delegate.call(this,add_fmt,add_args);};
G__42056.cljs$lang$maxFixedArity = 1;
G__42056.cljs$lang$applyTo = (function (arglist__42058){
var add_fmt = cljs.core.first(arglist__42058);
var add_args = cljs.core.rest(arglist__42058);
return G__42056__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq42008){
var G__42009 = cljs.core.first(seq42008);
var seq42008__$1 = cljs.core.next(seq42008);
var G__42011 = cljs.core.first(seq42008__$1);
var seq42008__$2 = cljs.core.next(seq42008__$1);
var G__42012 = cljs.core.first(seq42008__$2);
var seq42008__$3 = cljs.core.next(seq42008__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42009,G__42011,G__42012,seq42008__$3);
}));
...
var seq__42026 = cljs.core.seq(features);
var chunk__42027 = null;
var count__42028 = (0);
var i__42029 = (0);
while(true){
if((i__42029 < count__42028)){
var feature = chunk__42027.cljs$core$IIndexed$_nth$arity$2(null,i__42029);
...
var G__42061 = seq__42026;
var G__42062 = chunk__42027;
var G__42063 = count__42028;
var G__42064 = (i__42029 + (1));
seq__42026 = G__42061;
chunk__42027 = G__42062;
count__42028 = G__42063;
i__42029 = G__42064;
continue;
} else {
...
var c__5568__auto__ = cljs.core.chunk_first(seq__42026__$1);
var G__42065 = cljs.core.chunk_rest(seq__42026__$1);
var G__42066 = c__5568__auto__;
var G__42067 = cljs.core.count(c__5568__auto__);
var G__42068 = (0);
seq__42026 = G__42065;
chunk__42027 = G__42066;
count__42028 = G__42067;
i__42029 = G__42068;
continue;
} else {
var feature = cljs.core.first(seq__42026__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__42069 = cljs.core.next(seq__42026__$1);
var G__42070 = null;
var G__42071 = (0);
var G__42072 = (0);
seq__42026 = G__42069;
chunk__42027 = G__42070;
count__42028 = G__42071;
i__42029 = G__42072;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5751__auto__)){
var o42032 = temp__5751__auto__;
return (o42032["version"]);
} else {
return null;
}
})() == null);
