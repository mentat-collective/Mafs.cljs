...
null===options$jscomp$0.to[0]&&(options$jscomp$0.to=[...options$jscomp$0.to],options$jscomp$0.to[0]=options$jscomp$0.from);var $jscomp$inline_3119=Object.assign({},transition);$jscomp$inline_3119=(delete $jscomp$inline_3119.when,delete $jscomp$inline_3119.delay,delete $jscomp$inline_3119.delayChildren,delete $jscomp$inline_3119.staggerChildren,delete $jscomp$inline_3119.staggerDirection,delete $jscomp$inline_3119.repeat,delete $jscomp$inline_3119.repeatType,delete $jscomp$inline_3119.repeatDelay,
delete $jscomp$inline_3119.from,$jscomp$inline_3119);if(!Object.keys($jscomp$inline_3119).length){$jscomp$inline_3119=Object;var JSCompiler_temp_const=$jscomp$inline_3119.assign,to=options$jscomp$0.to;key=Array.isArray(to)?keyframes$1:defaultTransitions[key]||defaultTransitions.default;key=Object.assign({},{to},key(to));transition=JSCompiler_temp_const.call($jscomp$inline_3119,{},transition,key)}key=Object;$jscomp$inline_3119=key.assign;var $jscomp$inline_3136=transition,$jscomp$inline_3137=Object.assign({},
$jscomp$inline_3136);transition=$jscomp$inline_3136.ease;var times=$jscomp$inline_3136.times;JSCompiler_temp_const=$jscomp$inline_3136.yoyo;to=$jscomp$inline_3136.flip;$jscomp$inline_3136=$jscomp$inline_3136.loop;$jscomp$inline_3137=(delete $jscomp$inline_3137.ease,delete $jscomp$inline_3137.times,delete $jscomp$inline_3137.yoyo,delete $jscomp$inline_3137.flip,delete $jscomp$inline_3137.loop,$jscomp$inline_3137);const options=Object.assign({},$jscomp$inline_3137);times&&(options.offset=times);$jscomp$inline_3137.duration&&
(options.duration=1E3*$jscomp$inline_3137.duration);$jscomp$inline_3137.repeatDelay&&(options.repeatDelay=1E3*$jscomp$inline_3137.repeatDelay);transition&&(times=Array.isArray(transition)&&"number"!==typeof transition[0],options.ease=times?transition.map(easingDefinitionToFunction):easingDefinitionToFunction(transition));"tween"===$jscomp$inline_3137.type&&(options.type="keyframes");if(JSCompiler_temp_const||$jscomp$inline_3136||to)heyListen.warning(!legacyRepeatWarning,"yoyo, loop and flip have been removed from the API. Replace with repeat and repeatType options."),
legacyRepeatWarning=!0,JSCompiler_temp_const?options.repeatType="reverse":$jscomp$inline_3136?options.repeatType="loop":to&&(options.repeatType="mirror"),options.repeat=$jscomp$inline_3136||JSCompiler_temp_const||to||$jscomp$inline_3137.repeat;"spring"!==$jscomp$inline_3137.type&&(options.type="keyframes");return $jscomp$inline_3119.call(key,{},options$jscomp$0,options)}function getAnimation(key,value,target,transition,onComplete){function start(){const options={from:origin,to:target,velocity:value.getVelocity(),
...
$jscomp$destructuring$var124=>{var {timestamp,delta}=$jscomp$destructuring$var124;initialTimestamp.current||(initialTimestamp.current=timestamp);callback(timestamp-initialTimestamp.current,delta)};sync__default["default"].update(provideTimeSinceStart,!0);return()=>sync.cancelSync.update(provideTimeSinceStart)}},[callback])}function useReducedMotion(){!JSCompiler_object_inline_current_4359&&initPrefersReducedMotion();const [shouldReduceMotion]=React.useState(JSCompiler_object_inline_current_4358);
...
visualElement.render();isBrowser&&null!==scrollY&&window.scrollTo({top:scrollY});return{target:convertedTarget,transitionEnd}}return{target,transitionEnd}};var JSCompiler_object_inline_current_4358=null;var JSCompiler_object_inline_current_4359=!1;const featureNames=Object.keys(featureDefinitions),numFeatures=featureNames.length,propEventHandlers="AnimationStart AnimationComplete Update Unmount BeforeLayoutMeasure LayoutMeasure LayoutAnimationStart LayoutAnimationComplete".split(" ");class VisualElement{constructor($jscomp$destructuring$var84,
...
!1),isWillChangeMotionValue($jscomp$destructuring$var84)&&$jscomp$destructuring$var84.add(key))}}scrapeMotionValuesFromProps(_props){return{}}mount(instance){var _a;this.current=instance;this.projection&&this.projection.mount(instance);this.parent&&this.isVariantNode&&!this.isControllingVariants&&(this.removeFromVariantTree=null===(_a=this.parent)||void 0===_a?void 0:_a.addVariantChild(this));this.values.forEach((value,key)=>this.bindToMotionValue(key,value));JSCompiler_object_inline_current_4359||
initPrefersReducedMotion();this.shouldReduceMotion="never"===this.reducedMotionConfig?!1:"always"===this.reducedMotionConfig?!0:JSCompiler_object_inline_current_4358;this.parent&&this.parent.children.add(this);this.setProps(this.props)}unmount(){var _a,_b,_c;null===(_a=this.projection)||void 0===_a?void 0:_a.unmount();sync.cancelSync.update(this.notifyUpdate);sync.cancelSync.render(this.render);this.valueSubscriptions.forEach(remove=>remove());null===(_b=this.removeFromVariantTree)||void 0===_b?void 0:
